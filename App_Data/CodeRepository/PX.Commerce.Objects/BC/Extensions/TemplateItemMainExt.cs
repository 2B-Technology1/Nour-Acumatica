...
namespace PX.Commerce.Objects
{
	public class TemplateItemMainExt : PXGraphExtension<TemplateInventoryItemMaint>
	{
		...
		{
			return CommerceFeaturesHelper.CommerceEdition;
		}
		...
		protected virtual void BCInventoryFileUrls_FileType_FieldVerifying(PXCache sender, PXFieldVerifyingEventArgs e)
		{
			...
			if (val != null)
			{
				...
				{
					sender.RaiseExceptionHandling<BCInventoryFileUrls.fileURL>(row, row.FileURL,
						new PXSetPropertyException(PX.Commerce.Core.BCMessages.InvalidURL, PXErrorLevel.Error));
				}
			}
		}
