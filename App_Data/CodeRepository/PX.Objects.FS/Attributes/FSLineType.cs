...
namespace PX.Objects.FS
{
    public class FSLineType
    {
        ...
        public static CustomListAttribute GetDropDownList(bool includeIN, bool includeTemplate, bool includePickup, bool includeCI, bool includeAll)
        {
            ...
            if (includeAll == true)
            {
                result.Add(new Tuple<string, string>(ID.LineType_ALL.ALL, TX.LineType_ALL.ALL));
            }
        ...
        public class ListAttribute : CustomListAttribute
        {
            public ListAttribute() : base(
                new[]
                {
                    ...
                    Pair(ID.LineType_ALL.ALL, TX.LineType_ALL.ALL),
                })
            { }
        }

        public static void SetLineTypeList<LineTypeField>(PXCache cache, object row, bool includeIN, bool includeTemplate, bool includePickup, bool includeCI, bool includeAll)
            where LineTypeField : class, IBqlField
        {
            CustomListAttribute dropDownList = GetDropDownList(includeIN, includeTemplate, includePickup, includeCI, includeAll);
        ...
        {
            public All() : base(ID.LineType_ALL.ALL) {; }
        }
    }
}
