...
namespace PX.Objects.FS
{
    ...
    public class FSSrvOrdAddressAttribute : FSDocumentAddressAttribute
    {
        ...
        public override void DefaultAddress<TAddress, TAddressID>(PXCache sender, object documentRow, object addressRow)
        {
            ...
            bool isBranchLocation = false;
            BqlCommand select;
			AppointmentEntry appointmentGraph = null;
            ...
            {
				appointmentGraph = (AppointmentEntry)sender.Graph;
                fsSrvOrdTypeRow = appointmentGraph.ServiceOrderTypeSelected.Current;
            }
            ...
            if (view != null)
            {
                ...
                foreach (PXResult res in view.Select(new object[] { documentRow }, new[] { parm }, null, null, null, null, ref startRow, 1, ref totalRows))
                {
					...
					if (appointmentGraph != null)
					{
						var appt = appointmentGraph.AppointmentSelected.Current;
						if (appt != null)
						{
							appointmentGraph.AppointmentSelected.Cache.SetDefaultExt<FSAppointment.taxZoneID>(appt);
						}
					}
