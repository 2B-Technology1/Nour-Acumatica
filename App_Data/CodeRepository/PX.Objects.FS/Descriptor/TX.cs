...
namespace PX.Objects.FS
{
    public static class TX
    {
        ...
        public static class Error
        {
			...
			public const string ASSIGNMENT_INSUFFICIENT_SKILLS												   = "This appointment could not be assigned to a staff member because no employee satisfies the skills required to perform the services in this appointment.";
			...
			public const string DecimalNumberCannotBeEntered     											   = "A decimal number cannot be entered as an item quantity if any equipment action is specified in the line. Specify a whole number for the quantity of this item.";
            ...
            public const string APPOINTMENT_COULD_NOT_BE_REACH_SERVICED                                        = "This appointment cannot be optimized because the selected employee or employees have no available working hours in their work calendars.";
            ...
            public const string ACTUAL_DURATION_UNEDITABLE_DUE_TO_LOG_LINES									   = "The service actual duration cannot be edited because there is a log line or lines on the Log tab related to the service time tracking.";
			...
			public const string DocumentCannotBeInvoiced													   = "The document {0}-{1} cannot be billed. Ensure that at least one billable item is added on the Details tab and that the None option is not specified in the Generate Billing Documents box on the Service Order Types (FS202300) form for the document's service order type.";
			...
			public const string DayEndTimeCannotBeEarlierDayStartTime 										   = "The day end time cannot be earlier than the day start time. Update the value accordingly.";
			public const string EquipmentCannotBeDeleted													   = "Equipment {0} cannot be deleted because it is referenced in multiple tables. For details, see trace.";
			public const string LineWithStockItemCannotBeAddedBecauseAdvancedSOInvoicesFeatureIsDisabled       = "A line with a stock item cannot be added because the Advanced SO Invoices feature is disabled on the Enable/Disable Features (CS100000) form.";
			public const string AppointmentCannotBeDeletedBecauseItWasBilled								   = "An appointment cannot be deleted because it was billed.";
			public const string ServiceOrderCannotBeDeletedBecauseItWasBilled								   = "A service order cannot be deleted because it was billed.";
			public const string ServiceOrderCannotBeBilledWaitingForPurchaseditems							   = "The service order cannot be billed because it contains items that are waiting to be purchased.";
			public const string ServiceOrderEstimatedQtyCannotBeLessThanTotalEstimatedQtyOfAppts			   = "The specified estimated quantity {0} is less than the sum of the estimated quantities of all lines {1} in the associated appointment(s).";
			public const string CannotReverseARInvoiceFromServiceOrder = "The action cannot be performed because this AR invoice is a duplicate of the SO invoice that has been generated from the field service document. To proceed, perform the reversal procedure for the SO invoice with the same reference number on the Invoices (SO303000) form.";
			public const string AttributeNotValid															   = "The attribute {0} was not found.";
			...
			public const string RefNbrCannotBeEmpty															   = "{0} cannot be empty.";
			public const string RefNbrCannotBeTheSame														   = "The service contract ID must be different from the service contract ID of the source service contract.";
			public const string RefNbrAlreadyExists															   = "A service contract with the specified ID already exists. Specify another service contract ID for a new service contract.";
		}
        ...
        public static class Warning
        {
			...
			public const string BILLING_SETTINGS_NOT_MODIFIED_SRV_ORDERS_AVAIL							  = "Billing settings cannot be modified because at least one service order or appointment has been created for the customer.";
        ...
        {
			public const string DummyProjectTransactionDescription = "Service billing of stock. For related costs, see the respective inventory issue.";
        ...
        public static class CalendarMessages
        {
            ...
            public const string SERVICEORDER_SERVICES_REMAINING = "Service Remaining";
