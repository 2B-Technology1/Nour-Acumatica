...
namespace PX.Objects.FS
{
    public class BranchLocationMaint : PXGraph<BranchLocationMaint, FSBranchLocation>
    {
        ...
        protected virtual void _(Events.RowSelected<FSBranchLocation> e)
        {
            ...
            EnableDisable_ActionButtons(e.Cache, e.Row);

            PXDefaultAttribute.SetPersistingCheck<FSBranchLocation.dfltSiteID>(e.Cache,
                                                                               e.Row,
            ...
            PXUIFieldAttribute.SetVisible<FSBranchLocation.dfltUOM>(e.Cache, 
                                                                    e.Row,
                                                                    PXAccess.FeatureInstalled<FeaturesSet.inventory>()
                                                                        && PXAccess.FeatureInstalled<FeaturesSet.multipleUnitMeasure>());
        }
        ...
        /// <exclude/>
        public class BranchLocationMaintAddressLookupExtension : CR.Extensions.AddressLookupExtension<BranchLocationMaint, FSBranchLocation, FSAddress>
        {
            protected override string AddressView => nameof(Base.BranchLocation_Address);
