...
namespace PX.Objects.FS
{
    public class ManufacturerMaint : PXGraph<ManufacturerMaint, FSManufacturer>
    {
        ...
        /// <exclude/>
        public class ManufacturerMaintAddressLookupExtension : CR.Extensions.AddressLookupExtension<ManufacturerMaint, FSManufacturer, FSAddress>
        {
            protected override string AddressView => nameof(Base.Manufacturer_Address);
