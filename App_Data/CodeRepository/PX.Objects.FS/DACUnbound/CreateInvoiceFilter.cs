    ...
    public partial class CreateInvoiceFilter : IBqlTable
    {
        ...
        public virtual DateTime? UpToDate
        {
            ...
            set
            {
                ...
                UpToDateWithTimeZone = new DateTime(_UpToDate.Value.Year, _UpToDate.Value.Month, _UpToDate.Value.Day, 23, 59, 59);
            }
        }
        #endregion
        #region UpToDateWithTimeZone
        public abstract class upToDateWithTimeZone : PX.Data.BQL.BqlDateTime.Field<upToDateWithTimeZone> { }

        [PXDate(UseTimeZone = true)]
        [PXDefault(typeof(AccessInfo.businessDate))]
        [PXUIField(DisplayName = "Up to Date (with TimeZone)")]
