...
namespace PX.Objects.FS
{
    public class SM_OpportunityMaint_DBox : DialogBoxSOApptCreation<SM_OpportunityMaint, OpportunityMaint, CROpportunity>
    {
        ...
        public sealed override void Configure(PXScreenConfiguration configuration) =>
            Configure(configuration.GetScreenConfigurationContext<OpportunityMaint, CROpportunity>());
        ...
        protected virtual void _(Events.RowSelected<CROpportunity> e)
        {
            ...
            bool enableCreateActions = isSMSetup && e.Row != null && insertedStatus == false && ext?.ServiceOrderRefNbr == null;
