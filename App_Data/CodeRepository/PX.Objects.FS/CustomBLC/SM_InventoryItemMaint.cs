    ...
    public class SM_InventoryItemMaint : PXGraphExtension<InventoryItemMaint>
    {
        ...
        public virtual void EnableDisable_InventoryItem(PXCache cache, InventoryItem inventoryItemRow)
        {
            ...
            if (PXAccess.FeatureInstalled<FeaturesSet.equipmentManagementModule>() == true)
            {
                ...
                PXUIFieldAttribute.SetEnabled<FSxEquipmentModel.companyWarrantyType>(cache, inventoryItemRow, enableHeaderWarranties);
                PXUIFieldAttribute.SetEnabled<FSxEquipmentModel.companyWarrantyValue>(cache, inventoryItemRow, enableHeaderWarranties);
        ...
        public virtual void ResetValuesFromItemClass(PXCache cache, InventoryItem inventoryItemRow, int? itemClassID)
        {
            ...
            if (inventoryItemRow != null && inventoryItemRow.ItemClassID != null)
            {
                using (var ts = new PXTransactionScope())
                {
                    ...
                    fsxEquipmentModelRow.ModelType = fsxEquipmentModelTemplateRow.DefaultEquipmentModelType;
        ...
        public virtual void ShowOrHideFields(PXCache cache, InventoryItem inventoryItemRow)
        {
            ...
            PXUIFieldAttribute.SetVisible<FSxEquipmentModel.companyWarrantyValue>(cache, inventoryItemRow, hideFields);
            PXUIFieldAttribute.SetVisible<FSxEquipmentModel.companyWarrantyType>(cache, inventoryItemRow, hideFields);
        ...
        protected virtual void _(Events.FieldUpdated<FSModelComponent, FSModelComponent.inventoryID> e)
        {
            ...
            if (fsModelComponentRow.InventoryID != null)
            {
                ...
                fsModelComponentRow.CpnyWarrantyValue = fsxEquipmentModelTemplate.CompanyWarrantyValue;
                fsModelComponentRow.CpnyWarrantyType = fsxEquipmentModelTemplate.CompanyWarrantyType;
