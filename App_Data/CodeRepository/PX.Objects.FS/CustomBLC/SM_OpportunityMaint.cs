...
namespace PX.Objects.FS
{
    public class SM_OpportunityMaint : PXGraphExtension<CR.OpportunityMaint.Discount, OpportunityMaint>
    {
        ...
        public class WorkflowChanges : PXGraphExtension<OpportunityWorkflow, OpportunityMaint>
        {
            ...
            protected static void Configure(WorkflowContext<OpportunityMaint, CROpportunity> context)
            {
        ...
        public virtual void viewServiceOrder()
        {
            ...
            if (fsxCROpportunityRow != null && fsxCROpportunityRow.ServiceOrderRefNbr != null)
            {
                CRExtensionHelper.LaunchServiceOrderScreen(Base, fsxCROpportunityRow.ServiceOrderRefNbr, fsxCROpportunityRow.SrvOrdType);
            }
        }
        ...
        public virtual void openAppointmentBoard()
        {
            ...
            if (fsxCROpportunityRow != null && fsxCROpportunityRow.ServiceOrderRefNbr != null)
            {
                CRExtensionHelper.LaunchEmployeeBoard(Base, fsxCROpportunityRow.ServiceOrderRefNbr, fsxCROpportunityRow.SrvOrdType);
            }
        }
        ...
        protected virtual void _(Events.RowSelected<CROpportunity> e)
        {
            ...
            FSServiceOrder fsServiceOrderRow = CRExtensionHelper.GetRelatedServiceOrder(Base, cache, crOpportunityRow, fsxCROpportunityRow.ServiceOrderRefNbr, fsxCROpportunityRow.SrvOrdType);
