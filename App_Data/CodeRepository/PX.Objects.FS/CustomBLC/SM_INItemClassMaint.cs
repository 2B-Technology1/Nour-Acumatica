...
namespace PX.Objects.FS
{
    public class SM_INItemClassMaint : PXGraphExtension<INItemClassMaint>
    {
        ...
        public virtual void EnableDisable(PXCache cache, INItemClass itemClassRow)
        {
            ...
            PXUIFieldAttribute.SetEnabled<FSxServiceClass.defaultBillingRule>(cache, itemClassRow, itemClassRow.ItemType == INItemTypes.ServiceItem);
            ...
            if (PXAccess.FeatureInstalled<FeaturesSet.equipmentManagementModule>())
            {
                ...
                PXUIFieldAttribute.SetEnabled<FSxEquipmentModelTemplate.defaultEquipmentModelType>(cache, itemClassRow, isEnabledAsModelTemplate);
                PXDefaultAttribute.SetPersistingCheck<FSxEquipmentModelTemplate.defaultEquipmentModelType>(cache,
                                                                                               itemClassRow,
        ...
        protected virtual void _(Events.FieldDefaulting<INItemClass, FSxServiceClass.defaultBillingRule> e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (e.Row.StkItem == true
                    || (e.Row.StkItem == false && e.Row.ItemType != INItemTypes.ServiceItem))
            {
                e.NewValue = ID.BillingRule.FLAT_RATE;
            }
            else
            {
                e.NewValue = ID.BillingRule.TIME;
            }
        }
        #endregion
        ...
        protected virtual void _(Events.FieldUpdated<INItemClass, INItemClass.itemType> e)
        {
            ...
            e.Cache.SetDefaultExt<FSxServiceClass.defaultBillingRule>(e.Row);
        ...
        protected virtual void _(Events.RowSelected<INItemClass> e)
        {
            ...
            EnableDisable(e.Cache, e.Row);
            PXUIFieldAttribute.SetVisible<FSxEquipmentModelTemplate.equipmentItemClass>(e.Cache,
                                                                                        e.Row,
