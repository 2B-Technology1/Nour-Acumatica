...
namespace PX.Objects.FS
{
    public class SM_CRCaseMaint : PXGraphExtension<CRCaseMaint>
    {
        ...
        public virtual void openAppointmentBoard()
        {
            ...
            if (fsxCRCaseRow != null && fsxCRCaseRow.ServiceOrderRefNbr != null)
            {
                CRExtensionHelper.LaunchEmployeeBoard(Base, fsxCRCaseRow.ServiceOrderRefNbr, fsxCRCaseRow.SrvOrdType);
            }
        }
        ...
        public virtual void viewServiceOrder()
        {
            ...
            if (fsxCRCaseRow != null && fsxCRCaseRow.ServiceOrderRefNbr != null)
            {
                CRExtensionHelper.LaunchServiceOrderScreen(Base, fsxCRCaseRow.ServiceOrderRefNbr, fsxCRCaseRow.SrvOrdType);
            }
        }
        ...
        public sealed override void Configure(PXScreenConfiguration configuration) =>
            Configure(configuration.GetScreenConfigurationContext<CRCaseMaint, CRCase>());
        ...
        public virtual void CreateServiceOrderDocument(CRCaseMaint graphCRCaseMaint, CRCase crCaseRow, FSCreateServiceOrderOnCaseFilter fsCreateServiceOrderOnCaseFilterRow)
        {
			...
			var numID = graphServiceOrderEntry.ServiceOrderTypeSelected.SelectSingle()?.SrvOrdNumberingID;
                                                    ...
                                                    bool updatingExistingSO)
        {
            ...
            if (PXAccess.FeatureInstalled<FeaturesSet.multicurrency>())
            {
                ...
                if (customer != null
                    && fsServiceOrderRow.CuryID != customer.CuryID && customer.CuryID != null)
                {
        ...
        protected virtual void _(Events.RowSelected<CRCase> e)
        {
            ...
            FSServiceOrder fsServiceOrderRow = CRExtensionHelper.GetRelatedServiceOrder(Base, cache, crCaseRow, fsxCRCaseRow.ServiceOrderRefNbr, fsxCRCaseRow.SrvOrdType);
