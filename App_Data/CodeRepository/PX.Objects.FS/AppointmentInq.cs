...
namespace PX.Objects.FS
{
    ...
    public class AppointmentInq : PXGraph<AppointmentInq>
    {
        ...
        public PXSelectJoinGroupBy<FSAppointmentFSServiceOrder,
                ...
                LeftJoin<FSCustomerBillingSetup, On<FSCustomerBillingSetup.customerID, Equal<FSAppointmentFSServiceOrder.billCustomerID>,
						And<Where2<
							Where<FSSetup.customerMultipleBillingOptions, Equal<True>,
								And<FSCustomerBillingSetup.srvOrdType, Equal<FSAppointmentFSServiceOrder.srvOrdType>>>,
