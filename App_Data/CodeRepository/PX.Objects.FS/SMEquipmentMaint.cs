    ...
    public class SMEquipmentMaint : PXGraph<SMEquipmentMaint, FSEquipment>
    {
            ...
            if (inventoryItemRow != null)
            {
                ...
                if (fsxEquipmentModelRow != null)
                {
                    if (fsxEquipmentModelRow.EQEnabled == true)
                    {
                        ...
                        cache.SetValueExt<FSEquipment.cpnyWarrantyType>(fsEquipmentRow, fsxEquipmentModelRow.CompanyWarrantyType);
                        cache.SetValueExt<FSEquipment.cpnyWarrantyValue>(fsEquipmentRow, fsxEquipmentModelRow.CompanyWarrantyValue);
        ...
        public virtual void SetComponentValuesFromInventory(PXCache cache, FSEquipmentComponent fsEquipmentComponentRow)
        {
            ...
            if (inventoryItemRow != null)
            {
                ...
                if (fsxEquipmentModelRow != null)
                {
                    if (fsxEquipmentModelRow.CompanyWarrantyType != null)
                    {
                        fsEquipmentComponentRow.CpnyWarrantyType = fsxEquipmentModelRow.CompanyWarrantyType;
                    }

                    if (fsxEquipmentModelRow.CompanyWarrantyValue != null)
                    {
                        cache.SetValueExt<FSEquipmentComponent.cpnyWarrantyDuration>(fsEquipmentComponentRow, fsxEquipmentModelRow.CompanyWarrantyValue);
                    }
        ...
        protected virtual void _(Events.RowDeleting<FSEquipment> e)
        {
			...
			var referencedInSalesOrder = PXSelect<SOLine,
				Where<FSxSOLine.sMEquipmentID, Equal<Required<FSEquipment.SMequipmentID>>>>.
				Select(this, e.Row.SMEquipmentID).Any();

			if (referencedInSalesOrder)
			{
				e.Cancel = true;
				throw new PXSetPropertyException<CSAttributeGroup.attributeCategory>(TX.Error.EquipmentCannotBeDeleted, e.Row.RefNbr);
			}
