...
namespace PX.Objects.FS
{
    ...
    public class BAccountLocation : IBqlTable
    {
        ...
        {
            public static BAccountLocation Find(PXGraph graph, int? customerID, int? locationID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, customerID, locationID, options);
        }
