...
namespace PX.Objects.FS
{
    ...
    public partial class FSServiceOrderDiscountDetail : FSDiscountDetail, IDiscountDetail
    {
        ...
        {
            public static FSServiceOrderDiscountDetail Find(PXGraph graph, string srvOrdType, string refNbr, int? recordID, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, srvOrdType, refNbr, recordID, options);
        }
