...
namespace PX.Objects.FS
{
    ...
    public partial class RouteAppointmentInfo : FSAppointment
    {
        ...
        {
            public static RouteAppointmentInfo Find(PXGraph graph, string srvOrdType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, srvOrdType, refNbr, options);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<RouteAppointmentInfo>.By<projectID, dfltProjectTaskID> { }
