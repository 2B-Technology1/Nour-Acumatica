...
namespace PX.Objects.FS
{
	...
	[PXProjection(typeof(
            Select2<FSAppointment,
				...
				InnerJoin<FSCustomerBillingSetup,
					On<FSCustomerBillingSetup.customerID, Equal<FSServiceOrder.billCustomerID>,
						And<Where2<
    ...
    public class AppointmentToPost : FSAppointment, IPostLine
    {
        ...
        {
            public static AppointmentToPost Find(PXGraph graph, string srvOrdType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, srvOrdType, refNbr, options);
        }
        public new class UK : PrimaryKeyOf<AppointmentToPost>.By<appointmentID>
        {
            public static AppointmentToPost Find(PXGraph graph, int? appointmentID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, appointmentID, options);
        }
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<AppointmentToPost>.By<projectID, dfltProjectTaskID> { }
