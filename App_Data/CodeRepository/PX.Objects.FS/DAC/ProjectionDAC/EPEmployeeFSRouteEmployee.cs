...
namespace PX.Objects.FS
{
    ...
    [PXProjection(typeof(
        Select2<EPEmployee,
			...
			InnerJoin<Vendor,
				On<Vendor.bAccountID, Equal<EPEmployee.bAccountID>>,
    ...
    public class EPEmployeeFSRouteEmployee : EPEmployee
    {
        ...
        {
            public static EPEmployeeFSRouteEmployee Find(PXGraph graph, int? bAccountID, string acctCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, bAccountID, acctCD, options);
        }
