...
namespace PX.Objects.FS
{
    ...
    public partial class FSAppointmentInRoute : FSAppointment
    {
        ...
        {
            public static FSAppointmentInRoute Find(PXGraph graph, string srvOrdType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, srvOrdType, refNbr, options);
        }

        public new class UK : PrimaryKeyOf<FSAppointmentInRoute>.By<appointmentID>
        {
            public static FSAppointmentInRoute Find(PXGraph graph, int? appointmentID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, appointmentID, options);
        }
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSAppointmentInRoute>.By<projectID, dfltProjectTaskID> { }
