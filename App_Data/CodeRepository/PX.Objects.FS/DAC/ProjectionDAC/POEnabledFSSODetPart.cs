...
namespace PX.Objects.FS
{
    ...
    public class POEnabledFSSODet : FSSODet
    {
        ...
        {
            public static POEnabledFSSODet Find(PXGraph graph, int? lineNbr, string refNbr, string srvOrdType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, lineNbr, refNbr, srvOrdType, options);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<POEnabledFSSODet>.By<projectID, projectTaskID> { }
