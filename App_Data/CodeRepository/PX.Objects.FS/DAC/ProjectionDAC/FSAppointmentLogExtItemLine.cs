...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentLogExtItemLine : FSAppointmentLog
    {
        ...
        {
            public static FSAppointmentLogExtItemLine Find(PXGraph graph, string docType, string docRefNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, docRefNbr, lineNbr, options);
        }
        public new class UK : PrimaryKeyOf<FSAppointmentLogExtItemLine>.By<logID>
        {
            public static FSAppointmentLogExtItemLine Find(PXGraph graph, int? logID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, logID, options);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSAppointmentLogExtItemLine>.By<projectID, projectTaskID> { }
