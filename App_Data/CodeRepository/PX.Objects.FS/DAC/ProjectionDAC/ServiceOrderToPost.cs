...
namespace PX.Objects.FS
{
    ...
    public class ServiceOrderToPost : FSServiceOrder, IPostLine
    {
        ...
        {
            public static ServiceOrderToPost Find(PXGraph graph, string srvOrdType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, srvOrdType, refNbr, options);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<ServiceOrderToPost>.By<projectID, dfltProjectTaskID> { }
		...
		public new abstract class billingBy : ListField_Billing_By { }
