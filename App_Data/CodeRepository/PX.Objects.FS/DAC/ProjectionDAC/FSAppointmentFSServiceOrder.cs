...
namespace PX.Objects.FS
{
    ...
    public partial class FSAppointmentFSServiceOrder : FSAppointment
    {
        ...
        {
            public static FSAppointmentFSServiceOrder Find(PXGraph graph, string refNbr, string srvOrdType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, srvOrdType, options);
        }

        public new class UK : PrimaryKeyOf<FSAppointmentFSServiceOrder>.By<appointmentID>
        {
            public static FSAppointmentFSServiceOrder Find(PXGraph graph, int? appointmentID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, appointmentID, options);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<projectID, dfltProjectTaskID> { }
