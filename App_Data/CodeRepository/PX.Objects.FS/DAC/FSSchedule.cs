...
{	
    ...
    public class FSSchedule : PX.Data.IBqlTable
    {
        ...
        {
            public static FSSchedule Find(PXGraph graph, int? scheduleID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, scheduleID, options);
        }

        public class UK : PrimaryKeyOf<FSSchedule>.By<refNbr, customerID>
        {
            public static FSSchedule Find(PXGraph graph, string refNbr, int? customerID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, customerID, options);
        }
        ...
        public static class FK
        {
            ...
            public class DefaultTask : PMTask.PK.ForeignKeyOf<FSSchedule>.By<projectID, dfltProjectTaskID> { }
        }
        #endregion
