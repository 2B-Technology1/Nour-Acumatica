...
namespace PX.Objects.FS
{
	...
	public class FSRouteDocument : PX.Data.IBqlTable
	{
        ...
        {
            public static FSRouteDocument Find(PXGraph graph, int? routeDocumentID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, routeDocumentID, options);
        }

        public class UK : PrimaryKeyOf<FSRouteDocument>.By<refNbr>
        {
            public static FSRouteDocument Find(PXGraph graph, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, options);
        }
