...
namespace PX.Objects.FS
{
    ...
    public partial class FSApptLineSplit : PX.Data.IBqlTable, ILSDetail
    {
		...
		{
			public static FSApptLineSplit Find(PXGraph graph, string srvOrdType, string apptNbr, int? lineNbr, int? splitLineNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, srvOrdType, apptNbr, lineNbr, splitLineNbr, options);
		}
		...
		[LocationAvail(typeof(FSApptLineSplit.inventoryID), typeof(FSApptLineSplit.subItemID), typeof(CostCenter.freeStock), typeof(FSApptLineSplit.siteID), typeof(FSApptLineSplit.tranType), typeof(FSApptLineSplit.invtMult))]
        [PXDefault()]
        ...
        [FSApptLotSerialNbr(
			typeof(FSApptLineSplit.siteID),
			typeof(FSApptLineSplit.inventoryID),
			typeof(FSApptLineSplit.subItemID),
			typeof(FSApptLineSplit.locationID),
