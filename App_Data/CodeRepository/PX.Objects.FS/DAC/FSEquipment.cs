...
namespace PX.Objects.FS
{
    ...
    public class FSEquipment : PX.Data.IBqlTable
    {
        ...
        {
            public static FSEquipment Find(PXGraph graph, int? SMequipmentID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, SMequipmentID, options);
        }

        public class UK : PrimaryKeyOf<FSEquipment>.By<refNbr>
        {
            public static FSEquipment Find(PXGraph graph, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, options);
        }
