...
namespace PX.Objects.FS
{
    public class FSARTran : IBqlTable, IFSRelatedDoc
    {
        ...
        {
            public static FSARTran Find(PXGraph graph, string tranType, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranType, refNbr, lineNbr, options);
