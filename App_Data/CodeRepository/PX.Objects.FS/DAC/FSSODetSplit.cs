...
namespace PX.Objects.FS
{
    ...
    public class FSSODetSplit : PX.Data.IBqlTable, ILSDetail, IItemPlanSource
	{
        #region Keys
        public class PK : PrimaryKeyOf<FSSODetSplit>.By<srvOrdType, refNbr, lineNbr, splitLineNbr>
        {
            public static FSSODetSplit Find(PXGraph graph, string srvOrdType, string refNbr, int? lineNbr, int? splitLineNbr, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, srvOrdType, refNbr, lineNbr, splitLineNbr, options);
        }
        ...
        [SiteAvail(typeof(FSSODetSplit.inventoryID), typeof(FSSODetSplit.subItemID), typeof(CostCenter.freeStock), new Type[] { typeof(INSite.siteCD), typeof(INSiteStatusByCostCenter.qtyOnHand), typeof(INSiteStatusByCostCenter.qtyAvail), typeof(INSite.descr) }, DisplayName = "Alloc. Warehouse")]
        ...
        [LocationAvail(typeof(FSSODetSplit.inventoryID), typeof(FSSODetSplit.subItemID), typeof(CostCenter.freeStock), typeof(FSSODetSplit.siteID), typeof(FSSODetSplit.tranType), typeof(FSSODetSplit.invtMult))]
        ...
        [SOLotSerialNbr(typeof(FSSODetSplit.inventoryID), typeof(FSSODetSplit.subItemID), typeof(FSSODetSplit.locationID), typeof(FSSODet.lotSerialNbr), typeof(CostCenter.freeStock), PersistingCheck = PXPersistingCheck.Nothing, FieldClass = "LotSerial")]
