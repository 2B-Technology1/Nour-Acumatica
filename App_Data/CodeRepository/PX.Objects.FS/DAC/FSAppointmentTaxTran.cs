...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentTaxTran : TaxDetail, PX.Data.IBqlTable
    {
        ...
        {
            public static FSAppointmentTaxTran Find(PXGraph graph, string srvOrdType, string refNbr, int? recordID, string taxID, PKFindOptions options = PKFindOptions.None)
        ...
        [PXDBLong()]
        [CM.Extensions.CurrencyInfo(typeof(FSAppointment.curyInfoID))]
