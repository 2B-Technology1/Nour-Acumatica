...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentDet : IBqlTable, IFSSODetBase, IDocLine, ISortOrder, ILSPrimary
    {
        ...
        {
            public static FSAppointmentDet Find(PXGraph graph, string srvOrdType, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, srvOrdType, refNbr, lineNbr, options);
        }
        ...
        public static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSAppointmentDet>.By<projectID, projectTaskID> { }
        ...
        [LocationAvail(typeof(inventoryID), typeof(subItemID), typeof(CostCenter.freeStock), typeof(siteID), true, false, false)]
        ...
        [PXFormula(typeof(Default<lineType, areActualFieldsActive, logActualDuration>))]
        [PXUnboundFormula(typeof(Switch<
                                    Case<Where<
                                            lineType, Equal<FSLineType.Service>,
                                            And<isTravelItem, Equal<False>>>,
        ...
        [PXDefault(typeof(Switch<
                            ...
                            Case<Where<
                                    billingRule, Equal<billingRule.Time>,
										Or<Current<FSAppointment.completeActionRunning>, Equal<True>>>,
