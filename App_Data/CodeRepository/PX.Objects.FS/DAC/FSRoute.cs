...
namespace PX.Objects.FS
{
	...
	public class FSRoute : PX.Data.IBqlTable
	{
        ...
        {
            public static FSRoute Find(PXGraph graph, int? routeID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, routeID, options);
        }

        public class UK : PrimaryKeyOf<FSRoute>.By<routeCD>
        {
            public static FSRoute Find(PXGraph graph, string routeCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, routeCD, options);
        }
