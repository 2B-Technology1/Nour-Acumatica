...
namespace PX.Objects.PJ.DailyFieldReports.PJ.GraphExtensions
{
    public class DailyFieldReportEntryEmployeeActivityExtension : PXGraphExtension<DailyFieldReportEntry>
    {
		...
		public virtual void _(Events.RowInserted<EPActivityApprove> e)
		{
			if (e.Row != null)
			{
				EmployeeActivitiesEntry.UpdateReportedInTimeZoneIDIfNeeded(e.Cache, e.Row, null, e.Row.Date);
			}
		}

		public virtual void _(Events.FieldUpdated<EPActivityApprove, EPActivityApprove.date> e)
		{
			if (e.Row != null)
			{
		...
		public virtual void _(Events.FieldVerifying<EPActivityApprove, EPActivityApprove.projectTaskID> args)
        {
            ...
            {
                var projectTask = ProjectTaskDataProvider.GetProjectTask(Base, args.Row.ProjectID, projectTaskId);
                if (projectTask != null)
                {
        ...
        public virtual void _(Events.RowUpdated<EPActivityApprove> args)
        {
			...
			if (args.Row != null)
			{
				EmployeeActivitiesEntry.UpdateReportedInTimeZoneIDIfNeeded(args.Cache, args.Row, args.OldRow.Date, args.Row.Date);
			}
		}
