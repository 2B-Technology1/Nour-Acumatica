...
namespace PX.Objects.PJ.DrawingLogs.PJ.Graphs
{
	public class DrawingLogsMaint : PXGraph<DrawingLogsMaint>, PXImportAttribute.IPXPrepareItems
	{
		...
		public SelectFrom<DrawingLog>
			...
			.LeftJoin<ProjectIssueDrawingLog>
				.On<
					DrawingLog.drawingLogId.IsEqual<ProjectIssueDrawingLog.drawingLogId>
					.And<ProjectIssueDrawingLog.projectIssueId.IsEqual<DrawingLogFilter.projectIssueID.FromCurrent>>>
			.LeftJoin<RequestForInformationDrawingLog>
				.On<
					DrawingLog.drawingLogId.IsEqual<RequestForInformationDrawingLog.drawingLogId>
					.And<RequestForInformationDrawingLog.requestForInformationId.IsEqual<DrawingLogFilter.rfiID.FromCurrent>>>
			.Where<
				Brackets<DrawingLog.projectId.IsEqual<DrawingLogFilter.projectId.FromCurrent>
				...
				.And<DrawingLog.statusId.IsEqual<DrawingLogFilter.statusID.FromCurrent>
					.Or<DrawingLogFilter.statusID.FromCurrent.IsNull>>
				.And<ProjectIssueDrawingLog.projectIssueId.IsEqual<DrawingLogFilter.projectIssueID.FromCurrent>
					.Or<DrawingLogFilter.projectIssueID.FromCurrent.IsNull>>
				.And<RequestForInformationDrawingLog.requestForInformationId.IsEqual<DrawingLogFilter.rfiID.FromCurrent>
					.Or<DrawingLogFilter.rfiID.FromCurrent.IsNull>>
		...
		public virtual void insertDrawingLog()
		{
			...
			graph.DrawingLog.Current = graph.DrawingLog.Insert();
		...
		// TODO Do we need Persist() in long-running?
