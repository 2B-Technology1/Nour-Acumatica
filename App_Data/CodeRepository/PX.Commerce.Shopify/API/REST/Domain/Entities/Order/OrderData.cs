...
namespace PX.Commerce.Shopify.API.REST
{
	...
	public class OrderData : BCAPIEntity
	{
		...
		/// Usually a <see cref="OrderCancelReason"/>
		/// </summary>
		...
		/// <summary>
		/// The current total additional fees on the order in shop and presentment currencies.
		...
		[CommerceDescription(ShopifyCaptions.LineItem, FieldFilterStatus.Skipped, FieldMappingStatus.ImportAndExport)]
		...
		public long? MerchantRecordAppId { get; set; }
		...
		/// </summary>
		[JsonProperty("po_number", DefaultValueHandling = DefaultValueHandling.Ignore)]
		[CommerceDescription(ShopifyCaptions.PurchaseOrderNumber, FieldFilterStatus.Filterable, FieldMappingStatus.ImportAndExport)]
		...
		/// </summary>
		/// <remarks> This field is deprecated since API version 2023-01.</remarks>
		[JsonProperty("processing_method")]
		[CommerceDescription(ShopifyCaptions.ProcessingMethod, FieldFilterStatus.Filterable, FieldMappingStatus.ImportAndExport)]
		[ShouldNotSerialize]
		[Obsolete("This field is deprecated from Shopify API version 2023-01.")]
		...
		/// This URL is displayed to merchants on the Order Details page. If the URL is invalid, then it won't be displayed.
		/// </summary>
		...
		[CommerceDescription(ShopifyCaptions.ItemsTotal, FieldFilterStatus.Filterable, FieldMappingStatus.Import)]
		public decimal? ItemsTotal { get; set; }

		[CommerceDescription(ShopifyCaptions.ItemsTotalPresentment, FieldFilterStatus.Skipped, FieldMappingStatus.Import)]
		[ShouldNotSerialize]
		...
		[CommerceDescription(ShopifyCaptions.OrderTotal, FieldFilterStatus.Filterable, FieldMappingStatus.Import)]
		...
		[CommerceDescription(ShopifyCaptions.OrderStatusURL, FieldFilterStatus.Filterable, FieldMappingStatus.ImportAndExport)]
		[ShouldNotSerialize]
