...
namespace PX.Commerce.Shopify.API.GraphQL
{
	...
	public class CompanyCreateInput
	{
		...
		/// </summary>
		[JsonProperty("companyContact", NullValueHandling = NullValueHandling.Ignore)]
		public CompanyContactInput CompanyContact { get; set; }

		/// <summary>
		/// The attributes for the company location.
		/// </summary>
		[JsonProperty("companyLocation", NullValueHandling = NullValueHandling.Ignore)]
		public CompanyLocationInput CompanyLocation { get; set; }
	}
}
