...
{
	/// <summary>
	/// The return type of the companyAssignCustomerAsContact mutation.
	/// </summary>
	[GraphQLObject(MutationName = "companyAssignCustomerAsContact")]
	public class CompanyAssignCustomerAsContactPayload : MutationPayload
	{
		/// <summary>
		/// The created contact.
		/// </summary>
		...
		public class Arguments
		{
			...
			[GraphQLArgument("customerId", "ID", false)]
