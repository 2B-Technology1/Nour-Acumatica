...
{
	/// <summary>
	/// The return type of the CompanyLocationCreate mutation.
	/// </summary>
	[GraphQLObject(MutationName = "companyLocationCreate")]
	public class CompanyLocationCreatePayload : MutationPayload
	{
		/// <summary>
		/// The created company.
		/// </summary>
		...
		public class Arguments
		{
			...
			[GraphQLArgument("input", "CompanyLocationInput", false)]
