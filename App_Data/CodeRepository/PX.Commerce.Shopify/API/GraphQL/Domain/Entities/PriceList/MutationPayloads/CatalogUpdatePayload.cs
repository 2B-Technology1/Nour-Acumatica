...
{
	/// <summary>
	/// The return type of the catalogUpdate mutation.
	/// </summary>
	[GraphQLObject(MutationName = "catalogUpdate")]
	public class CatalogUpdatePayload : MutationPayload
	{
		/// <summary>
		/// The updated catalog.
		/// </summary>
		...
		public class Arguments
		{
			...
			[GraphQLArgument("input", "CatalogUpdateInput", false)]
