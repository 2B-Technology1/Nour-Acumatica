...
{
	/// <summary>
	/// Provides functionality for creating a Shopify GraphQL API service.
	/// </summary>
	public interface ISPGraphQLAPIClientFactory
	{
		/// <summary>
		...
		SPGraphQLAPIClient GetClient(BCBindingShopify binding, string apiVersion = null);
	}
}
