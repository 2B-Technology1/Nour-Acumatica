...
namespace PX.Commerce.Shopify
{
	...
	public class SPConnector : BCConnectorBase<SPConnector>, IConnector
	{
		...
		public override IEnumerable<TInfo> GetExternalInfo<TInfo>(string infoType, int? bindingID)
		{
		...
		public override List<Tuple<String, String, String>> GetExternalFields(Int32? binding, String entity)
		{
			...
			{
				InventoryLocationRestDataProvider provider = new InventoryLocationRestDataProvider(GetRestClient(bindingShopify));
		...
		public static SPRestClient GetRestClient(BCBindingShopify binding, CancellationToken cancellationToken = default)
		{
			return GetRestClient(binding.ShopifyApiBaseUrl, binding.ShopifyApiKey, binding.ShopifyAccessToken, binding.StoreSharedSecret, binding.ApiCallLimit, cancellationToken);
		}
		public static SPRestClient GetRestClient(String url, String clientID, String accessToken, String sharedSecret, int? apiCallLimit, CancellationToken cancellationToken = default)
		{
			...
			SPRestClient client = new SPRestClient(restSerializer, options,
