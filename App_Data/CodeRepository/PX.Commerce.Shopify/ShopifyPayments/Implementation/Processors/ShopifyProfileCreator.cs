...
{
	public class ShopifyProfileCreator : ShopifyPaymentsDataProvider, ICCProfileCreator
	{
		public ShopifyProfileCreator(IShopifyRestClient restClient) : base(restClient)
		{
		}
