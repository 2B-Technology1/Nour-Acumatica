...
namespace PX.Commerce.Shopify.ShopifyPayments
{
    ...
    public static class ShopifyPluginMessages
    {
		...
		public const string TheOriginalTransactionXInTheCustomerRefundDocumentDoesNotBelongToTheRelatedPrepaymentDocument = "The original transaction in the Refund document ({0}) does not belong to the related Prepayment document.";
