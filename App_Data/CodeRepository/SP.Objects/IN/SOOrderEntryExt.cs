...
namespace SP.Objects.IN
{
    public class SOOrderEntryExt : PXGraphExtension<SOOrderEntry>
    {
		...
		protected virtual void _(Events.FieldSelecting<FinalConfirm, FinalConfirm.currencyStatus> e)
		{
			if (e.Row != null && Base.Document.Current != null)
			{
				e.Row.CurrencyStatus = Base.Document.Current.CuryID;
				e.ReturnState = Base.Document.Current.CuryID;
			}
		}
            ...
            PXRowInserted ins)
        {
            ...
            if (row != null && row.CustomerID == null)
            {
				...
				if (currentCustomer.CuryID != null || currentCustomer.BaseCuryID != null)
