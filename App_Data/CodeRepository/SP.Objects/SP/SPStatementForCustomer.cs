...
namespace SP.Objects.SP
{
	...
	public class SPStatementForCustomer : PXGraph<SPStatementForCustomer>
	{
		...
		[PXUIField(DisplayName = "Currency", FieldClass = "Multicurrency")]
		protected virtual void _(Events.CacheAttached<ARStatementForCustomer.DetailsResult.curyID> e)
		{
		}
		#endregion
		#region CuryStatementBalance
		[PXMergeAttributes(Method = MergeMethod.Merge)]
		[PXUIField(DisplayName = "Currency Statement Balance", FieldClass = "Multicurrency")]
		protected virtual void _(Events.CacheAttached<ARStatementForCustomer.DetailsResult.curyStatementBalance> e)
		{
		}
		#endregion
		#region CuryOverdueBalance
		[PXMergeAttributes(Method = MergeMethod.Merge)]
		[PXUIField(DisplayName = "Currency Overdue Balance", FieldClass = "Multicurrency")]
		protected virtual void _(Events.CacheAttached<ARStatementForCustomer.DetailsResult.curyOverdueBalance> e)
		{
		}
		#endregion
		#endregion
