...
namespace SP.Objects.SP
{
    public class PartnerBusinessAccountMaint : PXGraph<PartnerBusinessAccountMaint, BAccount>
    {
        ...
        public class PartnerBusinessAccountMaint_ActivityDetailsExt : ActivityDetailsExt<PartnerBusinessAccountMaint, BAccount>
        {
        ...
        public class CreateContactFromAccountGraphExt : CRCreateContactActionBase<PartnerBusinessAccountMaint, BAccount>
        {
            ...
            protected override PXSelectBase<CRPMTimeActivity> Activities => Base.GetExtension<PartnerBusinessAccountMaint_ActivityDetailsExt>().Activities;
