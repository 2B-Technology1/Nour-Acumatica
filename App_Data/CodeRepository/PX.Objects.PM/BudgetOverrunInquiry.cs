...
namespace PX.Objects.PM
{
	public class BudgetOverrunInquiry : PXGraph<BudgetOverrunInquiry>
	{
		...
		private PMBudgetControlLineExt CreateLine(PMBudgetControlLine line)
		{
			...
			result.TranDescription = line.TranDescription;
			return result;
		}
	...
	public class PMBudgetControlLineExt : PMBudgetControlLine
	{
		...
		public new abstract class projectDescription : BqlString.Field<projectDescription> { }
		...
		public new abstract class tranDescription : BqlString.Field<tranDescription> { }

		[PXString]
		[PXUIField(DisplayName = "Transaction Description")]
		public override string TranDescription
		{
			get;
			set;
		}
		...
		[PXUIField(DisplayName = "Project Currency", FieldClass = nameof(FeaturesSet.ProjectMultiCurrency))]
