...
namespace PX.Commerce.BigCommerce.API.REST
{
	...
	public class ProductData : BCAPIEntity
	{
		...
		[CommerceDescription(BigCommerceCaptions.ProductVariants, FieldFilterStatus.Skipped, FieldMappingStatus.Export)]
		public IList<ProductsVariantData> Variants { get; set; }

		[JsonIgnore]
		public IList<ProductsVariantData> VariantsToBeDeleted { get; set; } = new List<ProductsVariantData>();
