...
namespace PX.Objects.AM
{
    ...
    /// </summary>
    public class ConfigurationIDManager : IDManagerBase, IConfigurationIDManager
    {
	...
	public interface IConfigurationIDManager
	{
		string GetID(int? inventoryID, int? siteID);
	}
}
