...
namespace PX.Objects.AM
{
    ...
    /// </summary>
    public class PrimaryBomIDManager : IDManagerBase, IPrimaryBOMIDManager
    {
        /// <summary>
        ...
        public static AMBomItem GetRevisionBomItem(PXGraph graph, string bomId)
        {
            if (string.IsNullOrWhiteSpace(bomId))
            {
                return null;
		...
		public AMBomItem GetActiveRevisionBomItemByDate(string bomid, DateTime? effDate)
		{
			return GetActiveRevisionBomItemByDate(_Graph, bomid, effDate);
		}
	}

	public interface IPrimaryBOMIDManager
	{
		string GetPrimaryAllLevels(int? inventoryID, int? siteID, int? subItemID);
		AMBomItem GetActiveRevisionBomItemByDate(string bomid, DateTime? effDate);
    }
}
