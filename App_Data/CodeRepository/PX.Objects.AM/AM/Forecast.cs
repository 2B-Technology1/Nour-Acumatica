...
namespace PX.Objects.AM
{
    ...
    public class Forecast : PXGraph<Forecast>, PXImportAttribute.IPXPrepareItems
    {
        ...
        public PXSelectJoin<AMForecast,
			InnerJoin<Branch, On<AMForecast.branchID, Equal<Branch.branchID>>>,
			Where<Branch.baseCuryID, Equal<Current<AccessInfo.baseCuryID>>>> ForecastRecords;
        ...
        protected virtual void _(Events.RowPersisting<AMForecast> e)
        {
			...
			if (this.IsContractBasedAPI && (e.Row.ForecastID == "-1"))
			{
				e.Cancel = true;
			}
