...
namespace PX.Objects.AM
{
	...
	public class VendorShipmentEntry_Workflow : PXGraphExtension<VendorShipmentEntry>
	{
        ...
        public sealed override void Configure(PXScreenConfiguration config) =>
            Configure(config.GetScreenConfigurationContext<VendorShipmentEntry, AMVendorShipment>());

        protected static void Configure(WorkflowContext<VendorShipmentEntry, AMVendorShipment> context)
        {
