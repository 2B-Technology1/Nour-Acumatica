...
namespace PX.Objects.AM
{
    public class MPSMaint : PXGraph<MPSMaint>, PXImportAttribute.IPXPrepareItems
    {
        ...
        public PXSelectJoin<AMMPS,
			InnerJoin<Branch, On<AMMPS.branchID, Equal<Branch.branchID>>>,
			Where<Branch.baseCuryID, Equal<Current<AccessInfo.baseCuryID>>>> AMMPSRecords;
