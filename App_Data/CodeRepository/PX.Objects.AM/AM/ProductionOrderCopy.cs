    ...
    public class ProductionOrderCopy : ProductionBomCopy
    {
        ...
        protected virtual void CopyOperations(AMOrder order, AMProdItem productionCopyItem)
        {
            ...
            foreach (AMProdOper fromRow in fromRows)
            {
                ...
                toRow.EndDate = null;
                toRow.NoteID = null;
                toRow.ShippedQuantity = null;
                toRow.BaseShippedQuantity = null;
                toRow.ActualMachineTime = null;
                toRow.ActualSubcontract = null;
                toRow.POOrderNbr = null;
                toRow.POLineNbr = null;
