...
namespace PX.Objects.AM
{
    ...
    {
		public class AMProdMatlSplitPlan : AMProdMatlSplitPlan<ProductionBomCopyBase> { }
		public class AMProdItemSplitPlan : AMProdItemSplitPlan<ProductionBomCopyBase> { }
		...
		protected virtual void DeleteProductionDetail(AMProdItem amProdItem)
        {
            ...
            try
            {
                ...
                {
					var oper = ProcessingGraph.Caches<AMProdOper>().LocateElse(row);
                    //Doing this crazy set of zero to make sure the parent fields of AMProdTotal are correct when rebuilding details
					ProcessingGraph.Caches<AMProdOper>().SetValue<AMProdOper.planLaborTime>(oper, 0);
                    ProcessingGraph.Caches<AMProdOper>().SetValue<AMProdOper.planLabor>(oper, 0m);
                    ProcessingGraph.Caches<AMProdOper>().SetValue<AMProdOper.planMachine>(oper, 0m);
                    ProcessingGraph.Caches<AMProdOper>().SetValue<AMProdOper.planMaterial>(oper, 0m);
                    ProcessingGraph.Caches<AMProdOper>().SetValue<AMProdOper.planTool>(oper, 0m);
                    ProcessingGraph.Caches<AMProdOper>().SetValue<AMProdOper.planFixedOverhead>(oper, 0m);
                    ProcessingGraph.Caches<AMProdOper>().SetValue<AMProdOper.planVariableOverhead>(oper, 0m);
                    ProcessingGraph.Caches<AMProdOper>().SetValue<AMProdOper.planTotal>(oper, 0m);

					oper = (AMProdOper)ProcessingGraph.Caches<AMProdOper>().Update(oper);
					ProcessingGraph.Caches<AMProdOper>().Delete(oper);
                }
