...
namespace PX.Objects.AM
{
    ...
    public static class Messages
    {
        ...
        public const string ProdStatusInvalidForProcess = "The {0} {1} production order with the {2} status cannot be used in this process. Select a production order for which transactions are allowed according to the workflow.";
        ...
        public const string NotComplete = "The Inventory Planning regeneration process was not completed.";
        ...
        public const string ForecastNumberSequenceSetupNotEntered = "The forecast numbering sequence is required to use forecasts. Check the settings in {0}.";
		...
		public const string ProductionOrderUnreleasedTransactions = "The status of the {0} {1} production order cannot be changed because the order has related transactions that are not released. You must release or delete all the related transactions first.";
        ...
        public const string MPSTypeReferencedSetup = "The {0} MPS type ID was specified in Inventory Planning preferences as the default type.";
        ...
        public const string MrpFixedLeadTimeRequiresProdPreferencesCalendar = "Using fixed lead times in Inventory Planning requires the fixed calendar to be configured in production preferences.";
        ...
        public const string DateToMustBeGreaterThanDateFrom = "Date To must be greater than or equal to Date From";
		...
		public const string CannotPlanUnreleasedTransactionsExist = "The status of the {0} {1} production order cannot be changed from Released to Planned because the order has related transactions with the following batch or batches: {2}.";
		...
		public const string ProductionOrderUnreleasedVendorShipments = "The status of the {0} {1} production order cannot be changed because the order has related vendor shipments that are not released. You must release or delete all the related vendor shipments first.";
		public const string ProductionOrderUnreleasedClockEntries = "The status of the {0} {1} production order cannot be changed because the order has related clock entries that are not approved. You must approve or delete these clock entries first.";
        ...
        public const string PreassignedLotSerialNumberDoesNotExist = "The transaction cannot be created for Production Order {0} {1} because the {2} lot or serial number has not been preassigned.";
        public const string ExceededPreassignedLotSerialQuantity = "The transaction cannot be created for Production Order {0} {1} because the item quantity exceeds the preassigned item quantity for the {2} lot or serial number.";
		...
		public const string TransactionQtyOverCompleteOperWarning = "The quantity for Operation {0} would exceed the quantity to produce of {3} in Production Order {1} {2}.";
		public const string TransactionQtyOverCompleteOperError = "The quantity to complete for Operation {0} would exceed the quantity to produce of {3} in Production Order {1} {2}. Reduce the quantity in the operation row or increase the quantity to produce in the production order.";
		public const string WarehouseCannotBeCurrent = "Specify a warehouse that differs from the current warehouse.";
		public const string BranchBaseCurrencyDifference = "The branch base currency differs from the base currency of the {0} entity associated with the {1} business account.";
		public const string InvalidTreeDropOperToOper = "You cannot add an operation to another operation.";
		public const string InvalidTreeDropOperToNonSubMatl = "You cannot add an operation to a material which is not a subassembly.";
		public const string InvalidTreeDropMatlToMatl = "You cannot add a material to another material.";
		public const string InvalidTreeDropBomOnHold = "BOM {0} Revision {1} cannot be edited because it has a status other than On Hold.";
		public const string InvalidTreeDropECCRequired = "BOM {0} Revision {1} cannot be edited. You must create an ECR or ECO to make the changes in the bill of material.";
        public const string BuildingTransactionMaterialShortage = "Material shortage of {1} {0} was found for the {2} item in line {6} of the {5} operation in the {3} {4} order.";
		public const string BackflushUserEnterableNotAllocated = "The transaction cannot be released for the {1} operation in the {2} {3} order. The operation includes the {0} item, which is lot- or serial-tracked with the User-Enterable issue method and therefore the item cannot be backflushed.";
		public const string WorkCenterDoesNotSupportMultipleProductionOrders = "The {0} work center does not support clock entries for multiple production orders. It is either occupied by another production order or you are trying to clock in on multiple production orders with operations assigned to the work center.";
		public const string DuplicateClockInProductionOrder = "The selected employee has already clocked in for production order {0} {1}. Clock out of the production order first.";		
		public const string EmployeeNotClockedInOnOrder = "The selected employee is not currently clocked in on {0} {1}. Clock in to the production order first before clocking out of the production order.";
		public const string CalculatedLaborTimeLessThan1Minute = "The calculated labor time for the {0} operation of production order {1} {2} is less that 1 minute and therefore cannot be recorded.Would you like to set labor time to 1 minute? Otherwise the labor time record will be deleted.";
		public const string DeleteInvalidForClockEntryStatus = "Only new clock entries can be deleted.";
		public const string EstimatesAndDisableTaxCalculationConflictSOOrderType = "The Disable Automatic Tax Calculation and Allow Estimating check boxes cannot be selected simultaneously.";
		public const string EstimatesAndDisableTaxCalculationConflictSOOrder = "The Disable Automatic Tax Calculation check box cannot be selected for a sales order whose order type has the Allow Estimating check box selected on the Order Types (SO201000) form.";
		public const string ValueCannotBeLessThan = "The '{0}' field value ({1}) must be less than {2}.";
		public const string ValueCannotBeGreaterThan = "The '{0}' field value ({1}) must be greater than {2}.";
		public const string ClockEntryAlreadyExists = "The clock entry cannot be approved because a labor transaction with the {0} number has already been created for this clock entry.";
		public const string AvailableTimeForWorkCenterAndShiftCouldNotBeFound = "The available time for the {0} work center and {1} shift could not be found on the {2} schedule date.";
		public const string NegativeScrapReversalValidationError = "The total reversal quantity of scrapped items ({0}) is greater than the quantity of scrapped items ({4}) recorded for the {3} operation of the {1} {2} production order. Reduce the reversal quantity so that it is less than or equal to the recorded scrapped quantity.";
		public const string CannotUnreleasedAReleasedDocument = "The state of the {1} {0} transaction cannot be changed from released to not released.";
		public const string ExceedsOperationTimeFormat = "The full time {0} cannot be displayed. The full time exceeds the maximum time that is specified in the Operational Time Format box on the BOM Preferences (AM100000) form.";
		public const string MoveTransactionAlreadyExists = "The operation {0} cannot be deleted because a {1} batch {2} exists.";
        ...
        public const string MRPEngineStarting = "Inventory Planning Engine Starting";
        ...
        public const string MRPEngineCreateMRPPlan = "Creating the Inventory Plan";
        ...
        public const string MRPEngineUnableToFindItemInMRPCache = "The {0} inventory ID cannot be found in Planning item cache (the {1} first pass record ID).";
        ...
        public const string ErrorProcessingMrpDetailFpSupply = "An error occurred in Inventory Planning during processing the First Pass Detail record.";
        ...
        public const string MRPErrorProcessingDetailFP = "Inventory Planning Error processing First Pass Detail";
        ...
        public const string MrpIsRunningWaitFinished = "Inventory Planning is running. {0}. Wait until the process is finished.";
		...
		public const string ClockedIn = "Clocked In";
		public const string ClockedOut = "Clocked Out";
		...
		public const string NewTreeNodeOperation = "New Operation";
		public const string NewTreeNodeMaterial = "New Material";
		public const string DisableLockProductionWorkflowExist = "This check box cannot be cleared because production orders with the Locked status exist in the system. Close or unlock these production orders before clearing the check box.";
		public const string ProductionOrderLocked = "The production order is locked.";
		public const string ProductionOrderUnlock = "The production order is unlocked.";
		public const string LastRunDate = "Last Run Date";
		public const string UnableToSelectOrderToLink = "The {0} order cannot be selected as a parent order or a product order.";
        ...
        public const string MrpSetup = "Inventory Planning Preferences";
        public const string ProductionSetup = "Production Preferences";
        public const string MRPDetailInquiry = "Results by Item";
        ...
        public const string MRPFirstPassDetail = "Inventory Planning First Pass Detail";
        public const string MRPExceptions = "Inventory Planning Exceptions";
        public const string MRPAudit = "Inventory Planning Audit";
        ...
        public const string MRPBuckets = "Inventory Planning Buckets";
        public const string MRPBucketDetail = "Inventory Planning Bucket Detail";
        public const string MRPBucketInq = "Inventory Planning Bucket Inquiry";
        public const string MRPBucketDetailInq = "Inventory Planning Bucket Detail Inquiry";
        public const string MRPInventory = "Inventory Planning Inventory";
        ...
        public const string MRPDetailPlan = "Inventory Planning Detail Plan";
        ...
        public const string MRPDetailInventoryFilter = "Inventory Planning Detail Inventory Filter";
        ...
        public const string OverheadCurySettings = "Overhead Currency Settings";
        public const string ToolMstCurySettings = "Tools Currency Settings";
        public const string MachCurySettings = "Machine Currency Settings";
        public const string WCCurySettings = "Work Center Currency Settings";
        public const string BOMCurySettings = "BOM Currency Settings";
		public const string ConfigOptionCurySettings = "Config Option Currency Settings";
        ...
        public const string MRP = "Inventory Planning";
		...
		public const string OrderReleased = "OrderReleased";
		public const string OrderPlaceOnHold = "OrderPlaceOnHold";
		public const string OrderRemoveFromHold = "OrderRemoveFromHold";
		public const string OrderCompleted = "OrderCompleted";
		public const string OrderClosed = "OrderClosed";
		public const string OrderCancelled = "OrderCancelled";
		public const string OrderResetToPlan = "OrderResetToPlan";
		...
		public const string TransferWithoutReplenishmentWarehouse = "Transfer without Repl. Warehouse";
		public const string ReplenishmentWarehouseLoop = "Circular Transfer";
		public const string MRPExceptionTypeOrderWithoutSchedDate = "Order Without Sched. Shipment Date";
        ...
        public const string MRPPlan = "Requirement Plan";
        public const string MrpRequirement = "Inventory Planning Requirement";
		...
		public const string PlannedTransferDemand = "Planned Transfer Demand";
		public const string BlanketOrder = SO.Messages.BLName;
		...
		public const string SetMaterialsOpen = "Set Materials Status to Open";
		public const string SetMaterialsCompleted = "Set Materials Status to Completed";
		public const string ScheduleAndFirm = "Schedule and Firm";
		public const string UndoFirm = "Undo Firm";
		public const string CreateLaborTransaction = "Create Labor Transaction";
		#endregion
