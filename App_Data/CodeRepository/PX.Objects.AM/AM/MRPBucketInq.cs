...
namespace PX.Objects.AM
{
    ...
    public class MRPBucketInq : PXGraph<MRPBucketInq>
    {
        ...
        public PXSelectJoin<AMMRPBucketDetailInq, InnerJoin<INSite, On<AMMRPBucketDetailInq.siteID, Equal<Current<INSite.siteID>>>>,
    ...
    public class BucketFilter : IBqlTable
    {
        ...
        [AMSite]
		[PXDefault(typeof(Search<InventoryItemCurySettings.dfltSiteID, Where<InventoryItemCurySettings.inventoryID, Equal<Current<BucketFilter.inventoryID>>,
