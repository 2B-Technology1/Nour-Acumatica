...
namespace PX.Objects.AM
{
    public class CreateECOsProcess : PXGraph<CreateECOsProcess>
    {
		...
		protected virtual void _(Events.RowSelected<AMECRItem> e)
		{
			if (e.Row == null)
			{
				return;
			...
			PXUIFieldAttribute.SetVisible<AMECRItem.siteID>(e.Cache, null, !MBCEnabled);
		}
	...
	/// <summary>
	/// Optional filter processing options on the Create ECOs (AM514000) form (corresponding to the <see cref="CreateECOsProcess"/> graph).
	/// </summary>
	[Serializable]
