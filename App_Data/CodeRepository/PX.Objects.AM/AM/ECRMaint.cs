...
namespace PX.Objects.AM
{
    ...
    public class ECRMaint : PXGraph<ECRMaint, AMECRItem>
    {
		...
		public class BomOperCurySettings : CurySettingsExtension<ECRMaint, AMBomOper, AMBomOperCury>
		{
		...
		public class BomToolCurySettings : CurySettingsExtension<ECRMaint, AMBomTool, AMBomToolCury>
		{
			public static bool IsActive() => true;
		...
		public class BomMatlCurySettings : CurySettingsExtension<ECRMaint, AMBomMatl, AMBomMatlCury>
		{
			public static bool IsActive() => true;
		...
		protected virtual void EnableECRItemFields(PXCache cache, AMECRItem item)
        {
			...
			PXUIFieldAttribute.SetVisible<AMECRItem.siteID>(cache, item, !MBCEnabled);
        }
