...
namespace PX.Objects.AM
{
    ...
    public class ProductionEventHelper
    {
        ...
        public static AMProdEvnt BuildTransactionEvent(AMBatch amBatch, AMProdItem prodOrdId)
        {
            ...
            var eventDescription = $"{AMDocType.GetDocTypeDesc(amBatch.DocType)} {Messages.GetLocal(Messages.Transaction)}";
        ...
        public static AMProdEvnt BuildStatusEvent(AMProdItem amProdItem, string oldStatusID, string newStatusID)
        {
			...
			return BuildStatusEvent(amProdItem, oldStatusID, newStatusID, eventType);
        }

		public static AMProdEvnt BuildStatusEvent(AMProdItem amProdItem, string oldStatusID, string newStatusID, int eventType)
		{
			return new AMProdEvnt
			{
				EventType = eventType,
