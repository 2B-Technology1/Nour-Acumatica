...
namespace PX.Objects.AM
{
	...
	public class ProductionWhereUsedInq : PXGraph<ProductionWhereUsedInq>
	{
		...
		protected virtual List<WhereUsedProductionDetail> LoadAllData()
		{
			...
			slctdmatl.WhereAnd<Where<Branch.baseCuryID, Equal<Current<AccessInfo.baseCuryID>>>>();
			...
			foreach (PXResult<AMProdMatl, AMProdMatlLotSerial, InventoryItem, AMProdItem, Branch, AMProdItemSplit, BAccount, ParentInventoryItem, INLotSerClass> result in slctdmatl.Select())
			{
