...
namespace PX.Objects.AM
{
		...
		where TDocType : IConstant, IBqlOperand, new()
	{
		...
		protected virtual void _(Events.RowUpdated<AMScanUserSetup> e) => e.Row.IsOverridden = (e.Row.DefaultWarehouse != Setup.Current.DefaultWarehouse);
		protected virtual void _(Events.RowInserted<AMScanUserSetup> e) => e.Row.IsOverridden = (e.Row.DefaultWarehouse != Setup.Current.DefaultWarehouse);
		#endregion
		...
		public sealed class OperationState : OperationStateBase<TSelf>
			{
