...
namespace PX.Objects.AM
{
	...
	/// This relationship can be viewed and edited on the Late Assignment (AM312000) form (corresponding to the <see cref="LateAssignmentMaint"/> graph).
	/// </summary>
    ...
    public class AMProdMatlLotSerial : IBqlTable
    {
        ...
        public class PK : PrimaryKeyOf<AMProdMatlLotSerial>.By<orderType, prodOrdID, operationID, lineID, lotSerialNbr, parentLotSerialNbr>
        {
            public static AMProdMatlLotSerial Find(PXGraph graph, string orderType, string prodOrdID, int? operationID, int? lineID, 
                string lotSerialNbr, string parentLotSerialNbr, PKFindOptions options = PKFindOptions.None) 
                => FindBy(graph, orderType, prodOrdID, operationID, lineID, lotSerialNbr, parentLotSerialNbr, options);
        ...
        [PXDBString(INLotSerialStatusByCostCenter.lotSerialNbr.Length, IsUnicode = true, IsKey = true)]
        [PXDefault("")]
