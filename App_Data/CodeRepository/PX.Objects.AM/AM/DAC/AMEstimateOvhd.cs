...
{
	/// <summary>
	/// Maintenance table for the overheads on an estimate operation on the Estimate Operations (AM304000) form (corresponding to the <see cref="EstimateOperMaint"/> graph).
    ...
    public class AMEstimateOvhd : IBqlTable, IEstimateOper, INotable
    {
        ...
        {
            public static AMEstimateOvhd Find(PXGraph graph, string estimateID, string revisionID, int? operationID, int? lineID, PKFindOptions options = PKFindOptions.None)
        ...
        [PXDefault(typeof(Search<AMOverheadCurySettings.costRate, Where<AMOverheadCurySettings.ovhdID, Equal<Current<AMEstimateOvhd.ovhdID>>,
