...
{
	/// <summary>
	/// The table with the product configurator option results. The data is based on the configuration maintenance data from the <see cref="AMConfigurationOption"/> class with the entered or calculated results during the configuration entry. New data is stored for each new configuration result.
	/// Parent: <see cref = "AMConfigurationResults"/>, <see cref = "AMConfigResultsFeature"/>
	/// </summary>
