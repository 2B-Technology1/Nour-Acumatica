...
namespace PX.Objects.AM
{
    ...
    [PXProjection(typeof(Select2<
        ...
        LeftJoin<INLotSerialStatusByCostCenter,
            On<INLotSerialStatusByCostCenter.inventoryID, Equal<AMMTranSplit.inventoryID>,
            And<INLotSerialStatusByCostCenter.subItemID, Equal<AMMTranSplit.subItemID>,
            And<INLotSerialStatusByCostCenter.siteID, Equal<AMMTranSplit.siteID>,
            And<INLotSerialStatusByCostCenter.locationID, Equal<AMMTranSplit.locationID>,
            And<INLotSerialStatusByCostCenter.lotSerialNbr, Equal<AMMTranSplit.lotSerialNbr>,
