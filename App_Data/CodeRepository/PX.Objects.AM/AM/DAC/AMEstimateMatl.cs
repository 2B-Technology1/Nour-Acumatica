...
{
	/// <summary>
	/// Maintenance table for the materials on an estimate operation on the Estimate Operations (AM304000) form (corresponding to the <see cref="EstimateOperMaint"/> graph).
    ...
    public class AMEstimateMatl : IBqlTable, IEstimateOper, IEstimateInventory, ISortOrder, INotable
    {
        ...
        {
            public static AMEstimateMatl Find(PXGraph graph, string estimateID, string revisionID, int? operationID, int? lineID, PKFindOptions options = PKFindOptions.None)
