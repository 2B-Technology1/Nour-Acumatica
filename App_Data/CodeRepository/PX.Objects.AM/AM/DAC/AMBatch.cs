...
{
	/// <summary>
	/// Information about the manufacturing transaction batch header. Transactions include the <see cref="AMDocType.Move"/>, <see cref="AMDocType.Labor"/>, <see cref="AMDocType.Material"/>, <see cref="AMDocType.WipAdjust"/>, <see cref="AMDocType.ProdCost"/>Cost, and <see cref="AMDocType.Disassembly"/> classes.
	/// </summary>
	[PXPrimaryGraph(
        new[] {
	        typeof (MoveEntry), 
