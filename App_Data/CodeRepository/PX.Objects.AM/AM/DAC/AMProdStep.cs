...
{
	/// <summary>
	/// Maintenance table for the steps on a production order operation on the Production Order Details (AM209000) form (corresponding to the <see cref="ProdDetail"/> graph).
