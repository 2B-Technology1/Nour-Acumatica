...
{
	/// <summary>
	/// Transaction table for a vendor shipment created on the Vendor Shipments (AM310000) form (corresponding to the <see cref="VendorShipmentEntry"/> graph).
    ...
    public class AMVendorShipLine : IBqlTable, INotable, ILSPrimary, IProdOper
    {
        ...
        {
            public static AMVendorShipLine Find(PXGraph graph, string shipmentNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None)
        ...
        [SubItem(
            ...
            typeof(LeftJoin<INSiteStatusByCostCenter,
                ...
                And<INSiteStatusByCostCenter.inventoryID, Equal<Optional<AMVendorShipLine.inventoryID>>,
                And<INSiteStatusByCostCenter.siteID, Equal<Optional<AMVendorShipLine.siteID>>,
        ...
        [AMSiteAvail(typeof(AMVendorShipLine.inventoryID), typeof(AMVendorShipLine.subItemID))]
		...
		[MfgLocationAvail(typeof(AMVendorShipLine.inventoryID), typeof(AMVendorShipLine.subItemID), typeof(AMVendorShipLine.siteID),
		  IsSalesType: typeof(Where<AMVendorShipLine.lineType, NotEqual<AMShipLineType.wIP>>),
		  IsReceiptType: typeof(Where<AMVendorShipLine.lineType, Equal<AMShipLineType.wIP>>),
