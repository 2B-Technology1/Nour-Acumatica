...
{
	/// <summary>
	/// The maintenance table for a product configurator configuration and revision as shown on the Configuration Maintenance (AM207500) form (corresponding to the <see cref="ConfigurationEntry"/> graph).
	/// </summary>
	...
	public class AMConfiguration : IBqlTable, INotable, IProductConfiguration
	{
		...
		{
			public static AMConfiguration Find(PXGraph graph, string configurationID, string revision, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, configurationID, revision, options);
