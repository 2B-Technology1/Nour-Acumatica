...
namespace PX.Objects.AM
{
    ...
    public class AMOrderType : IBqlTable
    {
        ...
        {
            public static AMOrderType Find(PXGraph graph, string orderType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderType, options);
        }
        #endregion
        ...
        [PXDBString(1, IsFixed = true)]
        [PXDefault(SetupMessage.AllowMsg)]
        [PXUIField(DisplayName = "Excess Qty. for Orders")]
        [SetupMessage.List]
		...
		#endregion
		#region ExceedQtyOperations
		/// <summary>
		/// Check if the Qty is exceeded for the operation
		/// </summary>
		public abstract class exceedQtyOperations : PX.Data.BQL.BqlString.Field<exceedQtyOperations> { }

		protected String _ExceedQtyOperations;
		/// <summary>
		/// Check if the Qty is exceeded for the operation
		/// </summary>
		[PXDBString(1, IsFixed = true)]
		[PXDefault(SetupMessage.AllowMsg)]
		[PXUIField(DisplayName = "Excess Qty. for Operations")]
		[SetupMessage.List]
		[PXUIEnabled(typeof(Where<AMOrderType.function, NotEqual<OrderTypeFunction.planning>>))]
		[PXUIVisible(typeof(Where<AMOrderType.function, NotEqual<OrderTypeFunction.planning>>))]
		public virtual String ExceedQtyOperations
		{
			get
			{
				return this._ExceedQtyOperations;
			}
			set
			{
				this._ExceedQtyOperations = value;
			}
		}
		#endregion
		#region ScrapSource
