...
namespace PX.Objects.AM
{
    ...
    public class AMBomOvhd : IBqlTable, IBomOper, INotable, IBomDetail
    {
        ...
        {
            public static AMBomOvhd Find(PXGraph graph, string bOMID, string revisionID, int? operationID, int? lineID, PKFindOptions options = PKFindOptions.None)
        ...
        [PXLineNbr(typeof(AMBomOper.lineCntrOvhd), DecrementOnDelete = false, ReuseGaps = false)]
