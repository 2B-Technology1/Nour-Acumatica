...
{
	/// <summary>
	/// Projection of the <see cref="AMClockTranSplit"/> class that represents the Line Details dialog box for the <see cref="AMClockItem"/> class on the Clock Entry (AM315000) form (corresponding to the <see cref="ClockEntry"/> graph).
	/// Parent: <see cref = "AMClockItem"/>
	/// </summary>
