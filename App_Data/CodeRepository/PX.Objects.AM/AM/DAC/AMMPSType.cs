...
{
	/// <summary>
	/// Maintenance table for Master Production Schedule Type records on the MPS Type (AM203000) form (corresponding to the <see cref="MPSType"/> graph).
	/// </summary>
	...
	public class AMMPSType : IBqlTable, INotable
    {
        ...
        {
            public static AMMPSType Find(PXGraph graph, string mPSTypeID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, mPSTypeID, options);
        }
