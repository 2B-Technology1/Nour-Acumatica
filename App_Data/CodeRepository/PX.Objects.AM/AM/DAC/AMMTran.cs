...
namespace PX.Objects.AM
{
    ...
    public class AMMTran : IBqlTable, ILSPrimary, IProdOper, IAMBatch, INotable, IProdCostTran
    {
        ...
        {
            public static AMMTran Find(PXGraph graph, string docType, string batNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) =>
        ...
        public static class FK
        {
			...
			public class Task : PX.Objects.PM.PMTask.PK.ForeignKeyOf<AMMTran>.By<projectID, taskID> { }
		...
		public virtual Int32? LaborTime { get; set; }
		#endregion
		#region LaborTimeRaw
		public abstract class laborTimeRaw : PX.Data.BQL.BqlInt.Field<laborTimeRaw> { }

		[PXInt]
		[PXUIField(Visibility = PXUIVisibility.Invisible, Visible = false)]
		public virtual Int32? LaborTimeRaw
		{
			get
			{
	...
	/// <summary>
	/// Projection of <see cref="AMMTran"/> for lot/serial information only.
	/// </summary>
    ...
    public class AMMTranLotSerialNbrAll : IBqlTable
    {
        ...
        protected String _LotSerialNbr;
        [PXDBString(INLotSerialStatusByCostCenter.lotSerialNbr.Length, IsUnicode = true, InputMask = "",  BqlField = typeof(AMMTran.lotSerialNbr))]
