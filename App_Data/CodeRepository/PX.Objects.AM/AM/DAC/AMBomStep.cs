...
namespace PX.Objects.AM
{
    ...
    public class AMBomStep : IBqlTable, IBomOper, INotable, IBomDetail
    {
        ...
        {
            public static AMBomStep Find(PXGraph graph, string bOMID, string revisionID, int? operationID, int? lineID, PKFindOptions options = PKFindOptions.None)
        ...
        [PXLineNbr(typeof(AMBomOper.lineCntrStep), DecrementOnDelete = false, ReuseGaps = false)]
