...
{
	/// <summary>
	/// Projection of the <see cref="AMMTran"/> class as a disassembly transaction line that is entered on the Disassembly (AM301500) form (corresponding to the <see cref="DisassemblyEntry"/> graph).
	/// </summary>
	[Serializable]
    ...
    public class AMDisassembleTran : AMMTran
    {
        ...
        {
	        public static AMDisassembleTran Find(PXGraph graph, string docType, string batNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) =>
		        FindBy(graph, docType, batNbr, lineNbr, options);
        }
        #endregion
        ...
        [SubItem(typeof(AMDisassembleTran.inventoryID),
            typeof(LeftJoin<INSiteStatusByCostCenter,
                ...
                And<INSiteStatusByCostCenter.inventoryID, Equal<Optional<AMDisassembleTran.inventoryID>>,
                And<INSiteStatusByCostCenter.siteID, Equal<Optional<AMDisassembleTran.siteID>>,
        ...
        [AMSiteAvail(typeof(AMDisassembleTran.inventoryID), typeof(AMDisassembleTran.subItemID))]
