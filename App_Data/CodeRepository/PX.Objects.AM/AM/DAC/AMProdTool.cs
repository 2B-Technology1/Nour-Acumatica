...
{
	/// <summary>
	/// Maintenance table for the tools on a production order operation on the Production Order Details (AM209000) form (corresponding to the <see cref="ProdDetail"/> graph).
    ...
    public class AMProdTool : IBqlTable, IProdOper, IPhantomBomReference, INotable
    {
        ...
        {
            public static AMProdTool Find(PXGraph graph, string orderType, string prodOrdID, int? operationID, int? lineID, PKFindOptions options = PKFindOptions.None) 
