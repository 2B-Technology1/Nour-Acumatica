...
{
	/// <summary>
	/// The default option when selecting the feature while maintaining a product configurator configuration. Maintains data on the Options tab of the Features (AM203500) form (corresponding to the <see cref="FeatureMaint"/> graph).
	...
	public class AMFeatureOption : IBqlTable, IConfigOption
    {
        ...
        {
            public static AMFeatureOption Find(PXGraph graph, string featureID, int lineNbr, PKFindOptions options = PKFindOptions.None)
