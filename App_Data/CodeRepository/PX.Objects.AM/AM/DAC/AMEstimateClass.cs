...
{
	/// <summary>
	/// The maintenance class of defaults for the estimates defined on the Estimate Classes (AM206000) form (corresponding to the <see cref="EstimateClassMaint"/> graph).
	/// </summary>
	[Serializable]
	...
	public class AMEstimateClass : IBqlTable
	{
        ...
        {
            public static AMEstimateClass Find(PXGraph graph, string estimateClassID, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, estimateClassID, options);
        }
