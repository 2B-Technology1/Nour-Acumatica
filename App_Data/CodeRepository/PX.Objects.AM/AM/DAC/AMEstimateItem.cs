...
namespace PX.Objects.AM
{
	...
	/// <item><description>Estimate Maintenance (AM303000) (corresponding to the <see cref="EstimateMaint"/> graph)</description></item>
	/// </list>
	/// </remarks>
	[Serializable]
	...
	public class AMEstimateItem : IBqlTable, IEstimateInventory, INotable
	{
		...
		{
			public static AMEstimateItem Find(PXGraph graph, string estimateID, string revisionID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, estimateID, revisionID, options);
		...
		[Branch(searchType: typeof(Search<Branch.branchID, Where<Branch.baseCuryID, Equal<Current<AccessInfo.baseCuryID>>>>), BqlField = typeof(Standalone.AMEstimateItem.branchID))]
        ...
        [AMSite(BqlField = typeof(Standalone.AMEstimateItem.siteID))]
