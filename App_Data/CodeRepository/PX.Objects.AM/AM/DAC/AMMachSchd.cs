...
{
	/// <summary>
	/// Table that contains the production schedule for a machine on a specific day. These records are generated by the <see cref="ProductionScheduleEngine"/> graph.
	/// </summary>
	[Serializable]
    ...
    public class AMMachSchd : IBqlTable, ISchd
    {
        ...
        {
            public static AMMachSchd Find(PXGraph graph, string machID, DateTime schdDate, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, machID, schdDate, options);
        }
