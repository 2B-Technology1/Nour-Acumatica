...
{
	/// <summary>
	/// Disassembly transaction batch header that is entered on the Disassembly (AM301500) form (corresponding to the <see cref="DisassemblyEntry"/> graph).
	/// This projection will manage both the <see cref="AMBatch"/> and <see cref="AMMTran"/> records for the disassembling item.
	/// </summary>
	[Serializable]
...
#pragma warning restore PX1032 // DAC properties cannot contain method invocations
        ...
        [INOpenPeriod(
            sourceType: typeof(AMDisassembleBatch.date),
...
#pragma warning restore PX1030
        ...
        [PXDBGuid(BqlField = typeof(AMMTran.noteID))]
        ...
        [SubItem(
            ...
            typeof(LeftJoin<INSiteStatusByCostCenter,
                On<INSiteStatusByCostCenter.subItemID, Equal<INSubItem.subItemID>,
                    And<INSiteStatusByCostCenter.inventoryID, Equal<Optional<AMDisassembleBatch.inventoryID>>,
                    And<INSiteStatusByCostCenter.siteID, Equal<Optional<AMDisassembleBatch.siteID>>,
        ...
        [AMSiteAvail(typeof(AMDisassembleBatch.inventoryID), typeof(AMDisassembleBatch.subItemID), 
