...
{	
	...
	public class AMMach : IBqlTable, INotable
    {
        ...
        {
            public static AMMach Find(PXGraph graph, string machID, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, machID, options);
        }
		...
		#endregion
		#region StdCost
		[Obsolete("This field is obsolete and will be removed in later Acumatica versions.  Use AMMachCurySettings.stdCost")]
