...
{
	/// <summary>
	/// The default attribute when selecting the feature while maintaining a product configurator configuration. Maintain data in the Attributes tab of the Features (AM203500) form (corresponding to the <see cref="FeatureMaint"/> graph).
	/// Parent: <see cref="AMFeature"/>
	/// </summary>
	[Serializable]
    ...
    public class AMFeatureAttribute : IBqlTable
	{
        ...
        {
            public static AMFeatureAttribute Find(PXGraph graph, string featureID, int lineNbr, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, featureID, lineNbr, options);
        }
