...
{
	/// <summary>
	/// The maintenance table for the configuration of the product configurator features under a configuration revision on the Configuration Maintenance (AM207500) form (corresponding to the <see cref="ConfigurationEntry"/> graph).
    ...
    public class AMConfigurationFeature : IBqlTable, IProductConfiguration
	{
        ...
        {
            public static AMConfigurationFeature Find(PXGraph graph, string configurationID, string revision, int? lineNbr, PKFindOptions options = PKFindOptions.None) 
