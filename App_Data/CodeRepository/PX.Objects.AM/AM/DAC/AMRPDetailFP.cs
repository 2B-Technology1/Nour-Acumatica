...
namespace PX.Objects.AM
{
	...
	public class AMRPDetailFP : IBqlTable
	{
        ...
        {
            public static AMRPDetailFP Find(PXGraph graph, int? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, recordID, options);
        }
		...
		#endregion
		#region LateDemand
		public abstract class lateDemand : PX.Data.BQL.BqlBool.Field<lateDemand> { }

		protected bool? _LateDemand;
		[PXBool]
		[PXUnboundDefault(false)]
		[PXUIField(DisplayName = "Late Demand", Visible = false)]
		public virtual bool? LateDemand
		{
			get
			{
				return this._LateDemand;
			}
			set
			{
				this._LateDemand = value;
			}
		}
		#endregion
	}
    ...
    public class AMRPDetailFPSupply : IBqlTable
    {
        ...
        protected string _Type;
        [PXDefault]
        [PXDBString(BqlField = typeof(AMRPDetailFP.type))]
        [PXUIField(DisplayName = "Type")]
        [MRPPlanningType.List]
        public virtual string Type
        {
