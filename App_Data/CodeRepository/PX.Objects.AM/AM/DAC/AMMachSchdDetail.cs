...
{
	/// <summary>
	/// Table that contains the production schedule detail for a machine within a single day. These records are generated by the <see cref="ProductionScheduleEngine"/> graph.
	/// Parent: <see cref="AMMachSchd"/>
	/// </summary>
	[Serializable]
    ...
    public class AMMachSchdDetail : IBqlTable, ISchdDetail<AMMachSchdDetail>, ISchdReference
    {
        ...
        {
            public static AMMachSchdDetail Find(PXGraph graph, int recordID, PKFindOptions options = PKFindOptions.None)
