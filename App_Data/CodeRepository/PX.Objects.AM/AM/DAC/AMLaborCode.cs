...
{
	/// <summary>
	/// Maintenance table for production labor codes setup on the Labor Codes (AM206500) form (corresponding to the <see cref="LaborCodeMaint"/> graph).
	/// </summary>
	[Serializable]
	...
	public class AMLaborCode : IBqlTable, INotable
    {
        ...
        {
            public static AMLaborCode Find(PXGraph graph, string laborCodeID, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, laborCodeID, options);
        }
