...
namespace PX.Objects.AM
{
    ...
    public class AMSchdItem : IBqlTable
	{
        ...
        {
            public static AMSchdItem Find(PXGraph graph, string orderType, string prodOrdID, int? schdID, PKFindOptions options = PKFindOptions.None) 
                => FindBy(graph, orderType, prodOrdID, schdID, options);
