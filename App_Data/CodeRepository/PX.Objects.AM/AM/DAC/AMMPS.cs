...
{
	/// <summary>
	/// Maintenance table for MRP production supply records on the Master Production Schedule (AM201000) form (corresponding to the <see cref="MPSMaint"/> graph).
	/// </summary>
	[Serializable]
    ...
    public class AMMPS : IBqlTable, INotable
    {
        ...
        {
            public static AMMPS Find(PXGraph graph, string mPSTypeID, string mPSID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, mPSTypeID, mPSID, options);
        }
