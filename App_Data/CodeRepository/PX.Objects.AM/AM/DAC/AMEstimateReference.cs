...
{
	/// <summary>
	/// Maintenance table for the references on an estimate on the Estimate Maintenance (AM303000) form (corresponding to the <see cref="EstimateMaint"/> graph).
    ...
    public class AMEstimateReference : IBqlTable
    {
        ...
        {
            public static AMEstimateReference Find(PXGraph graph, string estimateID, string revisionID, PKFindOptions options = PKFindOptions.None)
