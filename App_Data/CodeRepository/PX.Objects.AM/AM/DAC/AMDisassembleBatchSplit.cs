...
{
	/// <summary>
	/// Disassembly transaction line details for a <see cref="AMDisassembleBatch"/> batch header that is entered on the Line Details tab of the Disassembly (AM301500) form (corresponding to the <see cref="DisassemblyEntry"/> graph).
	/// Parent: <see cref="AMDisassembleBatch"/>
	/// </summary>
	[Serializable]
    ...
    public class AMDisassembleBatchSplit : IBqlTable, ILSDetail, IAMBatch
    {
        ...
        [SubItem(
            ...
            typeof(LeftJoin<INSiteStatusByCostCenter,
                ...
                And<INSiteStatusByCostCenter.inventoryID, Equal<Optional<AMDisassembleBatchSplit.inventoryID>>,
                And<INSiteStatusByCostCenter.siteID, Equal<Optional<AMDisassembleBatchSplit.siteID>>,
