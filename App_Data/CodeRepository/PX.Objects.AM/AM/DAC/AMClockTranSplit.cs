...
{
	/// <summary>
	/// The table that represents the Line Details dialog box for the <see cref="AMClockTran"/> class on the Clock Entry (AM315000), Multiple Production Clock Entry (AM316000), and Approve Clock Entries (AM516000) forms.
