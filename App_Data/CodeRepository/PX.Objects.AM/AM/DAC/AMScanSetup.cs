...
{
	/// <summary>
	/// The table with the settings for the barcode scanning forms. The settings are maintained on the Production Preferences (AM102000) form (corresponding to the <see cref="ProdSetup"/> graph).
	/// </summary>
	...
	public class AMScanSetup : IBqlTable
	{
		...
		{
			public static AMScanSetup Find(PXGraph graph, int? branchID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, options);
		}
		#endregion
