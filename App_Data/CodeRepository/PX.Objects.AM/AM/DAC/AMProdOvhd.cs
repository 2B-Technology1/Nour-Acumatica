...
{
	/// <summary>
	/// Maintenance table for the overheads on a production order operation on the Production Order Details (AM209000) form (corresponding to the <see cref="ProdDetail"/> graph).
    ...
    public class AMProdOvhd : IBqlTable, IProdOper, IPhantomBomReference, INotable
    {
        ...
        {
            public static AMProdOvhd Find(PXGraph graph, string orderType, string prodOrdID, int? operationID, int? lineID, PKFindOptions options = PKFindOptions.None) 
