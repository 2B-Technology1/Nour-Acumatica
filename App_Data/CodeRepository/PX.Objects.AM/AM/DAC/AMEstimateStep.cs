...
namespace PX.Objects.AM
{
    ...
    public class AMEstimateStep : IBqlTable, IEstimateOper, INotable
    {
        ...
        {
            public static AMEstimateStep Find(PXGraph graph, string estimateID, string revisionID, int? operationID, int? lineID, PKFindOptions options = PKFindOptions.None)
