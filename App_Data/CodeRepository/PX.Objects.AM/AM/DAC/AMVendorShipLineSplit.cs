...
{
	/// <summary>
	/// The Line Details table for a vendor shipment transaction created on the Vendor Shipments (AM310000) form (corresponding to the <see cref="VendorShipmentEntry"/> graph).
	/// Parent: <see cref="AMVendorShipment"/>, <see cref="AMVendorShipLine"/>
	/// </summary>
	[Serializable]
    ...
    public class AMVendorShipLineSplit : IBqlTable, ILSDetail
    {
        ...
        {
            public static AMVendorShipLineSplit Find(PXGraph graph, string shipmentNbr, int? lineNbr, int? splitLineNbr, PKFindOptions options = PKFindOptions.None)
