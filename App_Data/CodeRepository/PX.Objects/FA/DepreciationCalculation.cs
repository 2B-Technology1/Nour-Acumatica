...
namespace PX.Objects.FA
{
	public class DepreciationCalculation : PXGraph<DepreciationCalculation, FADepreciationMethod>
	{
		...
		public virtual void CalculateDepreciation(FABookBalance assetBalance, string maxPeriodID)
		{
			...
			this.FADetails.Cache.MarkUpdated(details);
																					...
																					OrderBy<Asc<FABookHistoryNextPeriod.finPeriodID>>>.SelectMultiBound(this, new object[] { assetBalance }))
			{
				...
				FABookBalance bookbal = assetBalance;
				string bookDeprFromPeriod = bookbal.DeprFromPeriod;
				string additionDeprFromPeriod = FABookPeriodUtils.PeriodPlusPeriodsCount(next.FinPeriodID, -(next.YtdReversed ?? 0), next.BookID, next.AssetID);
		...
		protected virtual IEnumerable<DepreciationMethodBase> GetDepreciationMethods()
		{
			...
			yield return new StraightLineFullDayMethod();
			yield return new AustralianPrimeCostMethod();
			yield return new AustralianDiminishingValueMethod(FASetup.Current);
			yield return new NewZealandDiminishingValueMethod();
			//yield break;
		}
		...
		private bool PerformCalculation(FABookBalance bookBalance, string maxPeriodID = null, PXGraph uiGraph = null)
		{
			...
			.SelectSingleBound(this, null, depreciationMethod.IncomingParameters.FixedAsset.ClassID);
			...
			where TField : IBqlField
		{
			...
			calculationParameters.OriginalAddition = calculationParameters.Additions.First();
			calculationParameters.OriginalAddition.MarkOriginal();
			...
			string maxPeriodID = null)
		{
			...
			if(depreciationSchedule.First().FinPeriodID != bookBalance.DeprFromPeriod)
				throw new ArgumentException(nameof(bookBalance.DeprFromPeriod));
	...
	public class DeprCalcParameters
	{
		...
		protected virtual DeprCalcParameters SelectFromDatabase(PXGraph graph)
		{
			...
			PXSelectBase<FABookPeriod> periodsCmd = new PXSelectReadonly<FABookPeriod,
			...
			PXSelectBase<FABookYear> yearsCmd = new PXSelectReadonly<FABookYear,
