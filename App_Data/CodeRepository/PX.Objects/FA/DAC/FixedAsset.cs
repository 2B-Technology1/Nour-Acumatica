...
namespace PX.Objects.FA
{
   ...
   public class FixedAssetStatus
   {
	...
	/// Fixed assets are edited on the Fixed Assets (FA303000) form (which corresponds to the <see cref="AssetMaint"/> graph).
	/// The fixed asset classes edited through the Fixed Asset Classes (FA201000) form (corresponds to the <see cref="AssetClassMaint"/> graph).
	/// </summary>
	[Serializable]
	...
	public partial class FixedAsset : IBqlTable
	{
		...
		{
			public static FixedAsset Find(PXGraph graph, int? assetID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, assetID, options);
		}
		#endregion
	...
	public partial class FAClass : FixedAsset
	{
		...
		{
			public static FAClass Find(PXGraph graph, int? assetID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, assetID, options);
		}
		public class UK : PrimaryKeyOf<FAClass>.By<assetCD>
		{
			public static FAClass Find(PXGraph graph, string assetCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, assetCD, options);
		}
		#endregion
