...
namespace PX.Objects.FA
{
	...
	public partial class FABookYear : IBqlTable, IYear
	{
		...
		{
			public static FABookYear Find(PXGraph graph, int? bookID, int? organizationID, String year, PKFindOptions options = PKFindOptions.None) => FindBy(graph, bookID, organizationID, year, options);
		}
	...
	#region FABookYearAlias
	[Serializable]
	[PXHidden]
	public class FABookYearAlias : FABookYear
	{
