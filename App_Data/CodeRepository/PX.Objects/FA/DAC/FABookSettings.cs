...
namespace PX.Objects.FA
{
	...
	public partial class FABookSettings : IBqlTable
	{
		...
		{
			public static FABookSettings Find(PXGraph graph, Int32? bookID, Int32? assetID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, bookID, assetID, options);
		}
