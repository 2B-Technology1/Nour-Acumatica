...
namespace PX.Objects.FA
{
	...
	public partial class FADepreciationMethod : IBqlTable
	{
		...
		{
			public static FADepreciationMethod Find(PXGraph graph, int? methodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, methodID, options);
		}
		public class UK : PrimaryKeyOf<FADepreciationMethod>.By<methodCD>
		{
			public static FADepreciationMethod Find(PXGraph graph, string methodCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, methodCD, options);
		}
