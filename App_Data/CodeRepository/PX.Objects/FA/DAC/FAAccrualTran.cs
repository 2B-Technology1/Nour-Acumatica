...
namespace PX.Objects.FA
{
	...
	public partial class FAAccrualTran : IBqlTable, IFALocation
	{
		...
		{
			public static FAAccrualTran Find(PXGraph graph, Int32? tranID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranID, options);
		}
		...
		#region GLTranQty
		public abstract class gLTranQtyCalc : PX.Data.BQL.BqlDecimal.Field<gLTranQtyCalc> { }
		[PXQuantity]
		[PXDBCalced(typeof(IIf<FAAccrualTran.tranID.IsNotNull, FAAccrualTran.gLTranQty, GLTran.qty>), typeof(decimal))]
		public virtual decimal? GLTranQtyCalc { get; set; }

		#endregion
		#region GLTranAmt
		public abstract class gLTranAmtCalc : PX.Data.BQL.BqlDecimal.Field<gLTranAmtCalc> { }
		[PXBaseCury]
		[PXDBCalced(typeof(IIf<FAAccrualTran.tranID.IsNotNull, FAAccrualTran.gLTranAmt, GLTran.debitAmt.Add<GLTran.creditAmt>>), typeof(decimal))]
