...
namespace PX.Objects.FA
{
	...
	public partial class FABookPeriodSetup: IBqlTable, IPeriodSetup
	{
		...
		{
			public static FABookPeriodSetup Find(PXGraph graph, Int32? bookID, String periodNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, bookID, periodNbr, options);
		}
