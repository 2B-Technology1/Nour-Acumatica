...
namespace PX.Objects.FA
{
	...
	public partial class FADetails : PX.Data.IBqlTable
	{
		...
		{
			public static FADetails Find(PXGraph graph, Int32? assetID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, assetID, options);
		}
		...
		public abstract class tagNbr : PX.Data.BQL.BqlString.Field<tagNbr>
		{
			...
			public class NumberingAttribute : AutoNumberAttribute
			{
				...
				public override void RowPersisting(PXCache sender, PXRowPersistingEventArgs e)
				{
					...
					FASetup fASetup = (FASetup)sender.Graph.Caches[typeof(FASetup)].Current;
					FADetails det = (FADetails)e.Row;
					FixedAsset fixedAsset = FixedAsset.PK.Find(sender.Graph, det.AssetID);

					if (det != null && fASetup.CopyTagFromAssetID == true && (e.Operation & PXDBOperation.Command) == PXDBOperation.Insert)
					{
						det.TagNbr = fixedAsset.AssetCD;
					}
				}
			}
			#endregion
		...
		/// The field is filled in only for disposed fixed assets.
		/// </value>
		[GL.FinPeriodID(BqlField = typeof(FADetails.disposalPeriodID))]
...
namespace PX.Objects.FA.Standalone
{
	...
	public partial class FADetails : PX.Data.IBqlTable
	{
		...
		public class PK : PrimaryKeyOf<FADetails>.By<assetID>
		{
			public static FADetails Find(PXGraph graph, int? assetID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, assetID, options);
		}
		public static class FK
		{
			public class FixedAsset : FA.FixedAsset.PK.ForeignKeyOf<FADetails>.By<assetID> { }
