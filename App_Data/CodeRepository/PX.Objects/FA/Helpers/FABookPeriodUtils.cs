...
namespace PX.Objects.FA
{
	class FABookPeriodUtils : IFABookPeriodUtils
	{
		...
		public virtual int? PeriodMinusPeriod(string finPeriodID1, string finPeriodID2, int? bookID, int? assetID)
		{
		...
		public string PeriodPlusPeriodsCount(string finPeriodID, int counter, int? bookID, int? assetID)
		{
			...
			return PeriodPlusPeriodsCount(finPeriodID, counter, bookID, organizationID);
		}


		public string PeriodPlusPeriodsCount(string finPeriodID, int counter, int? bookID, int organizationID)
		{
		...
		{
			return PeriodPlusPeriodsCount(finPeriodID, 1, bookID, organizationID);
		}
