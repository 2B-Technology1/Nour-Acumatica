...
namespace PX.Objects.FA
{
	public class SplitProcess : PXGraph<SplitProcess>
	{
		...
		public void SplitFilter_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
            ...
            Splits.SetProcessWorkflowAction(
                filter.Action,
                filter.SplitDate,
		...
		public partial class SplitFilter : IBqlTable
		{
			...
			[PXDBBaseCury]
			[PXDefault(TypeCode.Decimal, "0.0", typeof(Search<
				FABookBalance.ytdDeprBase,
				Where<
					FABookBalance.assetID, Equal<Current<SplitFilter.assetID>>,
					And<FABookBalance.ytdDeprBase, NotEqual<Zero>>>,
				OrderBy<Desc<FABookBalance.updateGL, Asc<FABookBalance.bookCD>>>>
