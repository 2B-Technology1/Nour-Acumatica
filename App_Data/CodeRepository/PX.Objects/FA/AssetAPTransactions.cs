...
namespace PX.Objects.FA
{
	...
	public class AssetGLTransactions : PXGraph<AssetGLTransactions>
	{
		...
		protected virtual void FATran_RowInserting(PXCache sender, PXRowInsertingEventArgs e)
		{
			...
			if (Register.Current == null)
			{
				if (Filter.Current.BranchID == null)
				{
					throw new PXSetPropertyException(
							...
							PXUIFieldAttribute.GetDisplayName<GLTranFilter.branchID>(Filter.Cache));
				}
			...
			tranAmt = CM.PXCurrencyAttribute.BaseRound(this, tranAmt);
		...
		public override void Persist()
		{
			...
			foreach (FATran tran in ptrans)
			{
				...
				PXAccess.Organization organization = PXAccess.GetParentOrganization(asset.BranchID);
				if (!AssetMaint.IsPostingBookBalanceParametersValidInNonMigrationMode(this, organization?.OrganizationID, bal))
				{
					throw new PXSetPropertyException(
