...
namespace PX.Objects.EP
{
	...
	public class EPCustomerBilling : PXGraph<EPCustomerBilling>
	{
		...
		[PXFilterable]
		public PXFilteredProcessingOrderBy<CustomersList, BillingFilter, OrderBy<Asc<CustomersList.customerID, Asc<CustomersList.locationID>>>> Customers;
		public PXSelectJoinGroupBy<
			...
			Aggregate<
				...
				GroupBy<EPExpenseClaimDetails.customerLocationID>>>, 
			OrderBy<Asc<EPExpenseClaimDetails.customerID, Asc<EPExpenseClaimDetails.customerLocationID>>>> CustomersView;
