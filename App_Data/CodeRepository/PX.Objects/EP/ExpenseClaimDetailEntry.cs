...
namespace PX.Objects.EP
{
	public class ExpenseClaimDetailEntry : PXGraph<ExpenseClaimDetailEntry, EPExpenseClaimDetails>
	{
		...
		public class ExpenseClaimDetailEntry_ActivityDetailsExt : ActivityDetailsExt<ExpenseClaimDetailEntry, EPExpenseClaimDetails, EPExpenseClaimDetails.noteID>
		{
			public override Type GetBAccountIDCommand() => typeof(Select<EPEmployee, Where<EPEmployee.bAccountID, Equal<Current<EPExpenseClaimDetails.employeeID>>>>);

			public override Type GetEmailMessageTarget() => typeof(Select<Contact, Where<Contact.contactID, Equal<Current<EPEmployee.defContactID>>>>);
		}
