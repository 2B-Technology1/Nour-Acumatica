...
namespace PX.Objects.EP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<EPApproval>.By<approvalID>
		{
			public static EPApproval Find(PXGraph graph, int? approvalID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, approvalID, options);
		}
		public static class FK
		{
			public class ApprovalMap : EPAssignmentMap.PK.ForeignKeyOf<EPApproval>.By<assignmentMapID> { }

			public class Rule : EPRule.PK.ForeignKeyOf<EPApproval>.By<ruleID> { }
			public class Step : EPRule.PK.ForeignKeyOf<EPApproval>.By<stepID> { }

			public class DelegationRecord : EPWingman.PK.ForeignKeyOf<EPApproval>.By<delegationRecordID> { }
		}
		#endregion
		...
		#endregion
		#region OrigOwnerID
		public abstract class origOwnerID : PX.Data.BQL.BqlInt.Field<origOwnerID> { }
		/// <summary>
		/// When an approval request is created, the system save the assignee (approval request OwnerID) in a OrigOwnerID field.
		/// </summary>
		[Owner(DisplayName = "Originally Assigned To", Visibility = PXUIVisibility.SelectorVisible)]
		...
		/// <summary>
		///  Approval request current assignee.
		/// </summary>
		...
		#endregion
		#region DelegationRecordID
		public abstract class delegationRecordID : PX.Data.BQL.BqlInt.Field<delegationRecordID> { }
		/// <summary>
		/// This field is filled in than approval reassigned according to delegation defined in <see cref="EPWingman"/>.
		/// </summary>
		/// <value>
		/// This field corresponds to the <see cref="EPWingman.RecordID"/>.
		/// </value>
		[PXDBInt]
		[PXUIField(DisplayName = "Delegation")]
		public virtual Int32? DelegationRecordID { get; set; }
		#endregion
		#region Ignore Delegations
		public abstract class ignoreDelegations : PX.Data.BQL.BqlBool.Field<ignoreDelegations> { }
		/// <summary>
