...
namespace PX.Objects.EP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<EPRule>.By<ruleID>
		{
			public static EPRule Find(PXGraph graph, Guid? ruleID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, ruleID, options);
		}
		...
		#endregion
		#region AllowReassignment
		public abstract class allowReassignment : PX.Data.BQL.BqlBool.Field<allowReassignment> { }
		/// <summary>
