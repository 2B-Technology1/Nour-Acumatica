...
namespace PX.Objects.EP
{
	...
	public class EPAttendee : IBqlTable
	{
		...
		{
			public static EPAttendee Find(PXGraph graph, Guid? eventNoteID, Guid? attendeeID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, eventNoteID, attendeeID, options);
		}
