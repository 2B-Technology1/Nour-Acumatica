...
namespace PX.Objects.EP
{
	...
	public class EPEmployeePosition : PX.Data.IBqlTable
    {
		...
		[PXUIEnabled(typeof(Where<startReason.IsEqual<EPStartReason.newStatus>.Or<startReason.IsEqual<EPStartReason.rehire>>>))]
	...
	public static class EPStartReason
	{
		...
		public class newStatus : Data.BQL.BqlString.Constant<newStatus>
		{
			public newStatus() : base(New) { }
		}

		public class rehire : Data.BQL.BqlString.Constant<rehire>
		{
			public rehire() : base(Rehire) { }
		}

		public class promotion : Data.BQL.BqlString.Constant<promotion>
		{
			public promotion() : base(Promotion) { }
		}

		public class demotion : Data.BQL.BqlString.Constant<demotion>
		{
			public demotion() : base(Demotion) { }
		}

		public class newSkills : Data.BQL.BqlString.Constant<newSkills>
		{
			public newSkills() : base(NewSkills) { }
		}

		public class reorganization : Data.BQL.BqlString.Constant<reorganization>
		{
			public reorganization() : base(Reorganization) { }
		}

		public class other : Data.BQL.BqlString.Constant<other>
		{
