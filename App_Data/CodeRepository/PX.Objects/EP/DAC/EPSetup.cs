...
namespace PX.Objects.EP
{
	...
	public class EPSetupExpenseClaimDetailApproval : EPSetup, IAssignedMap
	{
		int? IAssignedMap.AssignmentMapID
		{
			get
			{
				return this.ClaimDetailsAssignmentMapID;
			}
			set
			{
				this.ClaimDetailsAssignmentMapID = value;
			}
		}
		...
		int? IAssignedMap.AssignmentNotificationID
		{
			get
			{
				return this.ClaimDetailsAssignmentNotificationID;
			}
			set
			{
				this.ClaimDetailsAssignmentNotificationID = value;
			}
		}
		...
		bool? IAssignedMap.IsActive
		{
			get
			{
				return this.ClaimDetailsAssignmentMapID.HasValue;
			}
		}
	}
}
