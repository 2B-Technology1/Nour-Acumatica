...
namespace PX.Objects.EP
{
	...
	/// An expense claim is edited on the Expense Claim (EP301000) form (which corresponds to the <see cref="ExpenseClaimEntry"/> graph).
	/// </summary>
	[Serializable]
	...
	public partial class EPExpenseClaim : IBqlTable, PX.Data.EP.IAssign, IAccountable
	{
		...
		{
			public static EPExpenseClaim Find(PXGraph graph, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, options);
		}
		...
		/// <summary>
		/// The identifier of the <see cref="Contact">contact</see> who actually approved the document.
		/// </summary>
		...
		/// <summary>
		/// The identifier of the <see cref="Customer"/> associated with the expense claim.
		/// </summary>
		...
		/// <summary>
		/// The identifier of the customer <see cref="Location">location</see> associated with the document.
		/// </summary>
