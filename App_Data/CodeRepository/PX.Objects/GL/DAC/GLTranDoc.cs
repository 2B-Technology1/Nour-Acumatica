...
namespace PX.Objects.GL
{
	...
	public partial class GLTranDoc : IBqlTable, IInvoice
	{
		...
		{
			public static GLTranDoc Find(PXGraph graph, String module, String batchNbr, Int32? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, module, batchNbr, lineNbr, options);
		}
		public static class FK
		{
			...
			public class Task : PMTask.PK.ForeignKeyOf<GLTranDoc>.By<projectID, taskID> { }
		...
		/// For more information see <see cref="Split"/> field and the documentation for the Journal Vouchers (GL304000) form.
		/// </summary>
		[PXDBInt]
		...
		[Account(typeof(GLTranDoc.branchID),
			typeof(Search2<Account.accountID,
										...
										LeftJoin<CashAccountETDetail, On<CashAccountETDetail.cashAccountID, Equal<CashAccount.cashAccountID>,
										...
										Where<Where2<Where<Optional<GLTranDoc.tranModule>, Equal<GL.BatchModule.moduleCA>,
												...
												And<Where<CAEntryType.drCr, Equal<CADrCr.cACredit>,
													Or<CashAccountETDetail.cashAccountID, IsNotNull>>>>>,
		...
		[Terms(typeof(GLTranDoc.tranDate), typeof(GLTranDoc.dueDate), typeof(GLTranDoc.discDate), typeof(GLTranDoc.curyTranTotal), typeof(GLTranDoc.curyDiscAmt), typeof(GLTranDoc.curyTaxTotal))]
