...
namespace PX.Objects.GL.ADL
{
	...
	public partial class Sub : PX.Data.IBqlTable
	{
		...
		{
			public static Sub Find(PXGraph graph, int? subID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, subID, options);
		}
		public class UK : PrimaryKeyOf<Sub>.By<subCD>
		{
			public static Sub Find(PXGraph graph, string subCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, subCD, options);
		}
		#endregion
