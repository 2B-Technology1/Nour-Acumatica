...
namespace PX.Objects.GL
{
	...
	public partial class GLVoucherBatch : PX.Data.IBqlTable
	{
		...
		{
			public static GLVoucher Find(PXGraph graph, String workBookID, String voucherBatchNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, workBookID, voucherBatchNbr, options);
		}
