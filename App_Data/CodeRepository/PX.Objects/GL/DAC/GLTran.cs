...
namespace PX.Objects.GL
{
	...
	/// The transactions are grouped in <see cref="Batch">batches</see>
	...
	public partial class GLTran : PX.Data.IBqlTable, IAccountable
	{
		...
		{
			public static GLTran Find(PXGraph graph, String module, String batchNbr, Int32? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, module, batchNbr, lineNbr, options);
		}
		...
		/// </value>
		[PXDBLong()]
		[CurrencyInfo(typeof(CurrencyInfo.curyInfoID), Required = true)]
	...
	//	[PXDBDecimal(4)]
		...
		public abstract class tranClass : PX.Data.BQL.BqlString.Field<tranClass>
		{
			...
			public class prepaymentInvoice : PX.Data.BQL.BqlString.Constant<prepaymentInvoice> { public prepaymentInvoice() : base(PrepaymentInvoice) { } }
			public const string PrepaymentInvoice = "Y";
			public class zeroRecord : PX.Data.BQL.BqlString.Constant<zeroRecord> { public zeroRecord() : base(ZeroRecord) { } }
	...
	public partial class GLTranAlias : GLTran
	{
		...
		{
			public static GLTranAlias Find(PXGraph graph, String module, String batchNbr, Int32? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, module, batchNbr, lineNbr, options);
		}
		public static class FK
		{
