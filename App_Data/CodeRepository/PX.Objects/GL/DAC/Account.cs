...
namespace PX.Objects.GL
{
	...
	{
		/// <summary>
		/// GL Account, Financial Accounting
		/// </summary>
		public const string GLAccount = "F";

		public IEnumerable<ValueLabelPair> ValueLabelPairs => new ValueLabelList
		{
			{ GLAccount, Messages.Account }
		};
		...
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
				new string[] { GLAccount },
				new string[] { Messages.Account })
			{ }
		}

		public class gLAccount : PX.Data.BQL.BqlString.Constant<gLAccount>
		{
			public gLAccount() : base(GLAccount)
			{
			}
		}
	}
	...
	/// (which corresponds to the <see cref="AccountMaint"/> graph).
	/// </summary>
	[System.SerializableAttribute()]
	[PXCacheName(Messages.Account, CacheGlobal = true)]
	...
	public partial class Account : PX.Data.IBqlTable, PX.SM.IIncludable
	{
		...
		{
			public static Account Find(PXGraph graph, int? accountID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, accountID, options);
		}
		public class UK : PrimaryKeyOf<Account>.By<accountCD>
		{
			public static Account Find(PXGraph graph, string accountCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, accountCD, options);
		}
		...
		public abstract class accountingType : PX.Data.BQL.BqlString.Field<accountingType> { }

		/// <summary>
		/// The type of the Entity. Extensibility point.
		/// </summary>
		/// <value>
		/// Possible values are:
		...
		[PXDefault(AccountEntityType.GLAccount)]
