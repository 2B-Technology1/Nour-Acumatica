...
namespace PX.Objects.GL
{
	...
	public partial class GLAllocationDestination : PX.Data.IBqlTable
    {
		...
		{
			public static GLAllocationDestination Find(PXGraph graph, String gLAllocationID, Int32? lineID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, gLAllocationID, lineID, options);
		}
		...
		[Branch(null, typeof(Search2<Branch.branchID,
					...
					LeftJoin<OrganizationLedgerLink,
						...
						And<CurrentValue<GLAllocation.allocLedgerBalanceType>, NotEqual<LedgerBalanceType.actual>>>>>,
					Where2<Match<Current<AccessInfo.userName>>,
						And2<MatchWithBranch<Branch.branchID>,
						And<Where<CurrentValue<GLAllocation.allocLedgerBalanceType>, NotEqual<LedgerBalanceType.actual>,
							And<OrganizationLedgerLink.ledgerID, Equal<Current<GLAllocation.allocLedgerID>>,
							Or<CurrentValue<GLAllocation.allocLedgerBalanceType>, Equal<LedgerBalanceType.actual>,
							And<Branch.baseCuryID, Equal<CurrentValue<GLAllocation.allocLedgerBaseCuryID>>>>>>>>>>),
			useDefaulting: false)]
        ...
        [AccountCDWildcard(typeof(Search<Account.accountCD, Where<Account.active, Equal<True>,
								And<Account.accountingType, Equal<AccountEntityType.gLAccount>>>>), DescriptionField = typeof(Account.description), DisplayName="Base Account")]        
