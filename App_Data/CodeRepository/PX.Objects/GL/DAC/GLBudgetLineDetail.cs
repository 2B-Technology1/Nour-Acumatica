...
namespace PX.Objects.GL
{
	...
	public partial class GLBudgetLineDetail : IBqlTable
	{
		...
		{
			public static GLBudgetLineDetail Find(PXGraph graph, int? branchID, int? ledgerID, Guid? groupID, string finYear, string finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, ledgerID, groupID, finYear, finPeriodID, options);
		}
