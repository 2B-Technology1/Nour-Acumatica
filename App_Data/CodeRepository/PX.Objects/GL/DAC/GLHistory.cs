...
namespace PX.Objects.GL
{
    ...
    public partial class GLHistory : BaseGLHistory, PX.Data.IBqlTable
	{
		...
		{
			public static GLHistory Find(PXGraph graph, Int32? ledgerID, Int32? branchID, Int32? accountID, Int32? subID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, ledgerID, branchID, accountID, subID, finPeriodID, options);
		}
	...
	public class BaseGLHistory 
	{
		...
		[PXSelector(typeof(Ledger.ledgerID),
			...
			DescriptionField = typeof(Ledger.descr), SubstituteKey = typeof(Ledger.ledgerCD), CacheGlobal = true)]
