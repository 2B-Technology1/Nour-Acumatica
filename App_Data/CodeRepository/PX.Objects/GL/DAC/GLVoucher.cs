...
namespace PX.Objects.GL
{
	...
	/// Cash Purchases (AP304000) form (which corresponds to the <see cref="AP.APQuickCheckEntryExt"/> graph),
	...
	public partial class GLVoucher: PX.Data.IBqlTable
	{
		...
		{
			public static GLVoucher Find(PXGraph graph, String workBookID, String voucherBatchNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, workBookID, voucherBatchNbr, lineNbr, options);
		}
		...
		/// The code is selected by user on the Journal Vouchers (GL304000) form (<see cref="GLWorkBookID.WorkBookID"/> field)
		...
		/// !REV!
		/// The unique voucher code for the selected <see cref="Module"/> and <see cref="TranType">Type</see> of the document.
		/// The code is selected by user on the Journal Vouchers (GL304000) form (<see cref="GLVoucherBatchNbr.VoucherBatchNbr"/> field)
		/// when entering the lines of the batch and determines the module and type of the document or transaction
		/// to be created from the corresponding line of the document batch.
