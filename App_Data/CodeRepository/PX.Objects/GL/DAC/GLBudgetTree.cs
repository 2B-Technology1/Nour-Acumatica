	...
	public partial class GLBudgetTree : PX.Data.IBqlTable, PX.SM.IIncludable
	 {
		...
		{
			public static GLBudgetTree Find(PXGraph graph, Guid? groupID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, groupID, options);
		}
		...
		/// </value>
		 [Account(null, typeof(Search<Account.accountID,
			 Where<Account.accountCD, Like<Current<SelectedNode.accountMaskWildcard>>>,
