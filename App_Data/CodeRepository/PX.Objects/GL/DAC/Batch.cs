...
namespace PX.Objects.GL
{
	...
	{ 
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
			new string[] { Hold, Balanced, Unposted, Posted, Completed, Voided, Released, PartiallyReleased, Scheduled, PendingApproval, Rejected },
			new string[] { Messages.Hold, Messages.Balanced, Messages.Unposted, Messages.Posted, Messages.Completed, Messages.Voided, Messages.Released, Messages.PartiallyReleased, Messages.Scheduled, Messages.PendingApproval, Messages.Rejected }) { }
		}
	...
	/// <summary>
	/// A batch of <see cref="GLTran">journal transactions</see>.
	/// The records of this type are edited through the Journal Transactions (GL301000) form
	/// (which corresponds to the <see cref="JournalEntry"/> graph).
	...
	public partial class Batch : PX.Data.IBqlTable, IApprovable
	{
		#region Keys
		public class PK : PrimaryKeyOf<Batch>.By<module, batchNbr>
		{
			public static Batch Find(PXGraph graph, String module, String batchNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, module, batchNbr, options);
		}
        ...
        /// </value>
		[PXDBLong()]
		[PX.Objects.CM.CurrencyInfo(Required = true)]
        ...
        /// </summary>
        /// <value>
        /// This field is set to <c>true</c> by the Journal Vouchers (GL304000) form (<see cref="JournalWithSubEntry"/> graph)
        ...
        /// </summary>
        /// <value>
        /// This field is populated only by the <see cref="JournalEntry"/> graph, which corresponds to the Journal Transactions (GL301000) form.
        /// </value>
        [PXInt]
		...
		public virtual bool? ReleasedToVerify
		{
			get;
			set;
		}
		#endregion
		#region PostedToVerify
		public abstract class postedToVerify : PX.Data.BQL.BqlBool.Field<postedToVerify> { }
		/// <summary>
		/// When set, on persist checks, that the document has the corresponded <see cref="Posted"/> original value.
		/// When not set, on persist checks, that <see cref="Posted"/> value is not changed.
		/// Throws an error otherwise.
		/// </summary>
		[Common.Attributes.PXDBRestrictionBool(typeof(posted))]
		public virtual bool? PostedToVerify
		{
			get;
			set;
		}
