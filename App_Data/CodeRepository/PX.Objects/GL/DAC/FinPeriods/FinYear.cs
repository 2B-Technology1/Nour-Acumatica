...
namespace PX.Objects.GL.FinPeriods.TableDefinition
{
	public class FinYear: IBqlTable
	{
		...
		{
			public static FinYear Find(PXGraph graph, int? organizationID, string year, PKFindOptions options = PKFindOptions.None) => FindBy(graph, organizationID, year, options);
