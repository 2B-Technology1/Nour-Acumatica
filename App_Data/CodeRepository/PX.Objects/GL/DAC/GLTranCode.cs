...
namespace PX.Objects.GL
{
	...
	public partial class GLTranCode : PX.Data.IBqlTable
	{
		...
		{
			public static GLTranCode Find(PXGraph graph, String module, String tranType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, module, tranType, options);
		}
		#endregion
        ...
        /// The code is selected by user on the Journal Vouchers (GL304000) form (<see cref="GLTranCode.TranCode"/> field)
