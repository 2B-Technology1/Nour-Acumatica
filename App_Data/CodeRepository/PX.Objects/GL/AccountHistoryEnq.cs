...
namespace PX.Objects.GL
{
	...
	public class AccountHistoryEnq : PXGraph<AccountHistoryEnq>
	{
		...
		protected virtual IEnumerable enqResult()
		{
			...
			{
				cmd.WhereAnd<Where<GLHistoryByPeriod.branchID, InsideBranchesOf<Current<GLHistoryEnqFilter.orgBAccountID>>,
		...
		[Obsolete(Common.Messages.MethodIsObsoleteAndWillBeRemoved2023R2)]
