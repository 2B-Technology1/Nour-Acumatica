...
namespace PX.Objects.GL
{
	...
	public class GLAccessDetail : PX.SM.UserAccess
	{
		...
		[PXDimensionSelector(AccountAttribute.DimensionName, typeof(Search<Account.accountCD,
				Where<Account.accountingType, Equal<AccountEntityType.gLAccount>>>), typeof(Account.accountCD))]
		...
		public new PXSave<SegmentValue> Save;
		public new PXCancel<SegmentValue> Cancel;
		public new PXFirst<SegmentValue> First;
		public new PXPrevious<SegmentValue> Prev;
		public new PXNext<SegmentValue> Next;
		public new PXLast<SegmentValue> Last;
	...
	{
		public new PXSave<Account> Save;
		public new PXCancel<Account> Cancel;
		public new PXFirst<Account> First;
		public new PXPrevious<Account> Prev;
		public new PXNext<Account> Next;
		public new PXLast<Account> Last;
	}

	public class GLAccessBySub : GLAccessDetail
	{
		public new PXSave<Sub> Save;
		public new PXCancel<Sub> Cancel;
		public new PXFirst<Sub> First;
		public new PXPrevious<Sub> Prev;
		public new PXNext<Sub> Next;
		public new PXLast<Sub> Last;
	}

	public class GLAccessByBranch : GLAccessDetail
	{
		public new PXSave<Branch> Save;
		public new PXCancel<Branch> Cancel;
		public new PXFirst<Branch> First;
		public new PXPrevious<Branch> Prev;
		public new PXNext<Branch> Next;
		public new PXLast<Branch> Last;
	}

	public class GLAccessByBudgetNode : GLAccessDetail
	{
		public new PXSave<GLBudgetTree> Save;
		public new PXCancel<GLBudgetTree> Cancel;
		public new PXFirst<GLBudgetTree> First;
		public new PXPrevious<GLBudgetTree> Prev;
		public new PXNext<GLBudgetTree> Next;
		public new PXLast<GLBudgetTree> Last;
	}

	public class GLAccessByPrinter : GLAccessDetail
	{
		public new PXSave<PX.SM.SMPrinter> Save;
		public new PXCancel<PX.SM.SMPrinter> Cancel;
		public new PXFirst<PX.SM.SMPrinter> First;
		public new PXPrevious<PX.SM.SMPrinter> Prev;
		public new PXNext<PX.SM.SMPrinter> Next;
		public new PXLast<PX.SM.SMPrinter> Last;
	}
