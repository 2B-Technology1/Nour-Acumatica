...
namespace PX.Objects.CN.Compliance.PM.GraphExtensions
{
    public class ChangeOrderEntryExt : PXGraphExtension<ComplianceViewEntityExtension<ChangeOrderEntry, PMChangeOrder>, ChangeOrderEntry>
    {
        ...
        [PXSelector(typeof(Search5<PMTask.taskID,
                LeftJoin<PMChangeOrderLine, On<PMChangeOrderLine.projectID, Equal<PMTask.projectID>, And<PMChangeOrderLine.taskID, Equal<PMTask.taskID>>>,
                    LeftJoin<PMChangeOrderBudget, On<PMChangeOrderBudget.projectID, Equal<PMTask.projectID>, And<PMChangeOrderBudget.projectTaskID, Equal<PMTask.taskID>>>>>,
		...
		[PXDBInt]
		[CostCodeDimensionSelector(typeof(Search5<PMCostCode.costCodeID,
			...
			Where<PMChangeOrderLine.refNbr, Equal<Current<PMChangeOrder.refNbr>>,
				Or<PMChangeOrderBudget.refNbr, Equal<Current<PMChangeOrder.refNbr>>>>,
			Aggregate<GroupBy<PMCostCode.costCodeID>>>))]
