    ...
    public abstract class ProjectTaskUsageValidationServiceBase : ProjectTaskValidationServiceBase
    {
        public void ValidateProjectTask(PMTask projectTask)
        {
            if (projectTask.Status.IsIn(ProjectTaskStatus.Planned, ProjectTaskStatus.Canceled) &&
                (IsTaskUsedInCostDocument(projectTask.ProjectID, projectTask.TaskID) || IsTaskUsedInRevenueDocument(projectTask.ProjectID, projectTask.TaskID)))
            {
        ...
        {
            return IsTaskUsed<PMChangeOrderBudget, PMChangeOrderBudget.projectID, PMChangeOrderBudget.projectTaskID,
