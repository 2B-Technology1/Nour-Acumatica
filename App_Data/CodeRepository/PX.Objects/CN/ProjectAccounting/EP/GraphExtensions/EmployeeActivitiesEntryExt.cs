...
namespace PX.Objects.CN.ProjectAccounting.EP.GraphExtensions
{
    public class EmployeeActivitiesEntryExt : PXGraphExtension<EmployeeActivitiesEntry>
    {
        ...
        protected virtual void _(Events.CacheAttached<EmployeeActivitiesEntry.PMTimeActivityFilter.projectTaskID> e)
        {
        }
        ...
        protected virtual void _(Events.CacheAttached<EPActivityApprove.projectTaskID> e)
        {
        }
    }
}
