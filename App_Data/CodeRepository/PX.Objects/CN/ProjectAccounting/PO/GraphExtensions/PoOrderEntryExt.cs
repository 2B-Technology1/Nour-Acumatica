...
namespace PX.Objects.CN.ProjectAccounting.PO.GraphExtensions
{
    public class PoOrderEntryExt : PXGraphExtension<POOrderEntry>
    {
        ...
        public virtual IEnumerable availableProjectItems()
        {
            ...
            foreach (PXResult<PMCostBudget, PMTask, PMCostCode> res in select.Select(ProjectDefaultAttribute.NonProject()))
            {
        ...
        {
            if (Base.Document.Current?.VendorID != null && !ChangeOrderReleaseScope.IsActive)
            {
