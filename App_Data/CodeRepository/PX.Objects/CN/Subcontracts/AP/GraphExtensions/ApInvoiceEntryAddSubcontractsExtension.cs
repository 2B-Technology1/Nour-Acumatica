...
namespace PX.Objects.CN.Subcontracts.AP.GraphExtensions
{
        ...
        APInvoiceEntry>
    {
		...
		public virtual void _(Events.RowSelected<APTran> args)
		{
			...
			PXUIFieldAttribute.SetEnabled<APTran.curyDiscAmt>(args.Cache, args.Row, Base.Document.Current?.DocType != APDocType.DebitAdj);
			PXUIFieldAttribute.SetEnabled<APTran.discPct>(args.Cache, args.Row, Base.Document.Current?.DocType != APDocType.DebitAdj);
		}
