...
namespace PX.Objects.Common.Extensions
{
	...
	public static class EnumerableExtensions
	{
		...
		/// </summary>
		public static IOrderedEnumerable<T> OrderByAccordanceTo<T>(this IEnumerable<T> source, Func<T, bool> predicate)
		...
		/// </summary>
		public static IOrderedEnumerable<T> ThenByAccordanceTo<T>(this IOrderedEnumerable<T> source, Func<T, bool> predicate)
			=> source.ThenByDescending(predicate);
