	...
	public static class RedirectionToOrigDoc
	{
        ...
        private static PXGraph PrepareDestinationGraph(string origDocType, string origRefNbr, string origModule, bool preferPrimaryDocForm)
		{
            ...
            switch (origModule)
            {
                ...
                case BatchModule.AR:
                    return PrepareDestinationGraphForAR(origDocType, origRefNbr, preferPrimaryDocForm);
        ...
        private static PXGraph PrepareDestinationGraphForAR(string origDocType, string origRefNbr, bool preferPrimaryDocForm)
        {
			if (origDocType == ARDocType.Invoice
				|| origDocType == ARDocType.PrepaymentInvoice
				|| origDocType == ARDocType.DebitMemo
				|| origDocType == ARDocType.CreditMemo && preferPrimaryDocForm)
			{
