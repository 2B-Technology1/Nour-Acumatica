...
namespace PX.Objects.Common.DAC
{
	...
	public class DropShipLink : IBqlTable
	{
		...
		{
			public static DropShipLink Find(PXGraph graph, string sOOrderType, string sOOrderNbr, int? sOLineNbr, string pOOrderType, string pOOrderNbr, int? pOLineNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, sOOrderType, sOOrderNbr, sOLineNbr, pOOrderType, pOOrderNbr, pOLineNbr, options);
		}
		public class UK
		{
			public class ByPOLine : PrimaryKeyOf<DropShipLink>.By<pOOrderType, pOOrderNbr, pOLineNbr>
			{
				public static DropShipLink Find(PXGraph graph, string pOOrderType, string pOOrderNbr, int? pOLineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, pOOrderType, pOOrderNbr, pOLineNbr, options);
			...
			{
				public static DropShipLink Find(PXGraph graph, string sOOrderType, string sOOrderNbr, int? sOLineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, sOOrderType, sOOrderNbr, sOLineNbr, options);
