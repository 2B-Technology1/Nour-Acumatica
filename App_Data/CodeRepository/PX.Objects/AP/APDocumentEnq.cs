...
namespace PX.Objects.AP
{
	...
	public class APDocumentEnq : PXGraph<APDocumentEnq>
	{
		...
		public class APRegister : IBqlTable
		{
			...
			/// </summary>
			/// <value>
			/// The value defaults to the period to which the <see cref="APRegister.DocDate"/> belongs,
			...
			/// <summary>
			/// The <see cref="PX.Objects.GL.FinPeriods.TableDefinition.FinPeriod">financial period</see>
			...
			/// <summary>
			/// The <see cref="PX.Objects.GL.FinPeriods.TableDefinition.FinPeriod">financial period</see> in which the document was closed.
			/// </summary>
			/// <value>
		...
		public virtual IEnumerable CreateInvoice(PXAdapter adapter)
		{
			if (Filter.Current?.VendorID != null)
			{
				...
				graph.BAccount.Current = (VendorR)BAccount.PK.Find(graph, this.Filter.Current.VendorID);
