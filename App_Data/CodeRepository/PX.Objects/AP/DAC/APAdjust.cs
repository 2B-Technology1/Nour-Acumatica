...
namespace PX.Objects.AP
{
		...
		: IBqlTable, IAdjustment, IDocumentAdjustment, IAdjustmentAmount, IAdjustmentStub, Common.GraphExtensions.Abstract.DAC.IFinAdjust
	{
		...
		{
			public static APAdjust Find(PXGraph graph, String adjgDocType, String adjgRefNbr, Int32? adjNbr, String adjdDocType, String adjdRefNbr, Int32? adjdLineNb, PKFindOptions options = PKFindOptions.None) 
											=> FindBy(graph, adjgDocType, adjgRefNbr, adjNbr, adjdDocType, adjdRefNbr, adjdLineNb, options);
		}
        ...
        /// <summary>
        /// Reference number of the adjusting document.
        /// </summary>
		...
		public partial class APInvoice : Standalone.APRegister
		{
			...
			public abstract class isJointPayees : PX.Data.BQL.BqlBool.Field<isJointPayees> { }
			[PXDBBool(BqlField = typeof(Standalone.APInvoice.isJointPayees))]
			[PXDefault(false)]
			...
			Where<APInvoice.vendorID, Equal<Optional<APPayment.vendorID>>, 
				...
				And2<Where<APPayment.refNbr, IsNull, 
					...
					And<Current<APPayment.docType>, Equal<APDocType.voidCheck>,
						Or<APPayment.refNbr, IsNotNull,
					And<Current<APPayment.docType>, Equal<APDocType.debitAdj>>>>>>>>>>>,
		...
		[PXCurrency(typeof(APAdjust.adjgCuryInfoID), typeof(APAdjust.origDocAmt), BaseCalc = false)]
        ...
        /// </summary>
        /// <value>
        /// Setting this field to <c>true</c> will change the <see cref="AdjgDocType">type of the adjusting document</see> to Voided Payment (<c>"VCK"</c>)
		...
		public abstract class pPDVATAdjRefNbr : PX.Data.BQL.BqlString.Field<pPDVATAdjRefNbr> { }

		/// <summary>
		/// The reference number of the adjustment, which is generated on the Generate VAT Adjustments (AP504500) form.
		/// </summary>
		/// <value>
		/// Corresponds to the <see cref="APInvoice.RefNbr"/> field.
		/// </value>
		[PXDBString(15, IsUnicode = true)]
		[PXSelector(typeof(Search<APInvoice.refNbr, Where<
			APInvoice.pendingPPD, Equal<True>,
			And<Where<APInvoice.docType, Equal<APDocType.debitAdj>, Or<APInvoice.docType, Equal<APDocType.creditAdj>>>>>>))]
		public virtual string PPDVATAdjRefNbr
		{
			get; set;
		}
		#endregion
		#region PPDVATAdjDocType
		public abstract class pPDVATAdjDocType : PX.Data.BQL.BqlString.Field<pPDVATAdjDocType> { }
		/// <summary>
		/// The doc type of the adjustment, which is generated on the Generate VAT Adjustments (AP504500) form.
		/// </summary>
		/// <value>
		/// Corresponds to the <see cref="APInvoice.docType"/> field.
		/// </value>
		...
		#region PPDVATAdjDescription
		public abstract class pPDVATAdjDescription : PX.Data.BQL.BqlString.Field<pPDVATAdjDescription> { }
		/// <summary>
		/// The description of the adjustment, which is generated on the Generate VAT Adjustments (AP504500) form.
		...
		/// </summary>
		/// <value>
		/// Value is <see cref="APAdjust.PPDVATAdjDocType"/> + <see cref="APAdjust.PPDVATAdjRefNbr"/> field.
		/// </value>
		[PXString(40, InputMask = "")]
		[PXUIField(DisplayName = "VAT Adj.", Enabled = false, Visible = false)]
    ...
    public partial class APAdjust2 : APAdjust
    {
		...
		{
			public static APAdjust2 Find(PXGraph graph, String adjgDocType, String adjgRefNbr, Int32? adjNbr, String adjdDocType, String adjdRefNbr, Int32? adjdLineNb, PKFindOptions options = PKFindOptions.None)
											=> FindBy(graph, adjgDocType, adjgRefNbr, adjNbr, adjdDocType, adjdRefNbr, adjdLineNb, options);
		}
...
namespace PX.Objects.AP.Standalone
{
	...
	public partial class APRegister : AP.APRegister
	{
		...
		/// <summary>
		/// This property was copied from the <see cref="APRegister">APRegister</see> class. It is overridden only for correct order of the fields 
	...
	public class APAdjust : IBqlTable
	{
		...
		/// </summary>
		[PXDBLong()]
		public virtual Int64? AdjgCuryInfoID { get; set; }
