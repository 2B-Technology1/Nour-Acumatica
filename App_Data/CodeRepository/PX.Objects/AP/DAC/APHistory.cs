...
namespace PX.Objects.AP
{
	...
	public partial class APHistory : PX.Data.IBqlTable
	{
		...
		{
			public static APHistory Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? vendorID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, vendorID, finPeriodID, options);
		}
	...
	public partial class APHistoryAlias : APHistory
	{
		...
		{
			public static APHistoryAlias Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? vendorID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, vendorID, finPeriodID, options);
		}
