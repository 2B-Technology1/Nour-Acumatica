...
namespace PX.Objects.AP
{
    ...
    public class APHistoryTran : IBqlTable
    {
        ...
        {
            public static APHistoryTran Find(PXGraph graph, string docType, string refNbr, int? lineNbr, int? id, PKFindOptions options = PKFindOptions.None) =>
        ...
        [PXDBCalced(typeof(
            Switch<
                Case<Where<APTranPostGL.type.IsEqual<APTranPost.type.retainage>>,
                    Data.BQL.Minus<APTranPostGL.turnRetainageAmt>.Multiply<APTranPost.glSign>>,
                decimal0>), typeof(decimal))]
    ...
    public class CuryAPHistoryTran : IBqlTable
    {
        ...
        {
            public static CuryAPHistoryTran Find(PXGraph graph, string docType, string refNbr, int? lineNbr, int? id, PKFindOptions options = PKFindOptions.None) =>
                FindBy(graph, docType, refNbr, lineNbr, id, options);
        }
        ...
        [PXDBCalced(typeof(
            Switch<
                Case<Where<APTranPostGL.type.IsEqual<APTranPost.type.retainage>>,
                    Data.BQL.Minus<APTranPostGL.curyTurnRetainageAmt>.Multiply<APTranPost.glSign>>,
                decimal0>), typeof(decimal))]
