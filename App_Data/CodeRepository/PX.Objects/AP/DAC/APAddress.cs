...
{
	/// <summary>
	/// A payment-specific remittance address.
	/// </summary>
	...
	public partial class APAddress : PX.Data.IBqlTable, IAddress, IAddressLocation
	{
		...
		{
			public static APAddress Find(PXGraph graph, Int32? addressID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, addressID, options);
		}
