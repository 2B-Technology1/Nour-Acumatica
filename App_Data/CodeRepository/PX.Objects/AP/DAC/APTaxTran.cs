...
namespace PX.Objects.AP
{
	...
	public partial class APTaxTran : TaxTran
	{
		...
		{
			public static APTaxTran Find(PXGraph graph, DateTime? tranDate, Int32? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranDate, recordID, options);
		}
