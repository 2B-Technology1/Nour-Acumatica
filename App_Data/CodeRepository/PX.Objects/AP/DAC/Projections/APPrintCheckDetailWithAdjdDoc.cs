...
namespace PX.Objects.AP
{
	...
	public class APPrintCheckDetailWithAdjdDoc : IBqlTable
	{
		...
		[PXDBCalced(typeof(IIf<Where<APPrintCheckDetail.source, Equal<AdjustmentGroupKey.AdjustmentType.outstandingBalance>>,
			APPrintCheckDetail.curyOutstandingBalance, APPrintCheckDetail.curyAdjgAmt>), typeof(decimal))]
		...
		[PXDecimal(4)]
		[PXDBCalced(typeof(IIf<Where<APPrintCheckDetail.source, Equal<AdjustmentGroupKey.AdjustmentType.outstandingBalance>>, APPrintCheckDetail.curyOutstandingBalance,
