...
namespace PX.Objects.AP
{
	...
	public class APPayment : APRegister, CM.IInvoice, IPrintCheckControlable, IAssign, IApprovable, IApprovalDescription, IReserved
	{
		...
		[APPaymentType.RefNbr(typeof(Search2<Standalone.APRegisterAlias.refNbr,
			...
			LeftJoinSingleTable<APInvoice, On<APInvoice.docType, Equal<Standalone.APRegisterAlias.docType>,
        ...
        [CashAccount(typeof(APPayment.branchID), typeof(Search<CashAccount.cashAccountID,
						Where2<Match<Current<AccessInfo.userName>>, 							
							And2<Where<CashAccount.clearingAccount, Equal<False>,
		...
		[APOpenPeriod(
			...
			branchSourceType: typeof(APPayment.branchID),
		...
		/// </summary>
		/// <value>
		/// Setting this field to <c>true</c> will change the <see cref="DocType">type of the document</see> to Voided Payment (<c>"VCK"</c>).
		/// </value>
		[PXBool()]
