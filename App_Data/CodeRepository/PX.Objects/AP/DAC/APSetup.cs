...
namespace PX.Objects.AP
{
	...
	public partial class APSetup : IBqlTable
	{
        ...
        /// Also this check box controls the Ext. Ref. Number box (<see cref="PX.Objects.GL.GLTranDoc.ExtRefNbr">GLTranDoc.ExtRefNbr</see>) on the Journal Vouchers (GL304000) form of the General Ledger module.
        /// </summary>
		[PXDBBool()]
		[PXDefault(true)]
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Require Single Project per Document", Visibility = PXUIVisibility.Visible)]
		...
		#region TermsInDebitAdjustments
		public abstract class termsInDebitAdjustments : PX.Data.BQL.BqlBool.Field<termsInDebitAdjustments> { }
		...
		public virtual bool? TermsInDebitAdjustments
		{
			get;
			set;
		}
