...
namespace PX.Objects.AP
{
	...
	public class APTranPost : IBqlTable
    {
		...
		{
			public static APTranPost Find(PXGraph graph, string docType, string refNbr, int? lineNbr, int? id, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, lineNbr, id, options);
		}
        ...
        [PXDBLong()]
        [CurrencyInfo(typeof(APRegister.curyInfoID), Required = true)]
        ...
        [PXFormula(typeof(
	        Switch<
				Case<
					Where<APTranPost.type.IsEqual<APTranPost.type.application>
						.And<APTranPost.isMigratedRecord.IsEqual<True>>
						.And<APTranPost.docType.IsIn<APDocType.invoice, APDocType.debitAdj, APDocType.creditAdj, APDocType.quickCheck, APDocType.voidQuickCheck>>>,
					APDocType.debitAdj.Concat<GLTran.tranClass.normal>,
				Case<
					Where<APTranPost.type.IsEqual<APTranPost.type.application>
						.And<APTranPost.isMigratedRecord.IsEqual<True>>
						.And<APTranPost.docType.IsIn<APDocType.check, APDocType.voidCheck, APDocType.refund, APDocType.voidRefund>>>,
					APDocType.debitAdj.Concat<GLTran.tranClass.payment>,
				Case<
					Where<APTranPost.type.IsEqual<APTranPost.type.application>
						.And<APTranPost.isMigratedRecord.IsEqual<True>>
						.And<APTranPost.docType.IsEqual<APDocType.prepayment>>>,
					APDocType.debitAdj.Concat<GLTran.tranClass.charge>,

				Case<
					Where<APTranPost.type.IsEqual<APTranPost.type.rgol>>,
					APTranPost.sourceDocType.Concat<GLTran.tranClass.rgol>,
				Case<
					Where<APTranPost.type.IsIn<APTranPost.type.application, APTranPost.type.rgol>
						.And<APTranPost.docType.IsIn<APDocType.invoice, APDocType.debitAdj, APDocType.creditAdj, APDocType.quickCheck, APDocType.voidQuickCheck>>>,
					APTranPost.sourceDocType.Concat<GLTran.tranClass.normal>,
				Case<
					Where<APTranPost.type.IsIn<APTranPost.type.application, APTranPost.type.rgol>
						.And<APTranPost.docType.IsIn<APDocType.check, APDocType.voidCheck, APDocType.refund, APDocType.voidRefund>>>,
					APTranPost.sourceDocType.Concat<GLTran.tranClass.payment>,
				Case<
					Where<APTranPost.type.IsIn<APTranPost.type.application, APTranPost.type.rgol>
						.And<APTranPost.docType.IsEqual<APDocType.prepayment>>>,
					APTranPost.sourceDocType.Concat<GLTran.tranClass.charge>,

				Case<
					Where<APTranPost.type.IsIn<APTranPost.type.origin, APTranPost.type.voided, APTranPost.type.adjustment>
					...
					docType.Concat<GLTran.tranClass.charge>,
				Case<
					Where<APTranPost.type.IsEqual<APTranPost.type.adjustment>>,
					docType.Concat<GLTran.tranClass.payment>,
				Case<
					Where<APTranPost.type.IsEqual<APTranPost.type.rgol>>,
					docType.Concat<GLTran.tranClass.rgol>,
				Case<
					Where<APTranPost.docType.IsIn<APDocType.invoice, APDocType.debitAdj, APDocType.creditAdj, APDocType.quickCheck, APDocType.voidQuickCheck>>,
					docType.Concat<GLTran.tranClass.normal>,
				Case<
					Where<APTranPost.docType.IsIn<APDocType.check, APDocType.voidCheck, APDocType.refund, APDocType.voidRefund>>,
					docType.Concat<GLTran.tranClass.payment>,
				Case<
					Where<APTranPost.docType.IsEqual<APDocType.prepayment>>,
					docType.Concat<GLTran.tranClass.charge>>>>>>>>>>>>>>>
        ))]
