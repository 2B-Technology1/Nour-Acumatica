...
namespace PX.Objects.AP
{
	...
	public partial class VendorClass : PX.Data.IBqlTable
	{
		...
		{
			public static VendorClass Find(PXGraph graph, String vendorClassID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, vendorClassID, options);
		}
		...
		[PXForeignReference(typeof(FK.TaxZone), Data.ReferentialIntegrity.ReferenceBehavior.SetNull)]
