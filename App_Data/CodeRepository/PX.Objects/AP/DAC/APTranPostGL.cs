...
namespace PX.Objects.AP
{
    ...
    public class APTranPostGL : IBqlTable
    {
        ...
        {
            public static APTranPostGL Find(PXGraph graph, string docType, string refNbr, int? lineNbr, int? id, PKFindOptions options = PKFindOptions.None) =>
        ...
        [PXDBCalced(typeof(
            Switch<
				Case<Where<APTranPost.type.IsEqual<APTranPost.type.application>
					.And<APTranPost.tranClass.IsEqual<APTranPost.tranClass.ADRU>>>,
					Mult<APTranPost.glSign, APTranPost.curyAmt>,
				Case<Where<APTranPost.type.IsEqual<APTranPost.type.application>
        ...
        [PXDBCalced(typeof(
            ...
            Switch<
				Case<Where<APTranPost.type.IsEqual<APTranPost.type.application>
						.And<APTranPost.tranClass.IsEqual<APTranPost.tranClass.ADRU>>>,
					Sub<Mult<APTranPost.glSign,APTranPost.amt>, APTranPost.rGOLAmt>,
				Case<Where<APTranPost.type.IsEqual<APTranPost.type.application>
