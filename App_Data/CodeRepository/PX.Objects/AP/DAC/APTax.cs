...
namespace PX.Objects.AP
{
	...
	/// <see cref="APInvoiceEntry"/> and <see cref="APQuickCheckEntry"/> graphs, respectively).
	/// </summary>
	...
	public partial class APTax : TaxDetail, PX.Data.IBqlTable, CM.ITranTax, ITaxDetailWithAmounts
	{
		...
		{
			public static APTax Find(PXGraph graph, String tranType, String refNbr, Int32? lineNbr, String taxID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranType, refNbr, lineNbr, taxID, options);
		}
