...
{
	/// <summary>
	/// A payment-specific remittance contact information.
	/// </summary>
	[Serializable()]
	[PXCacheName(Messages.APContact)]
	public partial class APContact : IBqlTable, IContact, CR.IEmailMessageTarget
	{
		#region Keys
		public class PK : PrimaryKeyOf<APContact>.By<contactID>
		{
			public static APContact Find(PXGraph graph, Int32? addressID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, addressID, options);
		}
