...
namespace PX.Objects.AP.Standalone
{
	...
	public partial class APRegisterAlias : AP.APRegister
	{
		...
		{
			public static APRegisterAlias Find(PXGraph graph, string docType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, options);
		}
