...
namespace PX.Objects.AP
{
	...
	public class APPrintCheckDetail : IBqlTable
	{
		...
		{
			public static APPrintCheckDetail Find(PXGraph graph, string adjgDocType, string adjgRefNbr, string source, string adjdDocType, string adjdRefNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, adjgDocType, adjgRefNbr, source, adjdDocType, adjdRefNbr, options);
		}
		#endregion
