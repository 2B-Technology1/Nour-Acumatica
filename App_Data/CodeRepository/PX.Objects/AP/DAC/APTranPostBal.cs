...
namespace PX.Objects.AP
{
    ...
    public class APTranPostBal : IBqlTable
    {
		...
		[PXDBCalced(typeof(
			Data.Round<
				Mult<
					Switch<Case<Where<Standalone.APRegister.paymentsByLinesAllowed, Equal<True>>, APTran.curyCashDiscBal>,
						Standalone.APRegister.curyDiscBal>,
