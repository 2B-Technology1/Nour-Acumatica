...
{
    /// <summary>
    /// An individual line of an accounts payable document.
    /// </summary>
	...
	public partial class APTran : IBqlTable, DR.Descriptor.IDocumentLine, ISortOrder, ITaxableDetail, IAccountable
	{
		...
		{
			public static APTran Find(PXGraph graph, string tranType, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranType, refNbr, lineNbr, options);
		}
        ...
        /// <summary>
        /// Reference number of the parent <see cref="APRegister">document</see>.
        /// </summary>
		...
		[PXDBBool()]
		[PXDefault(typeof(
			InventoryItem.postToExpenseAccount.FromSelectorOf<APTran.inventoryID>.
		...
		[PXSelector(
			typeof(Search<DR.DRSchedule.scheduleID,
				Where<DR.DRSchedule.bAccountID, Equal<Current<APInvoice.vendorID>>,
					And<Where2<
						Where<Current<APTran.tranType>, NotEqual<APDocType.creditAdj>, And<Current<APTran.tranType>, NotEqual<APDocType.debitAdj>>>,
						Or<Where<DR.DRSchedule.docType, NotEqual<Current<APTran.tranType>>,
							And<Where<Current<APTran.tranType>, Equal<APDocType.creditAdj>, Or<Current<APTran.tranType>, Equal<APDocType.debitAdj>>>>>>
						>>>>),
		...
		#endregion
		#region IsDirectTaxLine
		public abstract class isDirectTaxLine : PX.Data.BQL.BqlBool.Field<isDirectTaxLine> {}
		/// <summary>
		/// Indicates whether the line is direct tax line or not.
		/// </summary>
		[PXDBBool]
		[PXDefault(false)]
		public virtual Boolean? IsDirectTaxLine
		{
			get;
			set;
		}
	...
	public class APTran2: APTran
	{
		...
		public new abstract class tranBal : PX.Data.BQL.BqlDecimal.Field<tranBal> { }
	}
