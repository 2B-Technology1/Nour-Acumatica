...
namespace PX.Objects.AP
 {
	...
	/// (which are stored in <see cref="VendorDiscountSequence"/>).
	/// The APDiscount records are edited on the Vendor Discount Codes (AP204000) form,
	/// which corresponds to the <see cref="APDiscountMaint"/> graph.
	/// </summary>
	...
	public partial class APDiscount : PX.Data.IBqlTable
	 {
		...
		{
			public static APDiscount Find(PXGraph graph, Int32? discountID, Int32? bAccountID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, discountID, bAccountID, options);
		}
