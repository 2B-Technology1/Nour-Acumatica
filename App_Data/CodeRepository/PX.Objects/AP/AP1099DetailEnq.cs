...
namespace PX.Objects.AP
{
	...
	public class AP1099DetailEnq : PXGraph<AP1099DetailEnq>
	{
		...
		public PXSelectJoinGroupBy<AP1099Box,
			...
			Aggregate<GroupBy<AP1099Box.boxNbr, Sum<AP1099History.histAmt>>>, OrderBy<AP1099Box.boxCD.Asc>> YearVendorSummary;
		...
		public virtual void AP1099YearMaster_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
		{
			...
			if (row != null)
			{
				bool enableReports = row.VendorID != null && row.FinYear != null;
				year1099SummaryReport.SetEnabled(enableReports);
				year1099NECSummaryReport.SetEnabled(enableReports);
				year1099DetailReport.SetEnabled(enableReports);
			}
		}
