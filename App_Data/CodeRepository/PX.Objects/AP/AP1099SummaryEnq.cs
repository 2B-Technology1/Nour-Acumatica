...
namespace PX.Objects.AP
{
	...
	public class AP1099SummaryEnq : PXGraph<AP1099SummaryEnq>
	{
		...
		public PXSelectJoinGroupBy<AP1099Box, 
					...
					Aggregate<GroupBy<AP1099Box.boxNbr, Sum<AP1099History.histAmt>>>, OrderBy<AP1099Box.boxCD.Asc>>
					Year_Summary;
		...
		[PXProcessButton(Category = CS.ActionCategories.Processing, DisplayOnMainToolbar = true)]
