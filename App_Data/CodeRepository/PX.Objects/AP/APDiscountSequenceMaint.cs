...
namespace PX.Objects.AP
{
    ...
    /// which corresponds to the <see cref="APDiscountSequenceMaint"/> graph.
    /// </summary>
    ...
    public partial class VendorDiscountSequence : DiscountSequence
    {
		...
		{
            public static VendorDiscountSequence Find(PXGraph graph, int? vendorID, string discountID, string discountSequenceID, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, vendorID, discountID, discountSequenceID, options);
        }
        public class UK : PrimaryKeyOf<VendorDiscountSequence>.By<discountID, discountSequenceID>
        {
            public static VendorDiscountSequence Find(PXGraph graph, string discountID, string discountSequenceID, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, discountID, discountSequenceID, options);
        }
        #endregion
