...
namespace PX.Objects.SO
{
	...
	public partial class SOOrderSite : PX.Data.IBqlTable
	{
		...
		{
			public static SOOrderSite Find(PXGraph graph, string orderType, string orderNbr, int? siteID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderType, orderNbr, siteID, options);
		}
		...
		[PXUnboundFormula(typeof(IIf<openShipmentCntr.IsEqual<int0>.And<openLineCntr.IsGreater<int0>>, int1, int0>),
			typeof(SumCalc<SOOrder.openSiteCntr>), ValidateAggregateCalculation = true)]
