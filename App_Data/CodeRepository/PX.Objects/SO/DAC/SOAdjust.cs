...
namespace PX.Objects.SO
{
	...
	public partial class SOAdjust : PX.Data.IBqlTable, IAdjustment, ICreatePaymentAdjust
	{
		...
		{
			public static SOAdjust Find(PXGraph graph, int recordID, string adjdOrderType, string adjdOrderNbr, string adjgDocType, string adjgRefNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, recordID, adjdOrderType, adjdOrderNbr, adjgDocType, adjgRefNbr, options);
		}
		...
		[PXFormula(typeof(Maximum<Minimum<Sub<curyOrigAdjgAmt, curyAdjgBilledAmt>, Current<curyDocBal>>, decimal0>), typeof(SumCalc<ARPayment.curySOApplAmt>))]
