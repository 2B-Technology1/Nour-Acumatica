...
namespace PX.Objects.SO
{
	...
	public class SOPickingWorksheetShipment : IBqlTable
	{
		...
		{
			public static SOPickingWorksheetShipment Find(PXGraph graph, string worksheetNbr, string shipmentNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, worksheetNbr, shipmentNbr, options);
		}
