...
namespace PX.Objects.SO
{
	...
	public class SOPickPackShipSetup : IBqlTable
	{
		...
		{
			public static SOPickPackShipSetup Find(PXGraph graph, int? branchID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, options);
		}
		...
		#endregion
		#region ConfirmEachPackageDimensions
		...
		public abstract class confirmEachPackageDimensions : PX.Data.BQL.BqlBool.Field<confirmEachPackageDimensions> { }
		#endregion
		...
		#endregion
		#region AllowMultipleTotesPerShipment
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Add Totes to Shipments on the Fly")]
		public virtual bool? AllowMultipleTotesPerShipment { get; set; }
		public abstract class allowMultipleTotesPerShipment : PX.Data.BQL.BqlBool.Field<allowMultipleTotesPerShipment> { }
		#endregion
