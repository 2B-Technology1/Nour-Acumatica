...
namespace PX.Objects.SO.DAC.Projections
{
	...
	public class BlanketSOLineSplit : IBqlTable, IItemPlanSource
	{
		#region Keys
		public class PK : PrimaryKeyOf<BlanketSOLineSplit>.By<orderType, orderNbr, lineNbr, splitLineNbr>
		{
			public static BlanketSOLineSplit Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr, int? splitLineNbr, PKFindOptions options = PKFindOptions.None)
		...
		[PXDBString(INLotSerialStatusByCostCenter.lotSerialNbr.Length, IsUnicode = true, BqlField = typeof(SOLineSplit.lotSerialNbr))]
