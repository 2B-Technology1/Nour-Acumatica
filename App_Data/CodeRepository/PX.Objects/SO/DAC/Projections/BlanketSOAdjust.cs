...
namespace PX.Objects.SO.DAC.Projections
{
	...
	public class BlanketSOAdjust : IBqlTable
	{
		...
		{
			public static BlanketSOAdjust Find(PXGraph graph, int recordID, string adjdOrderType, string adjdOrderNbr, string adjgDocType, string adjgRefNbr, PKFindOptions options = PKFindOptions.None)
		...
		[PXDBTimestamp(BqlField = typeof(SOAdjust.Tstamp), VerifyTimestamp = VerifyTimestampOptions.BothFromGraphAndRecord)]
