...
namespace PX.Objects.SO
{
	...
	public class SOPickingWorksheetLineSplit : IBqlTable
	{
		...
		{
			public static SOPickingWorksheetLineSplit Find(PXGraph graph, string worksheetNbr, int? lineNbr, int? splitNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, worksheetNbr, lineNbr, splitNbr, options);
		}
