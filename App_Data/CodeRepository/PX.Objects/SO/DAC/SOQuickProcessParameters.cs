...
namespace PX.Objects.SO
{
	...
	using OrderTypeRequiresInvoicing = Where<SOOrderType.behavior.FromCurrent.IsIn<SOBehavior.sO, SOBehavior.iN, SOBehavior.cM, SOBehavior.mO>.
	...
	public class SOQuickProcessParameters : IBqlTable
	{
		...
		{
			public static SOQuickProcessParameters Find(PXGraph graph, string orderType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderType, options);
		}
