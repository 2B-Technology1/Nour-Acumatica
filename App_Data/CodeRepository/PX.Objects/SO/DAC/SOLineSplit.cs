...
namespace PX.Objects.SO
{
	...
	public partial class SOLineSplit : PX.Data.IBqlTable, ILSDetail, IItemPlanSource
	{
		#region Keys
		public class PK : PrimaryKeyOf<SOLineSplit>.By<orderType, orderNbr, lineNbr, splitLineNbr>
		{
			public static SOLineSplit Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr, int? splitLineNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, orderType, orderNbr, lineNbr, splitLineNbr, options);
		}
        ...
        [SiteAvail(typeof(inventoryID), typeof(subItemID), typeof(costCenterID),
			new Type[] { typeof(INSite.siteCD), typeof(INSiteStatusByCostCenter.qtyOnHand), typeof(INSiteStatusByCostCenter.qtyAvail), typeof(INSiteStatusByCostCenter.active), typeof(INSite.descr) },
		...
		#endregion
		#region BookedPlanType
		public abstract class bookedPlanType : PX.Data.BQL.BqlString.Field<bookedPlanType> { }
		[PXFormula(typeof(INPlanConstants.plan60))]
		public virtual String BookedPlanType
		{
			get;
			set;
		}
