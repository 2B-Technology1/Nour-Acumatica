...
namespace PX.Objects.SO
{
	...
	public partial class SOPackageDetail : PX.Data.IBqlTable
	{
		...
		[PXSelector(typeof(Search5<CSBox.boxID,
			...
			Or<Where<Current<SOShipment.shipVia>, IsNotNull,
				And<Where<CarrierPackage.carrierID, Equal<Current<SOShipment.shipVia>>, Or<CSBox.activeByDefault, Equal<True>>>>>>>,
		...
		public abstract class returnTrackNumber : PX.Data.BQL.BqlString.Field<returnTrackNumber> { }
		[PXDBString(60, IsUnicode = true)]
	...
	[PXProjection(typeof(Select2<SOPackageDetail, LeftJoin<CSBox, On<CSBox.boxID, Equal<SOPackageDetail.boxID>>,
		CrossJoin<CommonSetup>>>), new Type[] { typeof(SOPackageDetail) })]
