...
namespace PX.Objects.SO
{
	...
	public partial class SOShipmentDiscountDetail : PX.Data.IBqlTable, IDiscountDetail
	{
		...
		{
			public static SOShipmentDiscountDetail Find(PXGraph graph, int? recordID, string orderType, string orderNbr, string shipmentNbr, string type, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, recordID, orderType, orderNbr, shipmentNbr, type, options);
		}
