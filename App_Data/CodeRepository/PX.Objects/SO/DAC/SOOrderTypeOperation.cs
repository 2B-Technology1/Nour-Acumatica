...
namespace PX.Objects.SO
{
	...
	public partial class SOOrderTypeOperation : PX.Data.IBqlTable
	{
		...
		{
			public static SOOrderTypeOperation Find(PXGraph graph, string orderType, string operation, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderType, operation, options);
		}
