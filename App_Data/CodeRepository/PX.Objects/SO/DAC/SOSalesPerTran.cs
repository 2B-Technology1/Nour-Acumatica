...
namespace PX.Objects.SO
{
	...
	public partial class SOSalesPerTran : PX.Data.IBqlTable
	{
		...
		{
			public static SOSalesPerTran Find(PXGraph graph, string orderType, string orderNbr, int? salespersonID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, orderType, orderNbr, salespersonID, options);
		}
