...
namespace PX.Objects.SO
{
	...
	public class OpenBlanketSOLineSplit : IBqlTable
	{
		...
		{
			public static OpenBlanketSOLineSplit Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr, int? splitLineNbr, PKFindOptions options = PKFindOptions.None)
