...
namespace PX.Objects.SO
{
	...
	public partial class SOBlanketOrderLink : PX.Data.IBqlTable
	{
		...
		{
			public static SOBlanketOrderLink Find(PXGraph graph, string blanketType, string blanketNbr, string orderType, string orderNbr, PKFindOptions options = PKFindOptions.None) =>
				FindBy(graph, blanketType, blanketNbr, orderType, orderNbr, options);
		}
	...
	public partial class SOBlanketOrderDisplayLink : SOBlanketOrderLink
	{
		...
		{
			public static SOBlanketOrderDisplayLink Find(PXGraph graph, string blanketType, string blanketNbr, string orderType, string orderNbr, Guid? shippingRefNoteID, PKFindOptions options = PKFindOptions.None) =>
				FindBy(graph, blanketType, blanketNbr, orderType, orderNbr, shippingRefNoteID, options);
		}
		#endregion
