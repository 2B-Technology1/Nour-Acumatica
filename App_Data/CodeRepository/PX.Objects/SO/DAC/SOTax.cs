...
namespace PX.Objects.SO
{
	...
	public partial class SOTax : TaxDetail, PX.Data.IBqlTable, ITaxDetailWithLineNbr
	{
		...
		{
			public static SOTax Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr, string taxID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, orderType, orderNbr, lineNbr, taxID, options);
		}
