...
namespace PX.Objects.SO
{
	...
	public partial class SOFreightDetail : PX.Data.IBqlTable, IFreightBase
	{
		...
		{
			public static SOFreightDetail Find(PXGraph graph, string docType, string refNbr, string orderType, string orderNbr, string shipmentType, string shipmentNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, docType, refNbr, orderType, orderNbr, shipmentType, shipmentNbr, options);
		}
		public static class FK
		{
			...
			public class Task : PMTask.PK.ForeignKeyOf<SOFreightDetail>.By<projectID, taskID> { }
		}
		#endregion
		...
		[PXParent(typeof(FK.Order), LeaveChildren = true)]
		...
		[PXFormula(typeof(Add<curyPremiumFreightAmt, curyFreightAmt>), typeof(SumCalc<SOOrder.curyBilledFreightTot>))]
