...
{
	[Obsolete(Common.Messages.ItemIsObsoleteAndWillBeRemoved2023R1 + " Use " + nameof(DropShipLinkDialog) + " instead.")]
...
namespace PX.Objects.SO
{
	...
	[Obsolete(Common.Messages.ItemIsObsoleteAndWillBeRemoved2023R1 + " Use " + nameof(SupplyPOLine) + " instead.")]
