...
namespace PX.Objects.SO.GraphExtensions.SOOrderEntryExt
{
    public class AddRelatedItemsToOrder : AddRelatedItemExt<SOOrderEntry, SOOrder, SOLine>
    {
                ...
                Brackets<SOOrder.dontApprove.IsEqual<True>
                    .And<SOOrder.hold.IsEqual<True>
                        .Or<SOOrder.openShipmentCntr.IsEqual<Zero>
                            .And<Brackets<SOOrder.orderQty.IsEqual<decimal0>
								.Or<SOOrder.status.IsNotEqual<SOOrderStatus.completed>.And<Brackets<Use<Selector<SOOrder.orderType, SOOrderType.requireShipping>>.AsBool.IsEqual<False>>>>
								.Or<SOOrder.openLineCntr.IsGreater<Zero>>>>>>>
        ...
        {
            var availability = Base.ItemAvailabilityExt.FetchWithBaseUOM(line, excludeCurrent: true, line.CostCenterID);
