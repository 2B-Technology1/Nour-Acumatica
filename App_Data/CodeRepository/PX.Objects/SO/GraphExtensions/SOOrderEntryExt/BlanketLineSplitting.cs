...
namespace PX.Objects.SO.GraphExtensions.SOOrderEntryExt
{
	...
	public abstract class BlanketLineSplitting : PXGraphExtension<SOOrderLineSplittingAllocatedExtension, SOOrderLineSplittingExtension, SOOrderEntry>
	{
		...
		/// </summary>
		[PXOverride]
		public virtual void TruncateSchedules(SOLine line, decimal baseQty, HashSet<int?> lastUnshippedSchedules, Action<SOLine, decimal, HashSet<int?>> base_TruncateSchedules)
		{
			if (line.Behavior != SOBehavior.BL)
			{
