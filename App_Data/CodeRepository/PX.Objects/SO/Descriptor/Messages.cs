...
namespace PX.Objects.SO
{
	...
	public static class Messages
	{
		...
		public const string BlanketSOOrderSite = "Blanket SO Order Site";
		...
		public const string SOOrderInvoicesSPFilter = "SO Order Invoices Filter";
		public const string SOOrderInvoicesSPInqResult = "SO Order Invoices Inquiry Result";
		public const string SpecialOrderGIParameters = "Special Order GI Parameters";
		#endregion
		...
		public const string TimeInQueue = "Time in Queue";
		...
		public const string CreditCardProcessingIsDisabled = AR.Messages.CreditCardProcessingIsDisabled;
		...
		public const string OrderCheck_UnbilledQtyExceededPositive = "The unbilled quantity of the {0} item in the {1} order should not be less than zero or greater than the ordered quantity.";
		public const string OrderCheck_UnbilledQtyExceededNegative = "The unbilled quantity of the {0} item in the {1} order should not be less than the ordered quantity or greater than zero.";
		...
		public const string ItemNotAvailableTraced_Special = "The quantity of the {0} special-order item in the {1} warehouse is not sufficient to fulfill the order.";
		...
		public const string OrderTypeUnsupportedBehavior = "The Transfer inventory transaction type can be specified only for order types with the Transfer Order automation behavior.";
		...
		public const string OrderApplyAmount_Cannot_Exceed_Unrefunded = "The applied amount cannot exceed the unrefunded balance. Delete the refund, or remove the refund application on the Payments and Applications (AR302000) form.";
		public const string OrderApplyAmount_Cannot_Exceed_Unbilled = "The applied amount cannot exceed the unbilled balance. Delete or void the payment, or remove the payment application on the Payments and Applications (AR302000) form.";
		...
		public const string ShippedLineDeleting = "The line cannot be deleted because it is linked to a shipment.";
		public const string ReceivedLineDeleting = "The line cannot be deleted because it is linked to a purchase order.";
		...
		public const string LinkedPOLineIsCanceled = "The linked {0} purchase order line has been canceled.";
		public const string LinkedPOLineIsCompleted = "The linked {0} purchase order line has been completed.";
		...
		public const string NonStockKitWithNoSalesComponent = "The document cannot be saved because it includes a line with a non-stock kit that has components with the No Sales status.";
		...
		public const string CorrectionDocumentMissingLink = "The correction document does not have the link to the original document and cannot be released. Contact your Acumatica support provider for assistance.";
		...
		public const string OrderWithAppliedPaymentsCantBeDeleted = CannotDeleteBlanketWithPayment;
		...
		public const string RefundAmountMustBeLessUnrefunded = "The amount must be less than or equal to the unrefunded balance.";
		...
		public const string CapturePaymentWithHoldStatusError = "The payment cannot be captured because it has the On Hold status. To capture the payment, open it on the Payments and Applications (AR302000) form, and click Remove Hold.";
		...
		public const string InvoiceHasAlreadyBeenCreatedForThisSalesOrder = "A payment or prepayment cannot be created because there is a not released SO invoice which is linked directly to the sales order. To create a payment or prepayment, release the {0} invoice first.";
		...
		public const string CannotCorrectShipmentItemConverted = "The shipment cannot be corrected because the stock status of at least one item in it has changed.";
		public const string UnitCostUpdatedOnPO = "The cost has been updated in the related purchase order line.";
		public const string CannotMakeChangeOnSpecialOrder = "The line has been linked to the lines of the following purchase orders: {0}. To make changes in this column, you can try to unlink the purchase order lines by clicking the PO Link button and unlinking the purchase orders in the Purchasing Details dialog box.";
		public const string CannotChangeFieldOnSpecialOrder = "At least one special-order line has been linked to a purchase order. To make changes in this box, unlink the purchase orders by clicking the PO Link button for a line and unlinking the purchase order in the Purchasing Details dialog box.";
		public const string CannotClearSpecialOrderFlag = "The Special Order check box cannot be cleared because the related purchase order has been processed.";
		public const string SpecialLineExistsCancelOrder = "At least one line with a special-order item in the sales order is linked to a line of the purchase order. Do you want to cancel the sales order?";
		public const string SpecialLineReceivedCancelOrder = "The sales order cannot be canceled because it contains lines with special-order items. To cancel the order, you should update the inventory costs with the special costs by creating a transfer from the Special cost layer to Normal on the Transfers (IN304000) form.";
		public const string SpecialLineReceivedCancelOrderMassProcess = "Sales orders with special-order lines cannot be canceled on the current form. To cancel such orders, use the Sales Orders (SO301000) form.";
		public const string SpecialLineReceivedDeleteOrder = "The sales order cannot be deleted because special-order items have been received for it. To delete the order, you can transfer the items to the normal stock by creating a transfer from the Special cost layer to Normal on the Transfers (IN304000) form or write off the items by creating an issue for the Special cost layer on the Issues (IN302000) form.";
		public const string SpecialLineCompletedDeleteOrder = "You cannot delete the sales order because at least one special-order line is linked to a completed or billed purchase order line.";
		public const string SpecialLineCompletedDeleteLine = "You cannot delete the special-order line because it is linked to a completed purchase order line.";
		public const string SpecialLineExistsDeleteLine = "The line with a special-order item is linked to a line of a purchase order. Do you want to remove the link and delete the sales order line?";
		public const string SpecialLineReceivedDeleteLine = "The special-order line cannot be deleted because it is linked to a received purchase order line. To delete the line, you can transfer the items to the normal stock by creating a transfer from the Special cost layer to Normal on the Transfers (IN304000) form or write off the items by creating an issue for the Special cost layer on the Issues (IN302000) form.";
		public const string CannotCompleteReceivedSpecialLine = "The sales order cannot be completed because special-order items have been received for it but not fully issued. To complete the order, you can transfer the items to the normal stock by creating a transfer from the Special cost layer to Normal on the Transfers (IN304000) form or write off the items by creating an issue for the Special cost layer on the Issues (IN302000) form.";
		public const string CannotChangeSiteOnSpecialTransfer = "You can select only {0} as the destination warehouse because the transfer contains special-order items for this warehouse.";
		public const string CannotLinkPOWithDifferentCost = "The special-order line cannot be linked to this purchase order line because it has already been linked to at least one purchase order line with a different cost.";
		public const string OrderHaveLinesWithoutMargin = "Lines with zero unit cost and lines that are marked for drop-ship are not included in the calculation of margin for sales orders.";
		public const string IntercompanyShipmentShouldContainSingleOrder = "You cannot add multiple intercompany sales orders to the same shipment. Create a separate shipment for each order.";

		public const string LicenseShipLine = "The number of the lines in this document has exceeded the limit set for the current license. Please reduce the number of lines to be able to save the document";
		public const string LicenseShipLineSplit = "The number of the splits in this document has exceeded the limit set for the current license. Please reduce the number of splits to be able to save the document";
		public const string LicensePackageDetail = "The number of the packages in this document has exceeded the limit set for the current license. Please reduce the number of packages to be able to save the document";
		...
		public const string LineRequestedOn = "Line Requested On";
		public const string LineShipOn = "Line Ship On";
		...
		public const string MultiOrderShipment = "Multi-order shipment";
		...
		public const string MOName = "Mixed Order";
		#endregion
		...
		public const string ReverseInvoice = "Reverse Invoice";
		public const string CaptureCCPayment = "Capture";
		public const string VoidCCPayment = "Void Card Payment";
		public const string VoidCCEftPayment = "Void Card/EFT Payment";
		...
		public const string ImportCardPayment = "Import Card Payment";
		public const string ImportCardEftPayment = "Import Card/EFT Payment";
		...
		#region Disable Automatic Tax Calculation
		public const string CannotAddOrderToInvoiceDueToAutomaticTaxCalculationConflict = "The following sales orders cannot be added to the invoice because of inconsistencies in the states of the Disable Automatic Tax Calculation check box across the documents: {0}.";
		public const string CannotRecalculateExternalTaxesTaxCalcDisabled = "Taxes cannot be recalculated because the Disable Automatic Tax Calculation check box is selected on the Financial tab. To recalculate taxes, clear this check box.";
		public const string GrossModeIsNotAllowedWhenTaxCalculationDisabled = "The Disable Automatic Tax Calculation check box and the Gross tax calculation mode on the Financial tab of the Sales Orders (SO301000) form cannot be selected simultaneously for a sales order.";
		public const string InclusiveTaxesNotAllowedWhenTaxCalculationDisabled = "The Disable Automatic Tax Calculation check box cannot be selected on the Financial tab of the Sales Orders (SO301000) form for a sales order that has at least one tax with the Inclusive Line-Level or Inclusive Document-Level calculation rule specified on the Taxes (TX205000) form.";
		public const string ManualInclusiveTaxesNotAllowedWhenTaxCalculationDisabled = "The tax cannot be added because the Inclusive Line-Level or Inclusive Document-Level calculation rule is selected for it on the Taxes (TX205000) form and the Disable Automatic Tax Calculation check box is selected on the Financial tab of the current form. Clear this check box to allow automatic tax calculation of inclusive taxes.";
		public const string TaxCalculationDisabled = "Taxes will not be calculated automatically because the Disable Automatic Tax Calculation check box is selected on the Financial tab. Enter taxes manually on the Taxes tab or clear this check box to automatically calculate taxes.";
		#endregion

		#region Manage Sales Allocations

		public const string SalesAllocationsFilter = "Sales Allocations Filter";
		public const string SalesAllocation = "Sales Allocation";

		public const string AllocateSalesOrders = "Allocate Sales Orders";
		public const string DeallocateSalesOrders = "Deallocate Sales Orders";

		public const string QtyToAllocateGreaterQtyUnallocated = "The quantity to allocate cannot be greater than the unallocated quantity.";
		public const string QtyToAllocateGreaterQtyAvailable = "The quantity to allocate is greater than the quantity available for allocation.";
		public const string CantAllocateQtyToAllocateGreaterQtyAvailable = "The {0} item cannot be allocated because the quantity to allocate is greater than the quantity available for allocation.";

		public const string QtyToDeallocateGreaterQtyAllocated = "The quantity to deallocate cannot be greater than the allocated quantity.";
		public const string CantEditQtyToDeallocateForExpiredOrderLine = "The quantity to deallocate cannot be changed for lines of expired blanket sales orders.";
		public const string CantDeallocateLotSerialNumber = "For lot/serial-tracked items, you can deallocate only the full quantity or the quantity allocated without lot/serial numbers. If you need to deallocate a partial quantity that includes lot/serial numbers, use the Line Details dialog box on the Details tab of the Sales Orders (SO301000) form.";
		#endregion
