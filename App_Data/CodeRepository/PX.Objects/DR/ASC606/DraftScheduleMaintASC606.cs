...
namespace PX.Objects.DR
{
	public class DraftScheduleMaintASC606 : PXGraphExtension<DraftScheduleMaint>
	{
		...
		public delegate decimal GetCuryTotalAmtDelegate(PXCache sender, DRScheduleDetail scheduleDetail, decimal remainingAmount);

		[PXOverride]
		public virtual decimal GetCuryTotalAmt(PXCache sender, DRScheduleDetail scheduleDetail, decimal remainingAmount, GetCuryTotalAmtDelegate baseMethod)
		{
