...
namespace PX.Objects.DR
{
	...
	public partial class DRRevenueBalance : PX.Data.IBqlTable
	{
		...
		{
			public static DRRevenueBalance Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? customerID, Int32? projectID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, acctID, subID, componentID, customerID, projectID, finPeriodID, options);
		}
	...
	public partial class DRRevenueBalanceByPeriod : PX.Data.IBqlTable
    {
		...
		{
			public static DRRevenueBalanceByPeriod Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? customerID, Int32? projectID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, acctID, subID, componentID, customerID, projectID, finPeriodID, options);
		}
		public static class FK
		{
	...
	public class DRRevenueBalance2 : DRRevenueBalance
	{
		...
		{
			public static DRRevenueBalance2 Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? customerID, Int32? projectID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, acctID, subID, componentID, customerID, projectID, finPeriodID, options);
		}
