...
namespace PX.Objects.DR
{
	...
	/// upon the release of <see cref="AR.ARTran"/> or <see cref="APTran"/> document lines
	...
	public partial class DRScheduleTran : PX.Data.IBqlTable
	{
		...
		{
			public static DRScheduleTran Find(PXGraph graph, int? scheduleID, int? componentID, int? detailLineNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, scheduleID, componentID, detailLineNbr, lineNbr, options);
		}
