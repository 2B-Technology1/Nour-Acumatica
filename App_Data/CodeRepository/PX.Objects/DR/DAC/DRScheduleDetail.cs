...
{
	/// <summary>
	/// A revenue or expense recognition component of a <see cref="DRSchedule">deferral 
	...
	public class DRScheduleDetail : IBqlTable
	{
		...
		{
			public static DRScheduleDetail Find(PXGraph graph, int? scheduleID, int? componentID, int? detailLineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, scheduleID, componentID, detailLineNbr, options);
		}
