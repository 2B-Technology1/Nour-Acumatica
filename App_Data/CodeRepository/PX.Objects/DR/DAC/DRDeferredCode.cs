...
namespace PX.Objects.DR
{
	...
	public class DRDeferredCode : PX.Data.IBqlTable
	{
		...
		{
			public static DRDeferredCode Find(PXGraph graph, string deferredCodeID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, deferredCodeID, options);
		}
		...
		/// the <see cref="AP.APTran">AP</see> or <see cref="AR.ARTran">AR</see> document line 
		...
		/// <summary>
		/// The number of <see cref="GL.FinPeriods.OrganizationFinPeriod">financial periods</see> 
