...
namespace PX.Objects.DR
{
	...
	public partial class DRExpenseBalance : PX.Data.IBqlTable
	{
		...
		{
			public static DRExpenseBalance Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? vendorID, Int32? projectID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID, options);
		}
	...
	public partial class DRExpenseBalanceByPeriod : PX.Data.IBqlTable
    {
		...
		{
			public static DRExpenseBalanceByPeriod Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? vendorID, Int32? projectID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID, options);
		}
		public static class FK
		{
	...
	public class DRExpenseBalance2 : DRExpenseBalance
	{
		...
		{
			public static DRExpenseBalance2 Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? vendorID, Int32? projectID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID, options);
		}
