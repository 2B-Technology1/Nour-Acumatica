		...
		public partial class SchedulesInqResult : DRScheduleDetail
		{
			...
			[PXDBCalced(typeof(Switch<
								Case<Where<CurrentValue<SchedulesFilter.accountType>, Equal<AccountType.income>,
										And2<Where<SchedulesInqResult.docType, Equal<ARDocType.creditMemo>, Or<SchedulesInqResult.docType, Equal<ARDocType.cashReturn>>>,
										Or<CurrentValue<SchedulesFilter.accountType>, Equal<AccountType.expense>,
										And<Where<SchedulesInqResult.docType, Equal<APDocType.debitAdj>, Or<SchedulesInqResult.docType, Equal<APDocType.voidQuickCheck>>>>>>>,
