...
namespace PX.Objects.DR
{
	...
	public class DraftScheduleMaint : PXGraph<DraftScheduleMaint, DRSchedule>
	{
		...
		public DraftScheduleMaint()
		{
			...
			OpenPeriodAttribute.SetValidatePeriod<DRSchedule.finPeriodID>(DocumentProperties.Cache, null, PeriodValidation.DefaultSelectUpdate);
		...
		protected virtual void DRSchedule_RefNbr_FieldUpdated(PXCache sender, PXFieldUpdatedEventArgs e)
		{
			...
			else if (e.OldValue != null)
			{
				...
				info.IsReadOnly = false;
				schedule.CuryID = Accessinfo.BaseCuryID;
				schedule.BaseCuryID = Accessinfo.BaseCuryID;
		...
		protected virtual void DRScheduleDetail_CuryTotalAmt_FieldDefaulting(PXCache sender, PXFieldDefaultingEventArgs e)
			{
			DRScheduleDetail scheduleDetail = e.Row as DRScheduleDetail;
			...
			if (scheduleDetail.TotalAmt != null)
				{
				e.NewValue = GetCuryTotalAmt(sender, scheduleDetail, scheduleDetail.TotalAmt.Value);
				}
			}

		protected virtual decimal GetCuryTotalAmt(PXCache sender, DRScheduleDetail scheduleDetail, decimal remainingAmount)
		{
		...
		protected virtual void DRScheduleDetail_TotalAmt_FieldUpdated(PXCache sender, PXFieldUpdatedEventArgs e)
		{
			...
			if (scheduleDetail.TotalAmt != null)
			{
				scheduleDetail.CuryTotalAmt = GetCuryTotalAmt(sender, scheduleDetail, scheduleDetail.TotalAmt.Value);
			}
		...
		protected virtual void DRScheduleDetail_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			sender.MarkUpdated(scheduleDetail);
