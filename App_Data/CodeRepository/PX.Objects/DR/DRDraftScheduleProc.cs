...
namespace PX.Objects.DR
{
    public class DRDraftScheduleProc : PXGraph<DRRecognition>
    {
		...
		public PXSelectJoin<
					...
					Where<DRDeferredCode.accountType, Equal<Current<DRDraftScheduleProc.SchedulesFilter.accountType>>,
					...
					OrderBy<
						...
						Asc<DRScheduleDetail.detailLineNbr>>>>> ItemsView;
		...
		public virtual IEnumerable items()
		{
			...
			if (filter != null)
			{
				BqlCommand command = ItemsView.View.BqlSelect;
				...
				return command.CreateView(this, mergeCache: !ItemsView.View.IsReadOnly).SelectExternalWithPaging();
			}
			else
			{
				return null;
