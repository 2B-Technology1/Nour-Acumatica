...
namespace PX.Objects.CR
{
    ...
    public partial class CROpportunityProducts : IBqlTable, IHasMinGrossProfit, ISortOrder, IMatrixItemLine
    {
        ...
        #endregion
		#region BaseQuantity
		public abstract class baseQuantity : PX.Data.BQL.BqlDecimal.Field<baseQuantity> { }
		...
		/// <inheritdoc cref="InventoryItemCurySettings.preferredVendorID"/>
		[PXInt]
		[PXUnboundDefault(typeof(Search<INItemSiteSettings.preferredVendorID,
					Where<INItemSiteSettings.inventoryID, Equal<Current<CROpportunityProducts.inventoryID>>,
						And<INItemSiteSettings.siteID, Equal<Current<CROpportunityProducts.siteID>>>>>))]
        ...
        [PXFormula(typeof(Switch<
								Case<Where<PendingValue<CROpportunityProducts.vendorID>, IsPending>, Null,
								Case<Where<CROpportunityProducts.preferredVendorID, IsNotNull>, CROpportunityProducts.preferredVendorID,
								Case<Where<Current2<CROpportunityProducts.vendorID>, IsNotNull>, Current2<CROpportunityProducts.vendorID>>>>>))]
		...
		[PXFormula(typeof(IIf<Where<manualPrice.IsEqual<True>>, False, skipLineDiscounts>))]
