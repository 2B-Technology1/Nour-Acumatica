...
namespace PX.Objects.CR
{
	...
	public partial class CRCampaign : PX.Data.IBqlTable, INotable
	{
		...
		{
			public static CRCampaign Find(PXGraph graph, string campaignID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, campaignID, options);
		}
		public static class FK
		{
			public class Type : CR.CRCampaignType.PK.ForeignKeyOf<CRCampaign>.By<campaignType> { }

			public class Owner : CR.Contact.PK.ForeignKeyOf<CRCampaign>.By<ownerID> { }
