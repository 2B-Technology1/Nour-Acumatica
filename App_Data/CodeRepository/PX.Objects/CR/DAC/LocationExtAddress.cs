...
namespace PX.Objects.CR
{
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<LocationExtAddress>.By<locationID>
		{
			public static LocationExtAddress Find(PXGraph graph, int? locationID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, locationID, options);
		}
		#endregion
