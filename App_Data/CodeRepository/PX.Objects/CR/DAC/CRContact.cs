...
namespace PX.Objects.CR
{
    ...
    public partial class CRShippingContact : CRContact
    {
        ...
        {
            public static CRShippingContact Find(PXGraph graph, int? contactID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contactID, options);
        }
    ...
    public partial class CRBillingContact : CRContact
    {
        ...
        {
            public static CRBillingContact Find(PXGraph graph, int? contactID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contactID, options);
        }
        public new static class FK
        {
    ...
    public partial class CRContact : IBqlTable, IPersonalContact, IContactBase, IEmailMessageTarget, IConsentable
    {
        #region Keys
        public class PK : PrimaryKeyOf<CRContact>.By<contactID>
        {
            public static CRContact Find(PXGraph graph, int? contactID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contactID, options);
        }
        ...
        [PXDependsOnFields(typeof(CRContact.lastName), typeof(CRContact.firstName), typeof(CRContact.midName), typeof(CRContact.title))]
