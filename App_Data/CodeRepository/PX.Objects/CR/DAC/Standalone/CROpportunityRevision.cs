...
namespace PX.Objects.CR.Standalone
{
	public partial class CROpportunityRevision : PX.Data.IBqlTable, IAssign
	{
		...
		#region CuryTaxTotal
		public abstract class curyTaxInclTotal : PX.Data.BQL.BqlDecimal.Field<curyTaxTotal> { }
		...
		/// <summary>
		/// The total <see cref="curyDiscTot">discount of the document</see> (in the currency of the document),
		...
		/// <summary>
		/// The total <see cref="curyOrderDiscTotal">discount of the document</see> (in the currency of the document),
		...
		[PXDBCalced(typeof(Add<curyDiscTot, curyLineDiscountTotal>), typeof(Decimal))]
		...
		[PXDBCalced(typeof(Add<discTot, lineDiscountTotal>), typeof(Decimal))]
