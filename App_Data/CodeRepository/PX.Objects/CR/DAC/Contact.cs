...
namespace PX.Objects.CR
{
	...
	/// Also, records of the derived class <see cref="CRLead"/> are mostly created and edited on the Leads (CR301000) form,
	...
	public partial class Contact : IBqlTable, IContactBase, IPersonalContact, IAssign, IPXSelectable, IEmailMessageTarget, IConsentable, INotable
	{
		#region Keys
		public class PK : PrimaryKeyOf<Contact>.By<contactID>
		{
			public static Contact Find(PXGraph graph, int? contactID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contactID, options);
		}
		public static class FK
		{
			...
			public class Owner : CR.Contact.PK.ForeignKeyOf<Contact>.By<ownerID> { }
			...
			public class SalesTerritory : CS.SalesTerritory.PK.ForeignKeyOf<Contact>.By<salesTerritoryID> { }
		}
		#endregion
		...
		/// sent by the <see cref="CRMassMailMaint"/> graph (the Mass Emails (CR308000) form).
		/// </value>
		[PXDBBool]
		...
		/// </summary>
		/// <value>
		/// The property is used by the <see cref="LeadMaint"/> graph, displayed on the Leads (CR301000)
		...
		/// </value>
		[PXDBGuid]
		[PXForeignReference(typeof(FK.User), ReferenceBehavior.SetNull)]
		[PXUser]
		...
		/// The property is used by the <see cref="LeadMaint"/> graph and displayed on the Leads (CR301000) form.
		/// </value>
		...
		/// <summary>
		/// This field is used to implement the <see cref="IEmailMessageTarget.Address"/>
