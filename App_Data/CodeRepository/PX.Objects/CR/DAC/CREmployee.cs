...
namespace PX.Objects.CR.Standalone
{
	...
	public partial class EPEmployee : BAccount
    {
		...
		[PXForeignReference(typeof(Field<EPEmployee.defContactID>.IsRelatedTo<Contact.contactID>))]
		...
		[PXForeignReference(typeof(Field<EPEmployee.defAddressID>.IsRelatedTo<Address.addressID>))]
