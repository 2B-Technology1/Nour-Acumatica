...
namespace PX.Objects.CR
{
	...
	public partial class CROpportunity : IBqlTable, IAssign, IPXSelectable, INotable
	{
		...
		{
			public static CROpportunity Find(PXGraph graph, string opportunityID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, opportunityID, options);
		}
		public static class FK
		{
			public class Class : CR.CROpportunityClass.PK.ForeignKeyOf<CROpportunity>.By<classID> { }
			...
			public class Owner : CR.Contact.PK.ForeignKeyOf<CROpportunity>.By<ownerID> { }
			public class Workgroup : TM.EPCompanyTree.PK.ForeignKeyOf<CROpportunity>.By<workgroupID> { }
			public class SalesTerritory : CS.SalesTerritory.PK.ForeignKeyOf<CROpportunity>.By<salesTerritoryID> { }
		}
		#endregion
		...
		[PXRestrictor(typeof(Where2<Where2<
				...
				And<CROpportunity.bAccountID.FromCurrent.IsNull.Or<BAccount.bAccountID.IsEqual<CROpportunity.bAccountID.FromCurrent>>>>),
		...
		{
			[PXDependsOnFields(typeof(curyLineDocDiscountTotal), typeof(manualTotalEntry))]
			get { return _discTot; }
			set { _discTot = value; }
		}
		#endregion
		...
		[PXUIField(DisplayName = "Document Discounts", Visibility = PXUIVisibility.SelectorVisible)]
		[PXFormula(typeof(
			curyDiscTot
				.When<
		...
		[PXFormula(typeof(Add<curyDiscTot, curyLineDiscountTotal>))]
		...
		/// </summary>
		[PXDBBool(BqlField = typeof(Standalone.CROpportunityRevision.overrideSalesTerritory))]
		[PXDefault(false, PersistingCheck = PXPersistingCheck.Nothing)]
		...
		/// </summary>
		[SalesTerritoryField(BqlField = typeof(Standalone.CROpportunityRevision.salesTerritoryID))]
