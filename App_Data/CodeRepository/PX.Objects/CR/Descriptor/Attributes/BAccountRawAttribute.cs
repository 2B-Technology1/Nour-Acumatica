...
namespace PX.Objects.CR
{
	...
	public abstract class BAccountRawAttribute : PXEntityAttribute
	{
		...
		public BAccountRawAttribute(Type entityType, Type[] bAccountTypes = null, Type customSearchQuery = null, Type[] fieldList = null, string[] headerList = null)
		{
			...
			if (HideInactiveCustomers && BAccountTypes.Any(type => type.IsIn(new[] { typeof(BAccountType.prospectType), typeof(BAccountType.customerType), typeof(BAccountType.combinedType) })))
			{
