...
namespace PX.Objects.CR
{
	...
	public static class Messages
	{
        ...
        public const string OrderTypeOfWrongType = "The order type cannot be used.";
		...
		public const string GIException = "The following error occurred in the {0} generic inquiry: {1}";
		...
		public const string StateNotFound = "The '{0}' state cannot be found in the system.";
		...
		public const string FailedToPrepareMassEmail = "An error occurred during the preparation of mass emails.";
		...
		public const string RelationAlreadyExists = "The relation with the same settings already exists.";

		public const string BAccountChangedWithRestrictedCurrency = "The business account cannot be changed because the currency of the account differs from the currency of the document and the Enable Currency Override check box is cleared on the Business Accounts (CR303000) form.";
	    ...
	    public const string EmailNotificationTemplate = "Email Template";
		...
		public const string CRCampaignToCRMarketingListLink = "CRCampaign To CRMarketingList Link"; 
		...
		public const string CampaignMarketingLists = "Campaign Marketing Lists";
		...
		public const string NotificationTemplate = "Email Template";
		...
		public const string SplitEmailAddresses = "Split Email Addresses";
		...
		public const string Role_Child = "Child";
		public const string Role_Derivative = "Derivative";
		public const string Role_DecisionMaker = "Decision-Maker";
		public const string Role_Evaluator = "Evaluator";
		public const string Role_Parent = "Parent";
		public const string Role_RelatedEntity = "Related Entity";
		public const string Role_Referrer = "Referrer";
		public const string Role_SupportEngineer = "Support Engineer";
		public const string Role_Source = "Source";
		public const string Role_Supervisor = "Supervisor";
		public const string Role_TechnicalExpert = "Technical Expert";
		#endregion
	...
	public static class MessagesNoPrefix
	{
		...
		public const string CannotCreateCustomerFromCreateSalesOrder = "You need to extend the business account to be a customer. " +
			"Click Create Customer, and fill in the required settings of the class on the Customers (AR303000) form. Then you can create the sales order.";
		...
		#region Link/Merge dialogs strings
	...
	{
		public const string Warning  = Messages.Warning;
		public const string Confirmation = Messages.Confirmation;

		public const string ConvertStaticListToDynamic = "All members will be deleted from this list after conversion to a dynamic list.";
		public const string ConvertDynamicListToStatic = "Do you want to keep the members in this list after conversion to a static list?";

		public const string CampaignMemberExistsInCampaign = "All campaign members from marketing lists will be updated. Do you want to continue?";
		public const string CampaignMarketingListsUpdated = "You have updated the set of marketing lists for the campaign. You can update the campaign members or keep the current members.";
		public const string CampaignClearMembers = "All currently displayed members will be removed from the list. Do you want to proceed?";
		public const string MarketingListCampaignsUpdated = "You have updated the list of campaigns. You can update marketing list members in these campaigns or keep the current members.";
		public const string MarketingListClearMembers = "All currently displayed members will be removed from the list. Do you want to proceed?";
		public const string SalesTerritoriesUpdated = "Some of the selected records are assigned to other sales territories. Do you want to update the territories in these records?";
	}
	...
	{
		public const string ListManagement = "List Management";
	}
}
