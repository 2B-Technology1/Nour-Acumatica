...
namespace PX.Objects.CR.Workflows
{
	...
	public class LeadWorkflow : PXGraphExtension<LeadMaint>
	{
		...
		public sealed override void Configure(PXScreenConfiguration configuration) =>
			Configure(configuration.GetScreenConfigurationContext<LeadMaint, CRLead>());
		protected static void Configure(WorkflowContext<LeadMaint, CRLead> context)
		{
			...
			var actionCreateEmail = context.ActionDefinitions.CreateExisting(
				LeadMaint_ActivityDetailsExt_Actions.ActionNames.NewMailActivity_Workflow,
				a => a.WithCategory(categoryActivities));

			var actionCreateTask = context.ActionDefinitions.CreateExisting(
				LeadMaint_ActivityDetailsExt_Actions.ActionNames.NewTask_Workflow,
				a => a.WithCategory(categoryActivities));

			var actionCreatePhoneCall = context.ActionDefinitions.CreateExisting(
				LeadMaint_ActivityDetailsExt_Actions.ActionNames.NewActivity_Phonecall_Workflow,
				a => a.WithCategory(categoryActivities));

			var actionCreateNote = context.ActionDefinitions.CreateExisting(
				LeadMaint_ActivityDetailsExt_Actions.ActionNames.NewActivity_Note_Workflow,
				a => a.WithCategory(categoryActivities));
