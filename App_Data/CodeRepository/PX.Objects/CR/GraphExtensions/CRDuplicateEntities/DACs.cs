...
namespace PX.Objects.CR.Extensions.CRDuplicateEntities
{
	...
	public partial class CRGrams : IBqlTable
	{
		...
		[PXUIField(DisplayName = "Entity Name", Visibility = PXUIVisibility.Visible)]
	...
	public partial class CRDuplicateGrams : CRGrams
	{
		...
		public new abstract class entityName : PX.Data.BQL.BqlString.Field<entityName> { }
	...
	[PXInternalUseOnly]
	public class CRDuplicateResult : PXResult<CRDuplicateRecord, DuplicateContact, BAccountR, CRLead, Address, CRActivityStatistics, Standalone.Location>
	{
		[Obsolete]
		public CRDuplicateResult(CRDuplicateRecord p1, DuplicateContact p2, BAccountR p3, CRLead p4, Address p5, CRActivityStatistics p6)
			: base(p1, p2, p3, p4, p5, p6, null) { }

		public CRDuplicateResult(CRDuplicateRecord p1, DuplicateContact p2, BAccountR p3, CRLead p4, Address p5, CRActivityStatistics p6, Standalone.Location p7)
