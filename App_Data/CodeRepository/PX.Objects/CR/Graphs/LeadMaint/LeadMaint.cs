...
{
    public partial class LeadMaint : PXGraph<LeadMaint, CRLead, CRLead.displayName>, ICaptionable
	{
        #region Selects
		...
		public SelectFrom<CRCampaignMembers>
					...
					.Where<CRCampaignMembers.contactID.IsEqual<CRLead.contactID.FromCurrent>>
				.View Members;
		...
		public class CreateAccountFromLeadGraphExt : CRCreateAccountAction<LeadMaint, CRLead>
		{
			...
			protected override PXSelectBase<CRPMTimeActivity> Activities => Base.GetExtension<LeadMaint_ActivityDetailsExt>().Activities;
		...
		public class UpdateRelatedContactInfoFromLeadGraphExt : CRUpdateRelatedContactInfoGraphExt<LeadMaint>
		{
			...
			public SelectFrom<Address>
							...
							.Or<Contact.bAccountID.IsNull>
								.And<Contact.contactID.IsEqual<@P.AsInt>>>
							.View RefContactRelatedAddresses;
