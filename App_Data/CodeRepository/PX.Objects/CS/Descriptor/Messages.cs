...
namespace PX.Objects.CS
{
	...
	public static class Messages
	{
		...
		public const string FailedToCreateCarrierPlugin = "The carrier plug-in cannot be created. {0}";
		public const string FailedToCreateCarrierService = "The {0} carrier references a missing plug-in.";
		...
		public const string FeatureBankFeedRequiredCloudServices = "The feature cannot be enabled because the current license does not include the support of cloud services.";
		...
		public const string UKLocalizationFeatureName = "UK Localization";
		public const string GLAnomalyDetectionFeatureName = "GL Anomaly Detection";
		...
		public const string ConsolidatedStatementsAndDLForAllCompanies = "Customer statements and dunning letters cannot be prepared, because it is not allowed to consolidate statements and dunning letters for all companies if the Multiple Base Currencies feature is enabled. Select different options in the Prepare Statements and Prepare Dunning Letters boxes on the Accounts Receivable Preferences (AR101000) form.";
		public const string ConsolidatedDunningLettersForAllCompanies = "Dunning letters cannot be prepared because it is not allowed to consolidate dunning letters for all companies if the Multiple Base Currencies feature is enabled. Select a different option in the Prepare Dunning Letters box on the Accounts Receivable Preferences (AR101000) form.";
		public const string ConsolidatedStatementsForAllCompanies = "Customer statements cannot be prepared because it is not allowed to consolidate statements for all companies if the Multiple Base Currencies feature is enabled. Select a different option in the Prepare Statements box on the Accounts Receivable Preferences (AR101000) form.";
		public const string DunningBranchIsNotSetForCompany = "The Consolidated for Company option is selected on the Accounts Receivable Preferences (AR101000) form, but the dunning letter branch is not defined for the {0} company. Select a branch in the Dunning Letter Branch box on the Companies (CS101500) form.";
		...
		public const string NegativeValuedIdentifier = "The document cannot be saved because the {0} field in the database record that corresponds to this document is corrupted. Please try to save the document again. In case the issue remains, contact your Acumatica support provider for the assistance.";
		public const string MissingPayrollCountry = "Please select either US Payroll or Canadian Payroll as a sub feature.";
		public const string EnableUSPayrollOrCanadaPayroll = "US Payroll or Canadian Payroll should be enabled.";
		...
		public const string CanadianLocalizationBoxWarning = "Select Canada in the Localization box to use Canada-specific functionality for this company.";
		public const string ExperimentalFeatureCanBeDiscontinued = "This is an experimental feature. Please see the release notes for details. In the future, this item can be discontinued.";
		public const string ExperimentalFeatureCanBeReimplemented = "This is an experimental feature. Please see the release notes for details. In the future, this item can be substantially changed requiring a reimplementation.";
		public const string WarningForASOInvoiceIsDisabledAndSMIsEnabled = "If this feature is disabled, corrections to SO invoices created from field service documents and containing a stock item or items are not supported.";
	...
	#region Graph Names
		...
		public const string SalesTerritory = "Sales Territory";
		#endregion
		...
		public const string ByDecadesInNextMonth = "10th, 20th, or Last Day of Next Month";
		...
		#region SalesTerritory Type
		public const string SalesTerritoryTypeByCountry = "By Country";
		public const string SalesTerritoryTypeByState = "By State";
		public const string SalesTerritoryTypeOther = "Other";
		public const string SalesTerritoryOtherTypeWarning = "A sales territory with the Other type cannot be inserted automatically for a record. You can manually specify the territory in the needed records.";
		#endregion
		...
		public const string ReasonCodeInUseARBalanceWriteOff = "The reason code must have the {0} usage because it is selected in the Balance Write-Off Reason Code box on the Accounts Receivable Preferences (AR101000) form.";
		public const string ReasonCodeInUseARCreditWriteOff = "The reason code must have the {0} usage because it is selected in the Credit Write-Off Reason Code box on the Accounts Receivable Preferences (AR101000) form.";
		#endregion
		...
		public const string AttributeValueIDMustContainOnlySpecificSymbols = "The Value ID field must contain only numbers, letters, '.' characters, and whitespaces.";
		public const string AttributeValueIDCannotContainCommas = "The Value ID column of the Multi Select Combo attribute type cannot contain the \",\" character.";
