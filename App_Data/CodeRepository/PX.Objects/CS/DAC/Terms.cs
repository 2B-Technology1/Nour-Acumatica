...
namespace PX.Objects.CS
{
	...
	using static PX.Objects.EP.EPEmptyStepType;
	...
	/// (which corresponds to the <see cref="TermsMaint"/> graph).
	/// </summary>
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<Terms>.By<termsID>
		{
			public static Terms Find(PXGraph graph, string termsID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, termsID, options);
		}
		...
		#endregion
		#region PrepaymentRequired
		public abstract class prepaymentRequired : PX.Data.BQL.BqlBool.Field<prepaymentRequired> { }
		...
		public virtual bool? PrepaymentRequired
		{
			get;
			set;
		}
		...
		/// <summary>
		/// The percent of the Sales Order's Prepayment.
		/// </summary>
		[PXDBDecimal(2, MinValue = 0.0, MaxValue = 100.0)]
		[PXDefault(TypeCode.Decimal, "0.0")]
    ...
    public class TermsDueType
    {
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
                : base(
                new string[] { FixedNumberOfDays, DayOfNextMonth, EndOfMonth, EndOfNextMonth,DayOfTheMonth, Prox, FixedNumberOfDaysPlusDayOfNextMonth, ByDecadesInNextMonth, Custom },
				new string[] { Messages.FixedNumberOfDays, Messages.DayOfNextMonth, Messages.EndOfMonth, Messages.EndOfNextMonth, Messages.DayOfTheMonth, Messages.Prox, Messages.FixedNumberOfDaysPlusDayOfNextMonth, Messages.ByDecadesInNextMonth, Messages.Custom }) { ; }
        }
