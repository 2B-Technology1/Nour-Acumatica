...
namespace PX.Objects.CS
{
	...
	public partial class ShipTermsDetail : PX.Data.IBqlTable
	{
		...
		{
			public static ShipTermsDetail Find(PXGraph graph, string shipTermsID, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, shipTermsID, lineNbr, options);
		}
