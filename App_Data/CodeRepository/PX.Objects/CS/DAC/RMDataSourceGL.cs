	...
	public partial class RMDataSourceGL : PXCacheExtension<RMDataSource>
	{
		...
		[FinPeriodSelector(
			typeof(Search<OrganizationFinPeriod.finPeriodID,
				Where<Where2<Where<FinPeriod.organizationID, Equal<IsNull<Optional2<organizationID>, FinPeriod.organizationID.masterValue>>, And<IsNull<Optional2<useMasterCalendar>, False>, NotEqual<True>>>,
					Or<Where<FinPeriod.organizationID, Equal<FinPeriod.organizationID.masterValue>, And<Optional2<useMasterCalendar>, Equal<True>>>>>>>),
			null)]
