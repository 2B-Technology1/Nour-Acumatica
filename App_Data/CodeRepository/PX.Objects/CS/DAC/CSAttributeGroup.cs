...
namespace PX.Objects.CS
{
	...
	public partial class CSAttributeGroup : PX.Data.IBqlTable
	{
        ...
        {
            public static CSAttributeGroup Find(PXGraph graph, string attributeID, string entityClassID, string entityType, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, attributeID, entityClassID, entityType, options);
        }
        #endregion
        #region AttributeID
