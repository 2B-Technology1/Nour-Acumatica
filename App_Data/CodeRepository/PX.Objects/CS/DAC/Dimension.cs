...
namespace PX.Objects.CS
{
	...
	public partial class Dimension : PX.Data.IBqlTable
	{
		...
		{
			public static Dimension Find(PXGraph graph, String dimensionID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, dimensionID, options);
		}
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXFormula(typeof(IIf<Where<lookupMode, Equal<DimensionLookupMode.bySegmentsAndAllAvailableSegmentValues>>, True, False>), KeepIdleSelfUpdates = true)]
