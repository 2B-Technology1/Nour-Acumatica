...
namespace PX.Objects.CS
{
	...
	public partial class CSAttributeDetail : PX.Data.IBqlTable
	{
		...
		{
			public static CSAttributeDetail Find(PXGraph graph, string attributeID, string valueID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, attributeID, valueID, options);
		}
