...
using PX.Objects.CA;
	...
	/// (which corresponds to the <see cref="CarrierMaint"/> graph).
	...
	/// (which corresponds to the <see cref="CarrierPluginMaint"/> graph).
	/// </summary>
	...
	public partial class Carrier : PX.Data.IBqlTable
	{
		...
		{
			public static Carrier Find(PXGraph graph, string carrierID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, carrierID, options);
		}
		#endregion
