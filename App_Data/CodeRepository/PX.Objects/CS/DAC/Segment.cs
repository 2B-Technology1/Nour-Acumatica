...
namespace PX.Objects.CS
{
	...
	public partial class Segment : PX.Data.IBqlTable
	{
		...
		{
			public static Segment Find(PXGraph graph, String dimensionID, Int16? segmentID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, dimensionID, segmentID, options);
		}
