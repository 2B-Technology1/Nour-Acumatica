...
namespace PX.Objects.CS
{
    ...
    /// (which corresponds to the <see cref="CountryMaint"/> graph).
	/// </summary>
	...
	public partial class Country : PX.Data.IBqlTable
	{
		...
		{
			public static Country Find(PXGraph graph, string countryID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, countryID, options);
		}
		public static class FK
		{
			public class SalesTerritory : CS.SalesTerritory.PK.ForeignKeyOf<Country>.By<salesTerritoryID> { }
		}
		#endregion
        ...
        /// </value>
		[PXDBString(100, IsKey = true/*, IsFixed = true*/, InputMask = ">CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC")]
		[PXDefault()]
		...
		[PXSelector(typeof(Search<SalesTerritory.salesTerritoryID,
							Where<SalesTerritory.salesTerritoryType, Equal<SalesTerritoryTypeAttribute.byCountry>>>),
					fieldList: new []
					{
