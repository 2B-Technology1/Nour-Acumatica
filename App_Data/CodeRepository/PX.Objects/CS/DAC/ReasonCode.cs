...
namespace PX.Objects.CS
{
	...
	public partial class ReasonCode : PX.Data.IBqlTable
	{
        ...
        {
            public static ReasonCode Find(PXGraph graph, string reasonCodeID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, reasonCodeID, options);
        }
	...
	public class ReasonCodeUsages
	{
		...
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute() : base(
				new[]
				{
					...
					Pair(AssemblyDisassembly, IN.Messages.AssemblyDisassembly),
		...
		{
			public disassembly() : base(AssemblyDisassembly) {}
		}

		public class assemblyDisassembly : PX.Data.BQL.BqlString.Constant<assemblyDisassembly>
		{
			public assemblyDisassembly() : base(AssemblyDisassembly) { }
		}
