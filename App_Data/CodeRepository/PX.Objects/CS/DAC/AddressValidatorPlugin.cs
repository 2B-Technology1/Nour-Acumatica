...
using static PX.Objects.CA.PXProviderTypeSelectorAttribute;
...
namespace PX.Objects.CS
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<AddressValidatorPlugin>.By<addressValidatorPluginID>
		{
			public static AddressValidatorPlugin Find(PXGraph graph, string addressValidatorPluginID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, addressValidatorPluginID, options);
		}
		#endregion
		...
		[PXProviderTypeSelector(
			new Type[]{typeof(IAddressValidator), typeof(IAddressLookupService)}
			,SubstituteKey = typeof(ProviderRec.displayTypeName))]
		[PXDBString(255)]
		[PXDefault]
