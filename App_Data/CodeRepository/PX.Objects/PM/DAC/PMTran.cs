...
namespace PX.Objects.PM
{
	...
	public partial class PMTran : IBqlTable, IProjectFilter, IQuantify
	{
		...
		{
			public static PMTran Find(PXGraph graph, long? tranID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranID, options);
		}
		...
		public static class FK
		{
			...
			/// </summary>
			/// <exclude />
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMTran>.By<projectID, taskID> { }
		...
		// Acuminator disable once PX1030 PXDefaultIncorrectUse The test ATR100 does not understand that this is a bound field and gives the error PX1030.
		[OpenPeriod(
			null,
			typeof(PMTran.date),
		...
		[PXDefault(typeof(Search<PMProject.nonProject, Where<PMProject.contractID, Equal<Current<projectID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		[PXDefault(typeof(Search<PMProject.baseType, Where<PMProject.contractID, Equal<Current<projectID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		[PXFormula(typeof(Default<PMTran.projectID>))]
		...
		[BaseProjectTaskAttribute(typeof(PMTran.projectID), typeof(PMTran.baseType), typeof(PMTran.nonProject), AllowInactive = false)]
		...
		[LocationActive(typeof(Where<Location.bAccountID, Equal<Current<PMTran.bAccountID>>>), DisplayName = "Location", DescriptionField = typeof(Location.descr))]
		...
		/// </value>
		//[PXDefault] can be null for Off-balance account group
		[SubAccount(typeof(PMTran.accountID), typeof(PMTran.branchID), DisplayName = "Debit Subaccount")]
		...
		/// </value>
		//[PXDefault]
		[SubAccount(typeof(PMTran.offsetAccountID), typeof(PMTran.branchID), DisplayName = "Credit Subaccount")]
