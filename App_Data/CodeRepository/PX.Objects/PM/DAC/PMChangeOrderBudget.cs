...
{
	/// <summary>The base class for <see cref="PMChangeOrderRevenueBudget" /> and <see cref="PMChangeOrderCostBudget" /> types.
	...
	public class PMChangeOrderBudget : IBqlTable, IProjectFilter, IQuantify
	{
		...
		{
			public static PMChangeOrderBudget Find(PXGraph graph, string refNbr, int? projectID, int? projectTaskID, int? accountGroupID, int? costCodeID, int? inventoryID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, projectID, projectTaskID, accountGroupID, costCodeID, inventoryID, options);
		}
		...
		public static class FK
		{
			...
			/// </summary>
			/// <exclude />
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMChangeOrderBudget>.By<projectID, projectTaskID> { }
	...
	public class PMChangeOrderRevenueBudget : PMChangeOrderBudget
	{
		...
		{
			public static PMChangeOrderRevenueBudget Find(PXGraph graph, string refNbr, int? projectID, int? projectTaskID, int? accountGroupID, int? costCodeID, int? inventoryID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, projectID, projectTaskID, accountGroupID, costCodeID, inventoryID, options);
		}
		...
		public new static class FK
		{
			...
			/// </summary>
			/// <exclude />
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMChangeOrderRevenueBudget>.By<projectID, projectTaskID> { }
	...
	public class PMChangeOrderCostBudget : PMChangeOrderBudget
	{
		...
		{
			public static PMChangeOrderCostBudget Find(PXGraph graph, string refNbr, int? projectID, int? projectTaskID, int? accountGroupID, int? costCodeID, int? inventoryID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, projectID, projectTaskID, accountGroupID, costCodeID, inventoryID, options);
		}
		...
		public new static class FK
		{
			...
			/// </summary>
			/// <exclude />
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMChangeOrderCostBudget>.By<projectID, projectTaskID> { }
