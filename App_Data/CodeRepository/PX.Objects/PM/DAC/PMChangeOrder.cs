...
namespace PX.Objects.PM
{
	...
	[Serializable]
	public class PMChangeOrder : PX.Data.IBqlTable, IAssign, INotable
	{
		#region Keys
		/// <summary>
		/// Primary Key
		...
		{
			public static PMChangeOrder Find(PXGraph graph, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, options);
		}
		...
		[PXSelector(
			typeof(SelectFrom<PMChangeOrder>
		...
		#endregion
		#region ReversingRefNbr
		public abstract class reversingRefNbr : PX.Data.BQL.BqlString.Field<reversingRefNbr> { }

		/// <summary>
		/// The list of <see cref="RefNbr">reference number</see> of the change orders
		...
		public virtual String ReversingRefNbr
		{
			get;
			set;
		}
	...
	public static class ChangeOrderStatus
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
				new string[] { OnHold, PendingApproval, Open, Closed, Rejected, Canceled },
				new string[] { Messages.OnHold, Messages.PendingApproval, Messages.Open, Messages.Closed, Messages.Rejected, Messages.Canceled })
			{; }
		}
