...
namespace PX.Objects.PM
{
	...
	public class PMSetup : PX.Data.IBqlTable
	{
		...
		#endregion
		#region ProgressWorksheetNumbering
		public abstract class progressWorksheetNumbering : PX.Data.BQL.BqlString.Field<progressWorksheetNumbering> { }
		/// <summary>
		...
		[PXDBString(10, IsUnicode = true)]
		[PXSelector(typeof(Numbering.numberingID), DescriptionField = typeof(Numbering.descr))]
		[PXUIField(DisplayName = "Progress Worksheet Numbering Sequence", FieldClass = nameof(CS.FeaturesSet.Construction))]
		...
		[PXDBInt]
		[PXSelector(typeof(Search<PX.SM.Notification.notificationID>))]
		[PXUIField(DisplayName = "Change Order Approval Notification", FieldClass = PMChangeOrder.FieldClass)]
		...
		[PXDBInt]
		[PXSelector(typeof(Search<PX.SM.Notification.notificationID>))]
		[PXUIField(DisplayName = "Change Request Approval Notification", FieldClass = nameof(CS.FeaturesSet.ChangeRequest))]
		public virtual int? ChangeRequestApprovalNotificationID
		{
			get; set;
		}
		#endregion
		#region ProgressWorksheetApprovalMapID
		public abstract class progressWorksheetApprovalMapID : PX.Data.BQL.BqlInt.Field<progressWorksheetApprovalMapID> { }
		/// /// <summary>
		...
		[PXSelector(
			typeof(Search<
				EPAssignmentMap.assignmentMapID,
				Where<
					EPAssignmentMap.entityType, Equal<AssignmentMapType.AssignmentMapTypeProgressWorksheet>,
					And<EPAssignmentMap.mapType, Equal<EPMapType.approval>>>>))]
		[PXUIField(DisplayName = "Progress Worksheet Approval Map", FieldClass = nameof(CS.FeaturesSet.Construction))]
		public virtual int? ProgressWorksheetApprovalMapID
		{
			get; set;
		}
		#endregion
		#region ProgressWorksheetApprovalNotificationID
		public abstract class progressWorksheetApprovalNotificationID : PX.Data.BQL.BqlInt.Field<progressWorksheetApprovalNotificationID> { }
		/// <summary>
		...
		[PXDBInt]
		[PXSelector(typeof(Search<PX.SM.Notification.notificationID>))]
		[PXUIField(DisplayName = "Progress Worksheet Approval Notification", FieldClass = nameof(CS.FeaturesSet.Construction))]
		public virtual int? ProgressWorksheetApprovalNotificationID
		{
			get; set;
		}
		#endregion
		...
		/// </summary>
		/// <value>
		/// The value refers to the <see cref="GL.Sub"/> DAC.
		/// </value>
	...
	public class PMSetupProgressWorksheetApproval : PMSetup, IAssignedMap
	{
		int? IAssignedMap.AssignmentMapID
		{
			get
			{
				return this.ProgressWorksheetApprovalMapID;
			}
			set
			{
				this.ProgressWorksheetApprovalMapID = value;
			}
		}
		...
		int? IAssignedMap.AssignmentNotificationID
		{
			get
			{
				return this.ProgressWorksheetApprovalNotificationID;
			}
			set
			{
				this.ProgressWorksheetApprovalNotificationID = value;
			}
		}
		...
		bool? IAssignedMap.IsActive
		{
			get
			{
				return this.ProgressWorksheetApprovalMapID.HasValue;
			}
		}
	}
