...
namespace PX.Objects.PM
{
	...
	public partial class PMContact : IBqlTable, IContact, IEmailMessageTarget
	{
		#region ContactID
		...
		/// <summary>
		/// An implementation of the <see cref="IEmailMessageTarget"/> interface.
		/// Returns the value of the <see cref="Email"/> property.
		/// </summary>
		...
		/// <summary>
		/// An implementation of the <see cref="IEmailMessageTarget"/> interface.
		/// Returns the value of the <see cref="FullName"/> property.
		/// </summary>
	...
	/// <summary>
	/// Represents a shipping contact that is specified in the <see cref="PMProforma">pro forma invoice</see>.
	/// A <see cref="PMShippingContact"/> record is a copy of customer location's
	/// <see cref="Contact"/> and can be used to override the shipping contact at the document level.
	/// The record is independent of changes to the original <see cref="Contact"/> record.
	/// The entities of this type are created and edited on the Pro Forma Invoices (PM307000) form (which corresponds to the <see cref="ProformaEntry"/> graph).
	/// </summary>
	[Serializable]
	[PXCacheName(Messages.PMContact)]
