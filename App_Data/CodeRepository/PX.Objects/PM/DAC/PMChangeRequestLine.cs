...
namespace PX.Objects.PM
{
	...
	public class PMChangeRequestLine : PX.Data.IBqlTable, IQuantify
	{
		...
		[PXForeignReference(typeof(CompositeKey<Field<projectID>.IsRelatedTo<PMTask.projectID>, Field<costTaskID>.IsRelatedTo<PMTask.taskID>>))]
		...
		[PXForeignReference(typeof(CompositeKey<Field<projectID>.IsRelatedTo<PMTask.projectID>, Field<revenueTaskID>.IsRelatedTo<PMTask.taskID>>))]
		...
		/// </value>
		[Vendor(typeof(Search<Vendor.bAccountID, Where<Vendor.vStatus, NotEqual<VendorStatus.inactive>>>))]
