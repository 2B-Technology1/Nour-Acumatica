...
namespace PX.Objects.PM
{
	...
	[Serializable]
	public class PMChangeRequest : PX.Data.IBqlTable, IAssign, INotable
	{
		#region Events
		...
		[PXSelector(
			typeof(SelectFrom<PMChangeRequest>
		...
		#region CostChangeOrderReleased
		public abstract class costChangeOrderReleased : PX.Data.BQL.BqlBool.Field<costChangeOrderReleased> { }

		/// <summary>
		/// A Boolean value that indicates whether the linked cost change order is released.
		/// </summary>
		[PXBool]
		[PXDBScalar(typeof(Search<PMChangeOrder.released,
			Where<PMChangeOrder.refNbr, Equal<PMChangeRequest.costChangeOrderNbr>>>))]
		public virtual Boolean? CostChangeOrderReleased
		{
			get;
			set;
		}
