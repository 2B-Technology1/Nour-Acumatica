...
using static PX.Objects.PM.PMProjectGroup;

namespace PX.Objects.PM
{
	/// <summary>A planned set of interrelated tasks to be executed over a fixed period and within certain cost and other limitations. Each project consists of tasks that need
	...
	public partial class PMProject : Contract, IAssign, PX.SM.IIncludable, INotable
	{
		...
		public static class FK
		{
			...
			/// <summary>
			/// Foreign key to <see cref="PMProjectGroup">PMProjectGroup</see>.
			/// </summary>
			public class ProjectGroup
				: PMProjectGroup.PK.ForeignKeyOf<PMProject>.By<projectGroupID>
			{
			}
		}
		#endregion
		...
		[LocationActive(typeof(Where<Location.bAccountID, Equal<Current<customerID>>>), DisplayName = "Default Location", DescriptionField = typeof(Location.descr))]
		...
		[PXDefault(typeof(Coalesce<Search<Location.cSalesSubID, Where<Location.bAccountID, Equal<Current<PMProject.customerID>>, And<Location.locationID, Equal<Current<PMProject.locationID>>>>>,
			Search<GLSetup.defaultSubID>>))]
		[SubAccount(typeof(PMProject.defaultSalesAccountID), typeof(PMProject.defaultBranchID), DisplayName = "Default Sales Subaccount", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Sub.description))]
		...
		[SubAccount(typeof(PMProject.defaultExpenseAccountID), typeof(PMProject.defaultBranchID), DisplayName = "Default Cost Subaccount", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Sub.description))]
		...
		public new abstract class accountingMode : Data.BQL.BqlString.Field<accountingMode> { }
		...
		[Owner(
			workgroupType: null,
			search: null,
			substituteKey: typeof(OwnerAttribute.Owner.acctCD),
		...
		#region IncludeCO
		/// <exclude/>
		public new abstract class includeCO : PX.Data.BQL.BqlBool.Field<includeCO> { }
		/// <summary>
		/// Include Change Orders in Contract Total
		/// </summary>
		[PXDBBool()]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Include CO", FieldClass = nameof(FeaturesSet.ChangeOrder))]
		public override Boolean? IncludeCO
		{
			get;
			set;
		}
		...
		#region CuryRate
		public new abstract class curyRate : PX.Data.BQL.BqlString.Field<curyRate> { }
		...
		/// <summary>
		/// The project group (<see cref="PMProjectGroup">PMProjectGroup</see>),
		/// which the project belongs to.
		/// The project might not belong to any project group (the value is <c>null</c>).
		/// </summary>
		[PXDBString(PMProjectGroup.projectGroupID.Length, IsUnicode = true)]
		[PXUIField(DisplayName = "Project Group")]
		[PXSelector(
			typeof(SelectFrom<PMProjectGroup>
				.Where<MatchUser>
				.SearchFor<PMProjectGroup.projectGroupID>))]
		[PXRestrictor(
			typeof(Where<PMProjectGroup.isActive, Equal<True>>),
			Messages.ProjectGroupIsInactive,
			typeof(PMProjectGroup.projectGroupID))]
		[PXForeignReference(typeof(Field<projectGroupID>.IsRelatedTo<PMProjectGroup.projectGroupID>))]
		public virtual string ProjectGroupID { get; set; }
		#endregion
		#region StatusCode
		public abstract class statusCode : PX.Data.BQL.BqlString.Field<statusCode> { }
	...
	public static class ProjectStatus
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute() : base(
				new[]
				{
					...
					Pair(Suspended, Messages.Suspend),
		...
		{
			public ProjectStatusListAttribute() : base(
				new[]
				{
					Pair(Planned, Messages.InPlanning),
					Pair(Active, Messages.Active),
	...
	[PXBreakInheritance]
	[Serializable]
	public partial class PMProjectSearch : PMProject, IAssign, PX.SM.IIncludable
	{
		public new abstract class customerID : PX.Data.BQL.BqlInt.Field<customerID> { }
		public new abstract class contractID : PX.Data.BQL.BqlInt.Field<contractID> { }
		public new abstract class baseType : PX.Data.BQL.BqlString.Field<baseType> { }
		...
		public new abstract class startDate : PX.Data.BQL.BqlDateTime.Field<startDate> { }
		public new abstract class isActive : PX.Data.BQL.BqlBool.Field<isActive> { }
		public new abstract class budgetLevel : PX.Data.BQL.BqlString.Field<budgetLevel> { }
		public new abstract class billingID : PX.Data.BQL.BqlString.Field<billingID> { }
		...
		[PXDimensionSelector(ProjectAttribute.DimensionName,
			typeof(Search2<PMProjectSearch.contractCD,
						LeftJoin<Customer, On<Customer.bAccountID, Equal<PMProjectSearch.customerID>>,
						LeftJoin<ContractBillingSchedule, On<ContractBillingSchedule.contractID, Equal<PMProjectSearch.contractID>>>>,
						Where<PMProjectSearch.baseType, Equal<CTPRType.project>,
						 And<PMProjectSearch.nonProject, Equal<False>, And<Match<Current<AccessInfo.userName>>>>>>)
						, typeof(PMProjectSearch.contractCD), typeof(PMProjectSearch.contractCD), typeof(PMProjectSearch.description),
						typeof(PMProjectSearch.customerID), typeof(PMProjectSearch.customerID_Customer_acctName), typeof(PMProjectSearch.locationID), typeof(PMProjectSearch.status),
						typeof(PMProjectSearch.ownerID), typeof(PMProjectSearch.startDate), typeof(ContractBillingSchedule.lastDate), typeof(ContractBillingSchedule.nextDate),
						DescriptionField = typeof(PMProjectSearch.description))]
		[PXDBString(IsUnicode = true, IsKey = true, InputMask = "")]
		[PXDefault()]
		[PXUIField(DisplayName = "Template ID")]

		public new String ContractCD
		{
			get
			{
				return this._ContractCD;
