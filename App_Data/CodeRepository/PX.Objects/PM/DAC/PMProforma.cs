...
namespace PX.Objects.PM
{
	...
	public class PMProforma : PX.Data.IBqlTable, IAssign, INotable
	{
		#region Events
		...
		[PXDefault]
		[PXSelector(
			typeof(SelectFrom<PMProforma>
				.InnerJoin<PMProject>.On<PMProject.contractID.IsEqual<projectID>>
				.Where<corrected.IsNotEqual<True>.And<MatchUserFor<PMProject>>>
				.SearchFor<refNbr>),
			Filterable = true)]
		...
		[Project(
			typeof(Where<PMProject.customerID.IsNotNull>),
		...
		/// </value>
		[LocationActive(typeof(Where<Location.bAccountID, Equal<Current<PMProforma.customerID>>>), Visibility = PXUIVisibility.SelectorVisible, DisplayName = "Location", DescriptionField = typeof(Location.descr))]
		[PXDefault]
		...
		[Terms(typeof(invoiceDate), typeof(dueDate), typeof(discDate), null, null, null)]
		...
		#endregion
		#region CuryRetainageTaxInclTotal
		public abstract class curyRetainageTaxInclTotal : PX.Data.BQL.BqlDecimal.Field<curyRetainageTaxInclTotal> { }

		/// <summary>
		/// The total inclusive retained tax amount in document currency.
		/// </summary>
		[PXDBCurrency(typeof(curyInfoID), typeof(retainageTaxInclTotal))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXUIField(DisplayName = "Retained Inclusive Tax Total", Visible = false, Enabled = false, FieldClass = nameof(FeaturesSet.Retainage))]
		public virtual Decimal? CuryRetainageTaxInclTotal
		{
			get; set;
		}
		#endregion
		#region RetainageTaxInclTotal
		public abstract class retainageTaxInclTotal : PX.Data.BQL.BqlDecimal.Field<retainageTaxInclTotal> { }
		...
		[PXDBBaseCury]
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXUIField(DisplayName = "Retainage Inclusive Tax in Base Currency", Visible = false, Enabled = false, FieldClass = nameof(FeaturesSet.Retainage))]
		public virtual Decimal? RetainageTaxInclTotal
		{
			get; set;
		}
		#endregion
		...
		public abstract class curyTaxInclTotal : PX.Data.BQL.BqlDecimal.Field<curyTaxInclTotal> { }

		/// <summary>
		/// The total inclusive tax amount of the document in document currency.
		/// </summary>
		[PXDBCurrency(typeof(curyInfoID), typeof(taxInclTotal))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXUIField(DisplayName = "Inclusive Tax Total", Visible = false)]
		public virtual Decimal? CuryTaxInclTotal
		{
			get;
			set;
		}
		#endregion
		#region TaxInclTotal
		public abstract class taxInclTotal : PX.Data.BQL.BqlDecimal.Field<taxInclTotal> { }
		...
		public virtual Decimal? TaxInclTotal
		{
			get;
			set;
		}
		...
		[PXFormula(typeof(Add<curyTaxTotal, Add<curyRetainageTaxTotal, Add<Data.Minus<curyTaxInclTotal>, Add<Data.Minus<curyRetainageTaxInclTotal>, Add<curyProgressiveTotal, curyTransactionalTotal>>>>>))]
		...
		[PXSelector(typeof(SelectFrom<ARInvoice>
			.LeftJoin<PMProforma>
				.On<ARInvoice.refNbr.IsEqual<aRInvoiceRefNbr>>
			.Where<ARInvoice.docType.IsEqual<aRInvoiceDocType.FromCurrent>
				.And<ARInvoice.customerID.IsEqual<customerID.FromCurrent>>
				.And<ARInvoice.projectID.IsEqual<projectID.FromCurrent>>
				// Only invoices which are not chosen for any pro forma (see LeftJoin)
				// or linked to current pro forma
				.And<aRInvoiceRefNbr.IsNull>
				.Or<aRInvoiceRefNbr.IsEqual<aRInvoiceRefNbr.FromCurrent>>>
			.SearchFor<ARInvoice.refNbr>),
			ValidateValue = false)]
