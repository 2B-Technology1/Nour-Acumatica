...
namespace PX.Objects.PM
{
	...
	public class AllocationProcess : PXGraph<AllocationProcess>
	{
		...
		[PXUIField(DisplayName = "Allocation Rule Description")]
		...
		public virtual IEnumerable ViewTask(PXAdapter adapter)
		{
			...
			graph.Task.Current = PXSelect<PMTask, Where<PMTask.projectID, Equal<Current<PMTask.projectID>>, And<PMTask.taskID, Equal<Current<PMTask.taskID>>>>>.Select(this);
