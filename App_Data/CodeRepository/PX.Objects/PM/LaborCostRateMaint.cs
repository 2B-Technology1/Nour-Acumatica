...
namespace PX.Objects.PM
{
	...
	public class LaborCostRateMaint : PXGraph<LaborCostRateMaint>, PXImportAttribute.IPXPrepareItems
	{
		...
		public PXSelectJoin<PMLaborCostRate,
			LeftJoin<PMProject, On<PMProject.contractID, Equal<PMLaborCostRate.projectID>>>,
			Where2<
				Where<PMLaborCostRate.type, Equal<Current<PMLaborCostRateFilter.type>>,
					Or<Current<PMLaborCostRateFilter.type>, Equal<PMLaborCostRateType.all>>>,
				And2<Where<PMLaborCostRate.unionID, Equal<Current<PMLaborCostRateFilter.unionID>>,
					Or<Current<PMLaborCostRateFilter.unionID>, IsNull>>,
				And2<Where<PMLaborCostRate.projectID, Equal<Current<PMLaborCostRateFilter.projectID>>,
					Or<Current<PMLaborCostRateFilter.projectID>, IsNull>>,
				And2<Where<PMLaborCostRate.taskID, Equal<Current<PMLaborCostRateFilter.taskID>>,
					Or<Current<PMLaborCostRateFilter.taskID>, IsNull>>,
				And2<Where<PMLaborCostRate.employeeID, Equal<Current<PMLaborCostRateFilter.employeeID>>,
					Or<Current<PMLaborCostRateFilter.employeeID>, IsNull>>,
				And2<Where<PMLaborCostRate.inventoryID, Equal<Current<PMLaborCostRateFilter.inventoryID>>,
					Or<Current<PMLaborCostRateFilter.inventoryID>, IsNull>>,
				And2<Where<PMLaborCostRate.effectiveDate, GreaterEqual<Current<PMLaborCostRateFilter.effectiveDate>>,
					Or<Current<PMLaborCostRateFilter.effectiveDate>, IsNull>>,
				And<Where<PMLaborCostRate.projectID, IsNull,
					Or<MatchUserFor<PMProject>>>>>>>>>>>> Items;
		...
		protected virtual void _(Events.RowUpdated<PMLaborCostRate> e)
		{
			if (e.Row.EffectiveDate == e.OldRow.EffectiveDate)
			{
				PMLaborCostRate duplicate = GetLatestDuplicate(e.Row);
				if (duplicate != null && duplicate.EffectiveDate == e.Row.EffectiveDate)
				{
					e.Row.EffectiveDate = null;
				}
			}
		}
