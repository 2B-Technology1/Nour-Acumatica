...
namespace PX.Objects.IN.WMS
{
	...
	public class InventoryItemLookup : WMSBase
	{
		...
		protected virtual void _(Events.FieldDefaulting<InventorySummaryEnqFilter, InventorySummaryEnqFilter.siteID> e)
		{
			e.NewValue = SiteID ?? e.NewValue;
		}
		protected virtual void _(Events.FieldDefaulting<InventorySummaryEnqFilter, InventorySummaryEnqFilter.inventoryID> e)
		{
			e.NewValue = InventoryID ?? e.NewValue;
		}
		...
		protected override IEnumerable<ScanMode<InventoryItemLookup>> CreateScanModes() => new[]
{
			...
			protected override InventoryItem GetByBarcode(string barcode)
			{
				InventoryItem item =
					...
					Where<
						...
						And<INItemXRef.alternateType.IsIn<INAlternateType.barcode, INAlternateType.gIN>>.
	...
	{
		/// <summary>
		/// Overrides <see cref="InventorySummaryEnq._(Events.FieldSelecting{InventorySummaryEnquiryResult.locationID})" />
		/// </summary>
		protected virtual void _(Events.FieldSelecting<InventorySummaryEnquiryResult.locationID> e, PXFieldSelecting baseMethod)
		{
			...
			{
				var displayName = PXUIFieldAttribute.GetDisplayName<InventorySummaryEnquiryResult.locationID>(e.Cache);
