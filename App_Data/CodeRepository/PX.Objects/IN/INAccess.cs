...
namespace PX.Objects.IN
{
	public class INAccessDetail : PX.SM.UserAccess
	{
        ...
        public new PXSave<INSite> Save;
		public new PXCancel<INSite> Cancel;
		public new PXFirst<INSite> First;
		public new PXPrevious<INSite> Prev;
		public new PXNext<INSite> Next;
		public new PXLast<INSite> Last;
		...
		protected virtual void InventoryItem_RowInserted(PXCache sender, PXRowInsertedEventArgs e)
		{
			if (e.Row != null)
			{
				...
				if (item != null)
				{
					...
					sender.MarkUpdated(e.Row, assertError: true);
				}
				else
				{
					sender.Delete(e.Row);
	...
	{
		public new PXSave<INItemClass> Save;
		public new PXCancel<INItemClass> Cancel;
		public new PXFirst<INItemClass> First;
		public new PXPrevious<INItemClass> Prev;
		public new PXNext<INItemClass> Next;
		public new PXLast<INItemClass> Last;
	}

	public class INAccessDetailByItem : INAccessDetailItem
	{
		public new PXSave<InventoryItem> Save;
		public new PXCancel<InventoryItem> Cancel;
		public new PXFirst<InventoryItem> First;
		public new PXPrevious<InventoryItem> Prev;
		public new PXNext<InventoryItem> Next;
		public new PXLast<InventoryItem> Last;
	}
