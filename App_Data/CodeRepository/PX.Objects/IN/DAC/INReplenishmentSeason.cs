...
namespace PX.Objects.IN
{
	...
	public partial class INReplenishmentSeason: IBqlTable
	{
		...
		{
			public static INReplenishmentSeason Find(PXGraph graph, string replenishmentPolicyID, int? seasonID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, replenishmentPolicyID, seasonID, options);
		}
