...
namespace PX.Objects.IN
{
	...
	public partial class INItemCostHist : PX.Data.IBqlTable
	{
		...
		{
			public static INItemCostHist Find(PXGraph graph, int? inventoryID, int? costSubItemID, int? costSiteID, int? accountID, int? subID, string finPeriodID, PKFindOptions options = PKFindOptions.None)
		...
		#endregion
		#region FinPtdCostAMAssemblyIn
		[PXDBDecimal(4)]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? FinPtdCostAMAssemblyIn { get; set; }
		public abstract class finPtdCostAMAssemblyIn : PX.Data.BQL.BqlDecimal.Field<finPtdCostAMAssemblyIn> { }
		#endregion
		#region FinPtdCostAMAssemblyOut
		[PXDBDecimal(4)]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? FinPtdCostAMAssemblyOut { get; set; }
		public abstract class finPtdCostAMAssemblyOut : PX.Data.BQL.BqlDecimal.Field<finPtdCostAMAssemblyOut> { }
		#endregion
		...
		#endregion
		#region FinPtdQtyAMAssemblyIn
		[PXDBQuantity]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? FinPtdQtyAMAssemblyIn { get; set; }
		public abstract class finPtdQtyAMAssemblyIn : PX.Data.BQL.BqlDecimal.Field<finPtdQtyAMAssemblyIn> { }
		#endregion
		#region FinPtdQtyAMAssemblyOut
		[PXDBQuantity]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? FinPtdQtyAMAssemblyOut { get; set; }
		public abstract class finPtdQtyAMAssemblyOut : PX.Data.BQL.BqlDecimal.Field<finPtdQtyAMAssemblyOut> { }
		#endregion
		...
		#endregion
		#region TranPtdCostAMAssemblyIn
		[PXDBDecimal(4)]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? TranPtdCostAMAssemblyIn { get; set; }
		public abstract class tranPtdCostAMAssemblyIn : PX.Data.BQL.BqlDecimal.Field<tranPtdCostAMAssemblyIn> { }
		#endregion
		#region TranPtdCostAMAssemblyOut
		[PXDBDecimal(4)]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? TranPtdCostAMAssemblyOut { get; set; }
		public abstract class tranPtdCostAMAssemblyOut : PX.Data.BQL.BqlDecimal.Field<tranPtdCostAMAssemblyOut> { }
		#endregion
		...
		#endregion
		#region TranPtdQtyAMAssemblyIn
		[PXDBQuantity]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? TranPtdQtyAMAssemblyIn { get; set; }
		public abstract class tranPtdQtyAMAssemblyIn : PX.Data.BQL.BqlDecimal.Field<tranPtdQtyAMAssemblyIn> { }
		#endregion
		#region TranPtdQtyAMAssemblyOut
		[PXDBQuantity]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? TranPtdQtyAMAssemblyOut { get; set; }
		public abstract class tranPtdQtyAMAssemblyOut : PX.Data.BQL.BqlDecimal.Field<tranPtdQtyAMAssemblyOut> { }
		#endregion
