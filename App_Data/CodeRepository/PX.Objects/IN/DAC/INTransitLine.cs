...
namespace PX.Objects.IN
{
    ...
    public partial class INTransitLine : PX.Data.IBqlTable
    {
        ...
        {
            public static INTransitLine Find(PXGraph graph, int? costSiteID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, costSiteID, options);
        }
        ...
        [IN.Location(typeof(toSiteID), DisplayName = "To Location ID")]
