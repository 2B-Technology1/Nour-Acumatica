...
namespace PX.Objects.IN
{
	...
	public class INItemCost : IBqlTable
	{
		...
		{
			public static INItemCost Find(PXGraph graph, int? inventoryID, string baseCuryID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, inventoryID, baseCuryID, options);
		}
		...
		[PXDBCalced(typeof(Switch<Case<Where<InventoryItem.valMethod, Equal<INValMethod.standard>>, InventoryItemCurySettings.stdCost,
								...
								Switch<Case<Where<INItemCost.qtyOnHand, Equal<decimal0>>, decimal0,
									...
									Div<INItemCost.totalCost, INItemCost.qtyOnHand>>>), typeof(Decimal), CastToScale = 9, CastToPrecision = 25)]
