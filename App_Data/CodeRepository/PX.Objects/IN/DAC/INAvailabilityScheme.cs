...
namespace PX.Objects.IN
{
	...
	public class INAvailabilityScheme : IBqlTable
	{
		...
		{
			public static INAvailabilityScheme Find(PXGraph graph, string availabilitySchemeID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, availabilitySchemeID, options);
		}
		#endregion
