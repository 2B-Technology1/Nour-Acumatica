...
namespace PX.Objects.IN
{
	...
	public partial class INReplenishmentPolicy : PX.Data.IBqlTable
	{
		...
		{
			public static INReplenishmentPolicy Find(PXGraph graph, string replenishmentPolicyID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, replenishmentPolicyID, options);
		}
