...
namespace PX.Objects.IN
{
	...
	public partial class INItemCustSalesHist : PX.Data.IBqlTable
	{
        ...
        {
            public static INItemCustSalesHist Find(PXGraph graph, int? inventoryID, int? costSubItemID, int? costSiteID, int? bAccountID, string finPeriodID, PKFindOptions options = PKFindOptions.None)
                => FindBy(graph, inventoryID, costSubItemID, costSiteID, bAccountID, finPeriodID, options);
        }
