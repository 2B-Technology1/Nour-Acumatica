...
namespace PX.Objects.IN
{
	...
	public partial class INItemRep : PX.Data.IBqlTable
	{
		...
		{
			public static INItemRep Find(PXGraph graph, int? inventoryID, string curyID, string replenishmentClassID, PKFindOptions options = PKFindOptions.None) 
				=> FindBy(graph, inventoryID, curyID, replenishmentClassID, options);
		}
