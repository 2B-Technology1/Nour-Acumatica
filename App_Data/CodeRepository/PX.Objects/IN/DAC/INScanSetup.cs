...
namespace PX.Objects.IN
{
	...
	public class INScanSetup : IBqlTable
	{
		...
		{
			public static INScanSetup Find(PXGraph graph, int? branchID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, options);
		}
		...
		#region UseDefaultLotSerialNbrInTransfer
		[PXDBBool]
		[PXDefault(false)]
		...
		public abstract class useDefaultLotSerialNbrInTransfer : PX.Data.BQL.BqlBool.Field<useDefaultLotSerialNbrInTransfer> { }
		#endregion
