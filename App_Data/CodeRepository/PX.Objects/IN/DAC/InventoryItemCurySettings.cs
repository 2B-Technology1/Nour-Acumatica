...
namespace PX.Objects.IN
{
	...
	public class InventoryItemCurySettings : IBqlTable
    {
		...
		{
			public static InventoryItemCurySettings Find(PXGraph graph, int? inventoryID, string curyID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, inventoryID, curyID, options);
