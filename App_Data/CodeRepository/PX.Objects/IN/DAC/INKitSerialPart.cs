...
namespace PX.Objects.IN
{
	...
	public partial class INKitSerialPart : PX.Data.IBqlTable
	{
		...
		{
			public static INKitSerialPart Find(PXGraph graph, string docType, string refNbr, int? kitLineNbr, int? kitSplitLineNbr, int? partLineNbr, int? partSplitLineNbr, PKFindOptions options = PKFindOptions.None) 
				=> FindBy(graph, docType, refNbr, kitLineNbr, kitSplitLineNbr, partLineNbr, partSplitLineNbr, options);
		}
