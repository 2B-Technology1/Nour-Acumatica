...
{	
	...
	public partial class INItemSalesHistD : IBqlTable
	{
		...
		{
			public static INItemSalesHistD Find(PXGraph graph, int? inventoryID, int? siteID, int? subItemID, DateTime? sDate, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, inventoryID, siteID, subItemID, sDate, options);
		}
