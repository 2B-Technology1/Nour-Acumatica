...
namespace PX.Objects.IN
{
	...
	public partial class INCostStatus : PX.Data.IBqlTable
	{
		...
		{
			public static INCostStatus Find(PXGraph graph, int? inventoryID, int? costSubItemID, int? costSiteID, int? accountID, int? subID, string layerType, long? costID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, inventoryID, costSubItemID, costSiteID, accountID, subID, layerType, costID, options);
		}
