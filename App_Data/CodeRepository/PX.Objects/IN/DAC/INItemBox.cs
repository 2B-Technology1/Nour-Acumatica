...
namespace PX.Objects.IN
{
	...
	public partial class INItemBox : PX.Data.IBqlTable
	{
		...
		{
			public static INItemBox Find(PXGraph graph, int? inventoryID, string boxID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, inventoryID, boxID, options);
		}
	...
	public partial class INItemBoxEx : INItemBox
	{
		...
		{
			public static INItemBoxEx Find(PXGraph graph, int? inventoryID, string boxID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, inventoryID, boxID, options);
		}
		...
		[PXDBDecimal(2, MinValue = 0, BqlField = typeof(CSBox.length))]
		...
		[PXDBDecimal(2, MinValue = 0, BqlField = typeof(CSBox.width))]
		...
		[PXDBDecimal(2, MinValue = 0, BqlField = typeof(CSBox.height))]
