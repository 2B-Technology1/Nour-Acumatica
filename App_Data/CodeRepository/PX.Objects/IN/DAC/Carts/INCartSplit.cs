...
namespace PX.Objects.IN
{
	...
	public class INCartSplit : IBqlTable
	{
		...
		{
			public static INCartSplit Find(PXGraph graph, int? siteID, int? cartID, int? splitLineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, siteID, cartID, splitLineNbr, options);
		}
