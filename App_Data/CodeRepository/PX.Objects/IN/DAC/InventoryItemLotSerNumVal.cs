...
namespace PX.Objects.IN
{
	...
	/// (which corresponds to the <see cref="InventoryItemMaint"/> graph)
	/// </summary>
	[Serializable]
	...
	public class InventoryItemLotSerNumVal : IBqlTable, ILotSerNumVal
	{
		...
		{
			public static InventoryItemLotSerNumVal Find(PXGraph graph, int? inventoryID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, inventoryID, options);
