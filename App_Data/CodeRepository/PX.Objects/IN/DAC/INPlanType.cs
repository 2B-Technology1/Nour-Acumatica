...
namespace PX.Objects.IN
{
	...
	public partial class INPlanType : PX.Data.IBqlTable
	{
		...
		{
			public static INPlanType Find(PXGraph graph, string planType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, planType, options);
		}
		...
		#endregion
		#region LocalizedDescr
		protected String _LocalizedDescr;
		public abstract class localizedDescr : PX.Data.BQL.BqlString.Field<localizedDescr> { }
		[PXString(60, IsUnicode = true)]
		[PXUIField(DisplayName = "Description", Visibility = PXUIVisibility.SelectorVisible)]
		[LocalizedField(typeof(descr))]
		public virtual string LocalizedDescr
		{
			get
			{
				return this._LocalizedDescr;
			}
			set
			{
				this._LocalizedDescr = value;
			}
		}
		#endregion
		#region IsFixed
		...
		*/
		...
		public class LocalizedFieldAttribute : PXEventSubscriberAttribute, IPXRowSelectingSubscriber
		{
			...
			public LocalizedFieldAttribute(Type origField)
			{
				_origField = origField;
			}

			public virtual void RowSelecting(PXCache sender, PXRowSelectingEventArgs e)
			{
				string origFieldValue = (string)sender.GetValue(e.Row, _origField.Name);
				sender.SetValue(e.Row, _FieldName, PXLocalizer.Localize(origFieldValue));
			}
		}
	}
