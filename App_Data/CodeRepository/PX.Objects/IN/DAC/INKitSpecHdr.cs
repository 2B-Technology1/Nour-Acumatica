...
namespace PX.Objects.IN
{
	...
	public partial class INKitSpecHdr : PX.Data.IBqlTable
	{
		...
		{
			public static INKitSpecHdr Find(PXGraph graph, int? kitInventoryID, string revisionID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, kitInventoryID, revisionID, options);
		}
