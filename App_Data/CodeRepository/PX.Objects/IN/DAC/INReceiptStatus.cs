...
namespace PX.Objects.IN
{
	...
	public partial class INReceiptStatus : PX.Data.IBqlTable
	{
		...
		{
			public static INReceiptStatus Find(PXGraph graph, string docType, string receiptNbr, int? inventoryID, int? costSubItemID, int? costSiteID, string lotSerialNbr, int? accountID, int? subID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, docType, receiptNbr, inventoryID, costSubItemID, costSiteID, lotSerialNbr, accountID, subID, options);
		}
