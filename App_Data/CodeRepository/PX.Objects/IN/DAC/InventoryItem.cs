...
namespace PX.Objects.IN
{
	...
	public class InventoryItem : IBqlTable, PX.SM.IIncludable
	{
		...
		public abstract class postToExpenseAccount : PX.Data.BQL.BqlString.Field<postToExpenseAccount>
		{
			...
			public class purchases : BqlString.Constant<purchases> { public purchases() : base(Purchases) { } }
			public class sales : BqlString.Constant<sales> { public sales() : base(Sales) { } }
	...
	public class CommodityCodeTypes
	{
		...
		public class hSCode : BqlString.Constant<hSCode> { public hSCode() : base(HSCode) { } }
		public class hTSCode : BqlString.Constant<hTSCode> { public hTSCode() : base(HTSCode) { } }
		public class hSNCode : BqlString.Constant<hSNCode> { public hSNCode() : base(HSNCode) { } }
		public class nCMCode : BqlString.Constant<nCMCode> { public nCMCode() : base(NCMCode) { } }
		public class uNSPSCCode : BqlString.Constant<uNSPSCCode> { public uNSPSCCode() : base(UNSPSCCode) { } }
		public class serviceCode : BqlString.Constant<serviceCode> { public serviceCode() : base(ServiceCode) { } }
	...
	public class INPlanningMethod
	{
		...
		/// </summary>
		public class inventoryReplenishment : PX.Data.BQL.BqlString.Constant<inventoryReplenishment>
		{
			public inventoryReplenishment() : base(InventoryReplenishment) {; }
		}
		...
		/// Contract level DRP
		/// </summary>
		public class dRP : PX.Data.BQL.BqlString.Constant<dRP>
		{
			public dRP() : base(DRP) {; }
		}
		...
		/// Contract level MRP
		/// </summary>
		public class mRP : PX.Data.BQL.BqlString.Constant<mRP>
		{
			public mRP() : base(MRP) {; }
		}
	}
