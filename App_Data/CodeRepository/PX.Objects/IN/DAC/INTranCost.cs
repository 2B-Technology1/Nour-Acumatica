...
using SpecificCostStatus = PX.Objects.IN.InventoryRelease.Accumulators.CostStatuses.SpecificCostStatus;
...
namespace PX.Objects.IN
{
	...
	public partial class INTranCost : PX.Data.IBqlTable
	{
		...
		{
			public static INTranCost Find(PXGraph graph, string docType, string refNbr, int? lineNbr, long? costID, string costDocType, string costRefNbr, PKFindOptions options = PKFindOptions.None) =>
				FindBy(graph, docType, refNbr, lineNbr, costID, costDocType, costRefNbr, options);
		}
		...
		[PXDefault(typeof(Coalesce<Search<SpecificCostStatus.lotSerialNbr, Where<SpecificCostStatus.costID, Equal<Current<INTranCost.costID>>>>,
            Search<SpecificTransitCostStatus.lotSerialNbr, Where<SpecificTransitCostStatus.costID, Equal<Current<INTranCost.costID>>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		#endregion
		#region IsVirtual
		[Obsolete(Common.Messages.ItemIsObsoleteAndWillBeRemoved2023R1 + " Use the CostType field instead.")]
