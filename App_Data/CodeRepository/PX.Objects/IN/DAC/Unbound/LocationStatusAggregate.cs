...
{
	[PXHidden]
	public class LocationStatusAggregate : LocationStatusAggregate.ITable
	{
		public interface ITable : SiteStatusAggregate.ITable
		{
			int? LocationID { get; }
		...
		#endregion
		#region ExcludeRecord
		public abstract class excludeRecord : Data.BQL.BqlBool.Field<excludeRecord> { }
		[PXBool(IsKey = true)]
		public virtual bool? ExcludeRecord
		{
			get;
			set;
		}
