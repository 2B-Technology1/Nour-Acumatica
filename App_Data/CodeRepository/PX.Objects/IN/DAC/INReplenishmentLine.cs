...
namespace PX.Objects.IN
{
    ...
    public partial class INReplenishmentLine : IBqlTable
    {
        ...
        {
            public static INReplenishmentLine Find(PXGraph graph, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, refNbr, lineNbr, options);
        }
		...
		[IN.SiteAvail(typeof(INReplenishmentLine.inventoryID), typeof(INReplenishmentLine.subItemID), typeof(CostCenter.freeStock))]
