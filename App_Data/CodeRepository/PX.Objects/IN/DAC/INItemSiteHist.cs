...
namespace PX.Objects.IN
{
	...
	public partial class INItemSiteHist : PX.Data.IBqlTable
	{
		...
		{
			public static INItemSiteHist Find(PXGraph graph, int? inventoryID, int? siteID, int? subItemID, int? locationID, string finPeriodID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, inventoryID, siteID, subItemID, locationID, finPeriodID, options);
		}
