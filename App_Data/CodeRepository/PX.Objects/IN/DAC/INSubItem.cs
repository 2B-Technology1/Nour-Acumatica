...
namespace PX.Objects.IN
{
	...
	/// (which corresponds to the <see cref="INSubItemMaint"/> graph).
	/// </summary>
    ...
    public partial class INSubItem : PX.Data.IBqlTable
	{
		...
		{
			public static INSubItem Find(PXGraph graph, int? subItemID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, subItemID, options);
		}
		#endregion
		#region SubItemID
