...
namespace PX.Objects.IN
{
	...
	public partial class INItemClassRep : PX.Data.IBqlTable
	{
		...
		{
			public static INItemClassRep Find(PXGraph graph, int? itemClassID, string curyID, string replenishmentClassID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, itemClassID, curyID, replenishmentClassID, options);
		}
