...
namespace PX.Objects.IN
{
	...
	public partial class INItemSiteReplenishment : IBqlTable
	{
		...
		{
			public static INItemSiteReplenishment Find(PXGraph graph, int? inventoryID, int? siteID, int? subItemID, PKFindOptions options = PKFindOptions.None) 
				=> FindBy(graph, inventoryID, siteID, subItemID, options);
		}
