...
namespace PX.Objects.IN
{
    ...
    public partial class INSetup : PX.Data.IBqlTable
	{
		...
		#region IncludeSaleInTurnover
		[PXBool]
		[PXUnboundDefault(true)]
		[PXUIField(DisplayName = "Include Sales", Enabled = false)]
		public virtual bool? IncludeSaleInTurnover { get; set; }
		public abstract class includeSaleInTurnover : PX.Data.BQL.BqlBool.Field<includeSaleInTurnover> { }
		#endregion
		#region IncludeProductionInTurnover
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Include Production Orders")]
		public virtual bool? IncludeProductionInTurnover { get; set; }
		public abstract class includeProductionInTurnover : PX.Data.BQL.BqlBool.Field<includeProductionInTurnover> { }
		#endregion
		#region IncludeAssemblyInTurnover
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Include Assemblies")]
		public virtual bool? IncludeAssemblyInTurnover { get; set; }
		public abstract class includeAssemblyInTurnover : PX.Data.BQL.BqlBool.Field<includeAssemblyInTurnover> { }
		#endregion
		#region IncludeIssueInTurnover
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Include Issues and Adjustments")]
		public virtual bool? IncludeIssueInTurnover { get; set; }
		public abstract class includeIssueInTurnover : PX.Data.BQL.BqlBool.Field<includeIssueInTurnover> { }
		#endregion
		#region IncludeTransferInTurnover
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Include Transfers")]
		public virtual bool? IncludeTransferInTurnover { get; set; }
		public abstract class includeTransferInTurnover : PX.Data.BQL.BqlBool.Field<includeTransferInTurnover> { }
		#endregion
	}
}
