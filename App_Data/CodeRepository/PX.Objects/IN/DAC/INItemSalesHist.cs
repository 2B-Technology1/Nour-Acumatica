...
namespace PX.Objects.IN
{
	...
	public partial class INItemSalesHist : PX.Data.IBqlTable
	{
		...
		{
			public static INItemSalesHist Find(PXGraph graph, int? inventoryID, int? costSubItemID, int? costSiteID, string finPeriodID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, inventoryID, costSubItemID, costSiteID, finPeriodID, options);
		}
