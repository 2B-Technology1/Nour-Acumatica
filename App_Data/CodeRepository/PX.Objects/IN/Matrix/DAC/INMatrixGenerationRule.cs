...
namespace PX.Objects.IN.Matrix.DAC
{
	...
	public class INMatrixGenerationRule : IBqlTable
	{
		...
		{
			public static INMatrixGenerationRule Find(PXGraph graph, string parentType, int? parentID, string type, int? lineNbr, PKFindOptions options = PKFindOptions.None)
		...
		[PXSelector(typeof(Search2<CSAnswers.attributeID,
