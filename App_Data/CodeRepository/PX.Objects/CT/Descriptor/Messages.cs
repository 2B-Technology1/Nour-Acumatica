...
namespace PX.Objects.CT
{
	...
	public static class Messages
	{
		...
		public const string ItemNotPrice = "The item has no price set up in the currency selected in the Currency ID box.";
		...
		public const string ContractCuryCannotBeChangedDueToDetails = "The contract currency cannot be changed because the {0} contract item with the {1} currency is provided under the contract.";
		public const string CurrentBaseCurrenceDiffersFromCustomer = "The usage of the {0} customer who is to be billed for the contract is restricted in the {1} branch, which will be used in an AR document for contract billing. Sign in to the branch where the usage of the {2} customer is allowed.";
		public const string ContractUsageWithDiffBaseCurrencyExists = "There is contract usage recorded for this contract under the {0} branch. Usage of the {1} customer is restricted in this branch and you will not be able to bill the contract usage to the customer.";
		#endregion
