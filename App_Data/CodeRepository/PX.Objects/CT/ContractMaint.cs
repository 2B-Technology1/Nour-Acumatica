					...
					if (item.IsBaseValid == true)
					{
						...
						if (inventory != null)
						{
							...
							DiscountEngine.SetLineDiscountOnly<ContractDetail>(sender, det,
								...
								ContractDetail.baseDiscountSeq, DiscountLineFields.discountsAppliedToLine, DiscountLineFields.manualDisc, DiscountLineFields.manualPrice, DiscountLineFields.lineType, DiscountLineFields.isFree, DiscountLineFields.calculateDiscountsOnImport, DiscountLineFields.automaticDiscountsDisabled, DiscountLineFields.skipLineDiscounts>(sender, det), contract.DiscountID,
					...
					if (item.IsFixedRecurringValid == true || item.IsUsageValid == true)
					{
						...
						if (inventory != null)
						{
							DiscountEngine.SetLineDiscountOnly<ContractDetail>(sender, det,
								...
								ContractDetail.recurringDiscountSeq, DiscountLineFields.discountsAppliedToLine, DiscountLineFields.manualDisc, DiscountLineFields.manualPrice, DiscountLineFields.lineType, DiscountLineFields.isFree, DiscountLineFields.calculateDiscountsOnImport, DiscountLineFields.automaticDiscountsDisabled, DiscountLineFields.skipLineDiscounts>(sender, det), contract.DiscountID,
					...
					if (item.IsRenewalValid == true)
					{
						...
						if (inventory != null)
						{
							DiscountEngine.SetLineDiscountOnly<ContractDetail>(sender, det,
								...
								ContractDetail.renewalDiscountSeq, DiscountLineFields.discountsAppliedToLine, DiscountLineFields.manualDisc, DiscountLineFields.manualPrice, DiscountLineFields.lineType, DiscountLineFields.isFree, DiscountLineFields.calculateDiscountsOnImport, DiscountLineFields.automaticDiscountsDisabled, DiscountLineFields.skipLineDiscounts>(sender, det), contract.DiscountID,
