...
namespace PX.Objects.CT
{
	public class ContractPriceUpdate : PXGraph<ContractPriceUpdate>
	{
		...
		public PXSelectJoin<
			...
			Where<ContractDetail.contractItemID, Equal<Current<ContractFilter.contractItemID>>>>
			ItemsView;
		...
		protected virtual IEnumerable items()
		{
			...
			List<PXResult<ContractDetail, Contract, Customer>> result = new List<PXResult<ContractDetail, Contract, Customer>>();
			foreach (PXResult<ContractDetail, Contract, Customer> res in ItemsView.Select())
			{
