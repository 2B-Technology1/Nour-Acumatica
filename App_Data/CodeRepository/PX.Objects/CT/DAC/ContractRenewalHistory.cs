...
namespace PX.Objects.CT
{
	...
	public partial class ContractRenewalHistory : PX.Data.IBqlTable
	{
		...
		{
			public static ContractRenewalHistory Find(PXGraph graph, int? contractID, Int32? revID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contractID, revID, options);
		}
