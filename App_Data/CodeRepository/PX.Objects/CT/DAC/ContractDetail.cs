...
namespace PX.Objects.CT
{
	...
	public partial class ContractDetail : PX.Data.IBqlTable
	{
		...
		{
			public static ContractDetail Find(PXGraph graph, int? contractID, Int32? contractDetailID, Int32? revID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contractID, contractDetailID, revID, options);
		}
		...
		[PXFormula(typeof(GetItemPriceValue<
			...
			ContractDetail.qty,
			IsNull<Parent<Contract.startDate>, Current<AccessInfo.businessDate>>>))]
		...
		[PXFormula(typeof(GetItemPriceValue<
			...
			ContractDetail.basePriceVal, 
			ContractDetail.qty,
			IsNull<Parent<Contract.activationDate>, Current<AccessInfo.businessDate>>>))]
