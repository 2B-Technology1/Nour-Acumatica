...
namespace PX.Objects.CT
{
	...
	public class ContractBillingTrace : IBqlTable
    {
      ...
      {
         public static ContractBillingTrace Find(PXGraph graph, int? contractID, Int32? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contractID, recordID, options);
      }
