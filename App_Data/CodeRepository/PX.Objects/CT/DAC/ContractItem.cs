...
namespace PX.Objects.CT
{
	...
	public class ContractItem : IBqlTable
	{
		...
		{
			public static ContractItem Find(PXGraph graph, int? contractItemID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contractItemID, options);
		}
		public class UK : PrimaryKeyOf<ContractItem>.By<contractItemCD>
		{
			public static ContractItem Find(PXGraph graph, string contractItemCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contractItemCD, options);
		}
		...
		#region BaseItemCurySettingsID
		public abstract class baseItemCurySettingsID : PX.Data.BQL.BqlInt.Field<baseItemCurySettingsID> { }

		[PXInt]
		[PXSelector(typeof(Search<InventoryItemCurySettings.inventoryID,
			Where<InventoryItemCurySettings.inventoryID, Equal<baseItemID.FromCurrent>,
				And<InventoryItemCurySettings.curyID, Equal<Current<AccessInfo.baseCuryID>>>>>),
			ValidateValue = false)]
		[PXFormula(typeof(baseItemID))]
		...
		#endregion
		#region RenewalItemCurySettingsID
		public abstract class renewalItemCurySettingsID : PX.Data.BQL.BqlInt.Field<renewalItemCurySettingsID> { }

		[PXInt]
		[PXSelector(typeof(Search<InventoryItemCurySettings.inventoryID,
			Where<InventoryItemCurySettings.inventoryID, Equal<renewalItemID.FromCurrent>,
				And<InventoryItemCurySettings.curyID, Equal<Current<AccessInfo.baseCuryID>>>>>),
			ValidateValue = false)]
		[PXFormula(typeof(renewalItemID))]
		...
		#endregion
		#region RecurringItemCurySettingsID
		public abstract class recurringItemCurySettingsID : PX.Data.BQL.BqlInt.Field<recurringItemCurySettingsID> { }

		[PXInt]
		[PXSelector(typeof(Search<InventoryItemCurySettings.inventoryID,
			Where<InventoryItemCurySettings.inventoryID, Equal<recurringItemID.FromCurrent>,
				And<InventoryItemCurySettings.curyID, Equal<Current<AccessInfo.baseCuryID>>>>>),
			ValidateValue = false)]
		[PXFormula(typeof(recurringItemID))]
