...
namespace PX.Objects.PO.LandedCosts.Attributes
{
	public class POLandedCostTaxAttribute : TaxAttribute
	{
		...
		{
			POLandedCostDetail detailRow = row as POLandedCostDetail;

			if (detailRow != null && detailRow.AllocationMethod != LandedCostAllocationMethod.None)
			{
				sender.RaiseExceptionHandling<POLandedCostDetail.taxCategoryID>(detailRow, detailRow.TaxCategoryID,
