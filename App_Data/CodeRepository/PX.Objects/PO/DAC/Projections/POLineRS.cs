...
namespace PX.Objects.PO
{
	...
	public partial class POLineRS : IBqlTable, IAPTranSource, ISortOrder
	{
		...
		{
			public static POLineRS Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderType, orderNbr, lineNbr, options);
		}
		public static class FK
		{
			...
			public class Task : PMTask.PK.ForeignKeyOf<POLineRS>.By<projectID, taskID> { }
		...
		[PXDBCalced(typeof(
			...
			Switch<Case<Where<POLine.completePOLine, Equal<CompletePOLineTypes.quantity>>,
				...
				Switch<Case<Where<POLine.curyExtCost, Greater<decimal0>,
					And<Div<Mult<Add<POLine.curyExtCost, POLine.curyRetainageAmt>, POLine.rcptQtyThreshold>, decimal100>, Greater<POLine.curyBilledAmt>>>, False>,
				Switch<Case<Where<POLine.curyExtCost, Less<decimal0>,
					And<Div<Mult<Add<POLine.curyExtCost, POLine.curyRetainageAmt>, POLine.rcptQtyThreshold>, decimal100>, Less<POLine.curyBilledAmt>>>, False>,
				True>>>>),
			typeof(bool))]
