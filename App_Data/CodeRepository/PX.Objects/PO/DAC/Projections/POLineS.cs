...
namespace PX.Objects.PO
{
	...
	public partial class POLineS : IBqlTable, IAPTranSource, ISortOrder
	{
		...
		{
			public static POLineS Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderType, orderNbr, lineNbr, options);
		}
		public static class FK
		{
			...
			public class Task : PMTask.PK.ForeignKeyOf<POLineS>.By<projectID, taskID> { }
