...
namespace PX.Objects.PO
{
    ...
    [PXProjection(typeof(
        SelectFrom<POAccrualDetail>
            ...
            .LeftJoin<INTranDocInfo>
                .On<INTranDocInfo.docType.IsNotEqual<INDocType.adjustment>
                .And<INTranDocInfo.pOReceiptType.IsEqual<POAccrualDetail.pOReceiptType>>
                .And<INTranDocInfo.pOReceiptNbr.IsEqual<POAccrualDetail.pOReceiptNbr>>
                .And<INTranDocInfo.pOReceiptLineNbr.IsEqual<POAccrualDetail.lineNbr>>
				.And<INTranDocInfo.pOReceiptType.IsEqual<POAccrualDetail.pOReceiptType>>>
        .Where<
            ...
            .And<
                Brackets<POAccrualDetail.aPRefNbr.IsNotNull
                    .And<
						...
						.Or<Brackets<POAccrualDetail.reversedFinPeriodID.IsGreater<POAccrualInquiryFilter.finPeriodID.FromCurrent.Value>
								.Or<POAccrualDetail.reversedFinPeriodID.IsNull>>
							.And<Brackets<POAccrualDetail.reversingFinPeriodID.IsGreater<POAccrualInquiryFilter.finPeriodID.FromCurrent.Value>
								.Or<POAccrualDetail.reversingFinPeriodID.IsNull>>>
    ...
    public class POAccrualInquiryResult : IBqlTable
    {
        ...
        #region INDocType
        [PXDBString(1, IsFixed = true, BqlField = typeof(INTranDocInfo.docType))]
        [INDocType.List]
        ...
        #endregion
        #region INRefNbr
        [PXDBString(15, IsUnicode = true, BqlField = typeof(INTranDocInfo.refNbr))]
