...
namespace PX.Objects.PO
{
	...
	public class POCreateProjectionAttribute : TM.OwnedFilter.ProjectionAttribute
	{
		...
		typeof(Where<INItemPlan.hold, Equal<False>,
				...
				And<Where<INItemPlan.supplyPlanID, IsNull, And<SOLineSplit.pONbr, IsNull,
					Or<SOLineSplit.pONbr, IsNotNull, And<INItemPlan.planType, In3<INPlanConstants.plan6B, INPlanConstants.plan6E>>>>>>>>>>),
		typeof(And<>),
	...
	public partial class POFixedDemand : INItemPlan
	{
		...
		[PXUIField(DisplayName = Messages.PlanTypeDescr)]
		...
		[PXDimensionSelector(SiteAttribute.DimensionName, typeof(Search<INSite.siteID, Where<Match<INSite, Current<AccessInfo.userName>>>>),
														  typeof(INSite.siteCD), DescriptionField = typeof(INSite.descr), CacheGlobal = true)]
		...
		#endregion
		#region DemandUOM
		public abstract class demandUOM : PX.Data.BQL.BqlString.Field<demandUOM> { }
		...
		[PXDBCalced(typeof(Switch<
			...
			Case<Where<SOLine.isSpecialOrder, Equal<True>>, SOLineSplit.uOM>>,
			INUnit.fromUnit>),
			typeof(string))]
		[PXUIField(DisplayName = "UOM")]
		public virtual String DemandUOM
		{
			get;
			set;
		}
		...
		[PXDBCalced(typeof(Switch<
			Case<Where<SOLine.orderNbr, IsNotNull,
				And<SOLine.pOSource, Equal<INReplenishmentSource.dropShipToOrder>>>, SOLine.openQty.Multiply<SOLine.lineSign>,
		...
		[PXDBCalced(typeof(Switch<Case<Where<SOLine.isSpecialOrder, Equal<True>>, SOLineSplit.qty>, Null>), typeof(decimal))]
		[PXQuantity()]
		...
		#endregion
		#region DemandProjectID
		public abstract class demandProjectID : PX.Data.BQL.BqlInt.Field<demandProjectID> { }
		[PXDBInt(BqlField = typeof(SOLine.projectID))]
		public virtual int? DemandProjectID
		{
			get;
			set;
		}
