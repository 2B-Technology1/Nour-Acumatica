...
namespace PX.Objects.PO
{
	...
	public partial class POVendorInventory : PX.Data.IBqlTable
	{
		...
		{
			public static POVendorInventory Find(PXGraph graph, int? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, recordID, options);
		}
		...
		[VendorNonEmployeeActiveOrHoldPayments(Visibility = PXUIVisibility.SelectorVisible,
    ...
    public class POVendorInventoryAll : POVendorInventory
    {
		...
		{
			public static POVendorInventoryAll Find(PXGraph graph, int? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, recordID, options);
		}
	...
	[PXProjection(typeof(Select5<POVendorInventory, 
		LeftJoin<POVendorInventoryAll, 
				...
				And<IsNull<POVendorInventory.subItemID, int_1>, Equal<IsNull<POVendorInventoryAll.subItemID, int_1>>,
	...
	public class POVendorInventoryU : POVendorInventory
	{
		...
		{
			public static POVendorInventoryU Find(PXGraph graph, int? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, recordID, options);
		}
		public new static class FK
		{
