...
namespace PX.Objects.PO
{
	...
	public partial class POReceipt : PX.Data.IBqlTable, PX.Data.EP.IAssign, INotable
	{
		#region Keys
		public class PK : PrimaryKeyOf<POReceipt>.By<receiptType, receiptNbr>
		{
			public static POReceipt Find(PXGraph graph, string receiptType, string receiptNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, receiptType, receiptNbr, options);
		}
		public static class FK
		{
			...
			public class Owner : CR.Contact.PK.ForeignKeyOf<POReceipt>.By<ownerID> { }
		...
		[Obsolete(Common.Messages.ItemIsObsoleteAndWillBeRemoved2023R1 + " Use ReturnInventoryCostMode field instead.")]
		...
		{
			[PXDependsOnFields(typeof(released), typeof(invtDocType), typeof(invtRefNbr))]
			get;
			set;
		}
		#endregion
		...
		#region DropshipFieldsSet
		public abstract class dropshipFieldsSet : Data.BQL.BqlBool.Field<dropshipFieldsSet> { }
		[PXBool]
		public virtual bool? DropshipFieldsSet
		{
			get;
			set;
		}
		#endregion
		#region DropshipCustomerID
		public abstract class dropshipCustomerID : Data.BQL.BqlInt.Field<dropshipCustomerID> { }
		[Customer]
		public virtual int? DropshipCustomerID
		{
			get;
			set;
		}
		#endregion
		#region DropshipCustomerLocationID
		public abstract class dropshipCustomerLocationID : Data.BQL.BqlInt.Field<dropshipCustomerLocationID> { }
		[LocationActive(typeof(Where<Location.bAccountID, Equal<Current<dropshipCustomerID>>>))]
		public virtual int? DropshipCustomerLocationID
		{
			get;
			set;
		}
		#endregion
		#region DropshipCustomerOrderNbr
		public abstract class dropshipCustomerOrderNbr : Data.BQL.BqlString.Field<dropshipCustomerOrderNbr> { }
		[PXDBString(40, IsUnicode = true)]
		public virtual string DropshipCustomerOrderNbr
		{
			get;
			set;
		}
		#endregion
		#region DropshipShipVia
		public abstract class dropshipShipVia : Data.BQL.BqlString.Field<dropshipShipVia> { }
		[PXDBString(15, IsUnicode = true)]
		[PXSelector(typeof(Search<Carrier.carrierID>), CacheGlobal = true)]
		public virtual string DropshipShipVia
		{
			get;
			set;
		}
