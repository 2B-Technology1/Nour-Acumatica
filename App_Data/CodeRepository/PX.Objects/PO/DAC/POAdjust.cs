...
namespace PX.Objects.PO
{
	...
	public class POAdjust : IBqlTable, IAdjustmentStub
	{
		...
		{
			public static POAdjust Find(PXGraph graph, string adjgDocType, string adjgRefNbr, string adjdOrderType, string adjdOrderNbr, int? adjNbr, string adjdDocType, string adjdRefNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, adjgDocType, adjgRefNbr, adjdOrderType, adjdOrderNbr, adjNbr, adjdDocType, adjdRefNbr, options);
		}
