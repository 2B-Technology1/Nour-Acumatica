...
namespace PX.Objects.PO
{
    ...
    public partial class POOrderDiscountDetail : PX.Data.IBqlTable, IDiscountDetail
    {
		...
		{
			public static POOrderDiscountDetail Find(PXGraph graph, int? recordID, string orderType, string orderNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, recordID, orderType, orderNbr, options);
		}
