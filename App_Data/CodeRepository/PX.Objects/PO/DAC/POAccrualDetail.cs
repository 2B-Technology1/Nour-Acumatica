...
namespace PX.Objects.PO
{
    ...
    public class POAccrualDetail: IBqlTable
    {
		...
		{
			public static POAccrualDetail Find(PXGraph graph, Guid? documentNoteID, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, documentNoteID, lineNbr, options);
		}
		...
		#endregion
		#region ReversedFinPeriodID
		/// <summary>
		/// The financial period, when parent document was reversed.
		/// </summary>
		[FinPeriodID]
		public virtual string ReversedFinPeriodID { get; set; }
		/// <inheritdoc cref="ReversedFinPeriodID"/>
		public abstract class reversedFinPeriodID : BqlString.Field<reversedFinPeriodID> { }
		#endregion
		#region ReversingFinPeriodID
		/// <summary>
		...
		/// <inheritdoc cref="ReversingFinPeriodID"/>
		public abstract class reversingFinPeriodID : BqlString.Field<reversingFinPeriodID> { }
		#endregion
	}
