...
namespace PX.Objects.PO
{
	...
	public partial class LandedCostCode : PX.Data.IBqlTable
	{
		...
		{
			public static LandedCostCode Find(PXGraph graph, string landedCostCodeID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, landedCostCodeID, options);
		}
