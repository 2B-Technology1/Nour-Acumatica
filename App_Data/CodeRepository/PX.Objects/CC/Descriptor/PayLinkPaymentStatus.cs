	...
	public static class PayLinkPaymentStatus
	{
		...
		public class ListAttribute : PXStringListAttribute
		{
			...
			public static Tuple<string, string>[] ValueLabelPairs()
			{
				...
				{
					new Tuple<string, string>(None, Messages.PayLinkPaymentStatusNone),
					new Tuple<string, string>(Unpaid, Messages.PayLinkPaymentStatusUnpaid),
					new Tuple<string, string>(Paid, Messages.PayLinkPaymentStatusPaid),
					new Tuple<string, string>(Incomplete, Messages.PayLinkPaymentStatusIncomplete)
				};
				return arr;
			}
