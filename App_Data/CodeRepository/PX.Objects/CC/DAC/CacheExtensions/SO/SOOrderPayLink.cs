...
namespace PX.Objects.CC
{
	...
	/// </summary>
	public sealed class SOOrderPayLink : PXCacheExtension<SOOrder>
	{
		...
		[PXSelector(typeof(Search2<CCProcessingCenter.processingCenterID,
			...
			Where<CashAccount.curyID, Equal<Current<SOOrder.curyID>>,
				And<CCProcessingCenter.allowPayLink, Equal<True>,
				And<CCProcessingCenter.isActive, Equal<True>,
				And<CCProcessingCenterBranch.branchID, Equal<Current<SOOrder.branchID>>>>>>>),
