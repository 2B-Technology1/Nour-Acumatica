...
namespace PX.Objects.AR
{
	...
	public class CustomerPaymentMethodMassProcess: PXGraph<CustomerPaymentMethodMassProcess>
	{
		...
		public virtual void MailExpirationNotification(CustomerPaymentMethod aCard )
		{
			...
			try
			{
				this.GetExtension<CustomerPaymentMethodMassProcess_ActivityDetailsExt>().SendNotification(ARNotificationSource.Customer, notificationCD, null,  parameters, true);
			}
			catch (PXException e)
			{
