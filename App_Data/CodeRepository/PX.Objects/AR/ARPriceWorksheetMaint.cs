...
namespace PX.Objects.AR
{
    ...
    public class ARPriceWorksheetMaint : PXGraph<ARPriceWorksheetMaint, ARPriceWorksheet>, PXImportAttribute.IPXPrepareItems, PXImportAttribute.IPXProcess
	{
		...
		public PXSelectJoin<
			...
			Where<ARPriceWorksheetDetail.refNbr, Equal<Current<ARPriceWorksheet.refNbr>>,
				And<Where<ARPriceWorksheetDetail.priceType,NotEqual<PriceTypes.customer>,
		...
		#region Cache Attached event handlers

		#region ARPriceWorksheetDetail

		[PXMergeAttributes]
		[PXDBCalced(typeof(Use<InventoryItem.taxCategoryID>.AsString), typeof(string))]
		...
		protected virtual ARPriceWorksheetDetail CreateWorksheetDetailOnAddSelItems(ARAddItemSelected line)
        {
            ...
            ARPriceWorksheetDetail newWorksheetDetail = new ARPriceWorksheetDetail
            {
                ...
                UOM = line.BaseUnit,
				PriceType = addItemParameters.Current.PriceType,
				SkipLineDiscounts = addItemParameters.Current.SkipLineDiscounts == true && Document.Current.IsFairValue != true
			};
		...
		protected virtual void ARPriceWorksheet_RowUpdated(PXCache sender, PXRowUpdatedEventArgs e)
		{
			...
			{
				foreach (ARPriceWorksheetDetail detail in Details.Select())
				{
					detail.SkipLineDiscounts = doc.SkipLineDiscounts;
		...
		protected virtual void _(Events.FieldUpdated<ARPriceWorksheetDetail, ARPriceWorksheetDetail.inventoryID> e)
		{
			var inventory = InventoryItem.PK.Find(this, e.Row?.InventoryID);
			e.Cache.SetValueExt<ARPriceWorksheetDetail.taxCategoryID>(e.Row, inventory?.TaxCategoryID);
		}
	...
	public static class PriceCodeInfo
    {
        ...
        public const string PriceCodeNoteFieldName = "NoteId";
    }
    ...
    public partial class AddItemParameters : IBqlTable
    {
		...
		/// </summary>
		[PXDefault(typeof(ARPriceWorksheet.skipLineDiscounts), PersistingCheck = PXPersistingCheck.Nothing)]
    ...
    public partial class CopyPricesFilter : IBqlTable
    {
		...
		[ARPriceCodeSelector(typeof(sourcePriceType))]
        ...
        [PXDefault()]
        [PXUIField(DisplayName = "Price Code", Visibility = PXUIVisibility.SelectorVisible)]
		[ARPriceCodeSelector(typeof(destinationPriceType))]
