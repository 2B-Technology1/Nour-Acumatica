...
namespace PX.Objects.AR
{
	...
	public partial class DiscountInventoryPriceClass : PX.Data.IBqlTable
	{
		...
		{
			public static DiscountInventoryPriceClass Find(PXGraph graph, string discountID, string discountSequenceID, string inventoryPriceClassID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, discountID, discountSequenceID, inventoryPriceClassID, options);
		}

		public static class FK
		{
			public class DiscountSequence : AR.DiscountSequence.PK.ForeignKeyOf<DiscountInventoryPriceClass>.By<discountID, discountSequenceID> { }
			public class InventoryPriceClass : INPriceClass.PK.ForeignKeyOf<DiscountInventoryPriceClass>.By<inventoryPriceClassID> { }
		}
