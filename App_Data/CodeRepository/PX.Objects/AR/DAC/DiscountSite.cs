...
namespace PX.Objects.AR
{
	...
	public partial class DiscountSite : PX.Data.IBqlTable
    {
		...
		{
			public static DiscountSite Find(PXGraph graph, string discountID, string discountSequenceID, int? siteID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, discountID, discountSequenceID, siteID, options);
		}
