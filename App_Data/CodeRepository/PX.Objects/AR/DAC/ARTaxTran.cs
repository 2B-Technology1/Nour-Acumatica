...
namespace PX.Objects.AR
{
    ...
    public partial class ARTaxTran : TaxTran
    {
      ...
      {
         public static ARTaxTran Find(PXGraph graph, DateTime? tranDate, Int32? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranDate, recordID, options);
      }
      ...
      public new abstract class module : PX.Data.BQL.BqlString.Field<module> { }
        ...
        [PXUIField(DisplayName = Messages.TaxableAmount, Visibility = PXUIVisibility.Visible)]
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXUIField(DisplayName = Messages.TaxAmount, Visibility = PXUIVisibility.Visible)]
		...
		[PXDBDefault(typeof(ARRegister.docDesc), PersistingCheck = PXPersistingCheck.Nothing)]
    ...
    public partial class SalesTax : Tax
    {
      ...
      {
         public static SalesTax Find(PXGraph graph, string taxID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, taxID, options);
      }
      #endregion
      #region TaxID
      public new abstract class taxID : PX.Data.BQL.BqlString.Field<taxID> { }
