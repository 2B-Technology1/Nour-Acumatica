...
{
	/// <summary>
	/// A contact that is specified in a customer document,
	...
	public partial class ARContact : IBqlTable, IContact, IEmailMessageTarget
	{
		#region Keys
		public class PK : PrimaryKeyOf<ARContact>.By<contactID>
		{
			public static ARContact Find(PXGraph graph, Int32? contactID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contactID, options);
		}
	...
	public partial class ARShippingContact : ARContact
	{
		...
		{
			public static ARShippingContact Find(PXGraph graph, Int32? contactID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, contactID, options);
		}
