...
namespace PX.Objects.AR
{
	...
	/// <see cref="DiscountSequence">discount sequences</see>. The primary function of a discount
	...
	public partial class ARDiscount : PX.Data.IBqlTable
	{
		...
		{
			public static ARDiscount Find(PXGraph graph, String discountID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, discountID, options);
		}
		#endregion
