...
namespace PX.Objects.AR
{
    ...
    public partial class ARSPCommissionPeriod : IBqlTable
    {
      ...
      {
         public static ARSPCommissionPeriod Find(PXGraph graph, String commnPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, commnPeriodID, options);
      }
      #endregion
