...
namespace PX.Objects.AR
{
	...
	public partial class DiscountBranch : PX.Data.IBqlTable
	{
		...
		{
			public static DiscountBranch Find(PXGraph graph, string discountID, string discountSequenceID, int? branchID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, discountID, discountSequenceID, branchID, options);
		}
