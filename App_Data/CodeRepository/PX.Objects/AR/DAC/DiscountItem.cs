...
namespace PX.Objects.AR
{
	...
	public partial class DiscountItem : PX.Data.IBqlTable
	{
		...
		{
			public static DiscountItem Find(PXGraph graph, string discountID, string discountSequenceID, int? inventoryID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, discountID, discountSequenceID, inventoryID, options);
		}
