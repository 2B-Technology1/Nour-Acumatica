...
{
	/// <summary>
	/// A salesperson commission included in an <see cref="ARInvoice">accounts 
	...
	public partial class ARSalesPerTran : PX.Data.IBqlTable
	{
		...
		{
			public static ARSalesPerTran Find(PXGraph graph, string docType, string refNbr, Int32? salespersonID, Int32? adjNbr, String adjdDocType, String adjdRefNbr, PKFindOptions options = PKFindOptions.None)
												=> FindBy(graph, docType, refNbr, salespersonID, adjNbr, adjdDocType, adjdRefNbr, options);
		}
