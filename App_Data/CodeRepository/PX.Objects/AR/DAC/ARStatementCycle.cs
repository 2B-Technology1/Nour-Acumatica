...
namespace PX.Objects.AR
{
	...
	public partial class ARStatementCycle : IBqlTable
	{
		...
		{
			public static ARStatementCycle Find(PXGraph graph, string statementCycleId, PKFindOptions options = PKFindOptions.None) => FindBy(graph, statementCycleId, options);
		}
		#endregion
