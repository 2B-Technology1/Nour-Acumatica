...
namespace PX.Objects.AR
{
	...
	/// (AR202000) form, which corresponds to the <see cref="ARSalesPriceMaint"/> graph.
	/// </summary>
	...
	public partial class ARSalesPrice : PX.Data.IBqlTable
	{
		...
		{
			public static ARSalesPrice Find(PXGraph graph, Int32? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, recordID, options);
		}
