...
namespace PX.Objects.AR.Standalone
{
	...
	public class ARCashSale : ARRegister, ICCPayment, IApprovable, IApprovalDescription
	{
		...
		{
			public static ARCashSale Find(PXGraph graph, string docType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, options);
		}
		...
		[ARTermsSelector]
		[Terms(typeof(ARCashSale.docDate), null, null, typeof(ARCashSale.curyDocBal), typeof(ARCashSale.curyOrigDiscAmt), typeof(ARCashSale.curyTaxTotal))]
		...
		[PXDBTimestamp(BqlField = typeof(ARRegister.Tstamp), RecordComesFirst = true)]
		...
		/// <summary>
		/// The <see cref="goodsExtPriceTotal">total amount</see> on all lines of the document, except for Misc. Charges and empty or null Line Types
		...
		public virtual Decimal? DetailExtLineTotal
		{
			get;
			set;
		}
