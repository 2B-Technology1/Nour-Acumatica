...
namespace PX.Objects.AR
{
	...
	public partial class DiscountSequenceDetail : PX.Data.IBqlTable
    {
      ...
      {
         public static DiscountSequenceDetail Find(PXGraph graph, Int32? discountDetailsID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, discountDetailsID, options);
      }
      #endregion
