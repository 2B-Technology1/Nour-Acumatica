...
namespace PX.Objects.AR
{
	...
	public partial class ARDunningSetup : PX.Data.IBqlTable
    {
      ...
      {
         public static ARDunningSetup Find(PXGraph graph, Int32? dunningLetterLevel, PKFindOptions options = PKFindOptions.None) => FindBy(graph, dunningLetterLevel, options);
      }
      #endregion
