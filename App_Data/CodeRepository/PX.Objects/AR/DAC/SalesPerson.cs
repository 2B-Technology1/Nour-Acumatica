...
namespace PX.Objects.AR
{
	...
	public partial class SalesPerson : PX.Data.IBqlTable
	{
		...
		{
			public static SalesPerson Find(PXGraph graph, int? salesPersonID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, salesPersonID, options);
		}
		public class UK : PrimaryKeyOf<SalesPerson>.By<salesPersonCD>
		{
			public static SalesPerson Find(PXGraph graph, string salesPersonCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, salesPersonCD, options);
		}
