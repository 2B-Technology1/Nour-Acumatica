...
namespace PX.Objects.AR
{
	...
	public class ARPaymentTotals : IBqlTable
	{
		...
		{
			public static ARPaymentTotals Find(PXGraph graph, string docType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, options);
		}
		#endregion
