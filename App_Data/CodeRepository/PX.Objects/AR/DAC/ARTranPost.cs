...
namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<ARTranPost>.By<docType, refNbr, lineNbr, iD>
		{
			public static ARTranPost Find(PXGraph graph, string docType, string refNbr, int? lineNbr, int? id, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, lineNbr, id, options);
		}

		public static class FK
		{
			public class Document : AR.ARRegister.PK.ForeignKeyOf<ARTranPost>.By<docType, refNbr> { }
			public class Invoice : AR.ARInvoice.PK.ForeignKeyOf<ARTranPost>.By<docType, refNbr> { }
			public class Payment : AR.ARPayment.PK.ForeignKeyOf<ARTranPost>.By<docType, refNbr> { }
			public class CashSale : Standalone.ARCashSale.PK.ForeignKeyOf<ARTranPost>.By<docType, refNbr> { }
			public class SOInvoice : SO.SOInvoice.PK.ForeignKeyOf<ARTranPost>.By<docType, refNbr> { }

			public class Branch : GL.Branch.PK.ForeignKeyOf<ARTranPost>.By<branchID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARTranPost>.By<curyInfoID> { }
			public class Customer : AR.Customer.PK.ForeignKeyOf<ARTranPost>.By<customerID> { }

			public class Account : GL.Account.PK.ForeignKeyOf<ARTranPost>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<ARTranPost>.By<subID> { }
		}
		#endregion
		#region BranchID
		...
		public abstract class type : PX.Data.BQL.BqlString.Field<type>
		{
			...
			public class retainagePayment : PX.Data.BQL.BqlString.Constant<retainagePayment>
			{
				public retainagePayment() : base(RetainagePayment) { }
			}
			...
			public class prepaymentInvoice : PX.Data.BQL.BqlString.Constant<prepaymentInvoice>
			{
			...
			public class ListAttribute : PXStringListAttribute
			{
				public ListAttribute()
					: base(new[] {Origin, Application, Adjustment, Retainage, RetainageReverse, Voided, Installment, RGOL, Rounding, PrepaymentInvoice},
						new[]
						{
							Messages.Origin, Messages.Application, Messages.Adjusted, Messages.Retainage, Messages.RetainageReverse, Messages.Voided,
							Messages.Installment, Messages.RGOL, Messages.Rounding, Messages.PrepaymentInv
						}
					)
				{
				}
		...
		[PXFormula(typeof(Switch<Case<
			Where<docType.IsIn<ARDocType.refund, ARDocType.voidRefund, ARDocType.invoice, ARDocType.debitMemo,
								ARDocType.finCharge, ARDocType.cashSale, ARDocType.smallCreditWO, ARDocType.prepaymentInvoice>>,
				short1>,
			shortMinus1>))]
		...
		[PXFormula(typeof(Switch<
			...
			Case<Where<type.IsEqual<type.retainage>
				...
				short1,
			Case<Where<type.IsEqual<type.prepaymentInvoice>
					.And<docType.IsEqual<ARDocType.prepaymentInvoice>>>,
				shortMinus1,
		...
		[PXFormula(typeof(Add<
			Switch<
				Case<Where<ARTranPost.type.IsEqual<ARTranPost.type.application>
						.And<isMigratedRecord.IsEqual<True>>>,
			...
			Switch<
				...
				Case<Where<ARTranPost.docType.IsIn<ARDocType.invoice, ARDocType.debitMemo, ARDocType.creditMemo, ARDocType.finCharge,
													ARDocType.cashSale, ARDocType.cashReturn, ARDocType.prepaymentInvoice>>,
					GLTran.tranClass.normal,
	...
	[PXHidden]
	[Serializable]
	public partial class ARTranPostAlias : ARTranPost
	{
		public class PK : PrimaryKeyOf<ARTranPostAlias>.By<docType, refNbr, lineNbr, iD>
		{
			public static ARTranPostAlias Find(PXGraph graph, string docType, string refNbr, int? lineNbr, int? id) => FindBy(graph, docType, refNbr, lineNbr, id);
		}
		public new abstract class iD : PX.Data.BQL.BqlInt.Field<iD> { }
		public new abstract class docType : PX.Data.BQL.BqlString.Field<docType> { }
		public new abstract class refNbr : PX.Data.BQL.BqlString.Field<refNbr> { }
		public new abstract class sourceDocType : PX.Data.BQL.BqlString.Field<sourceDocType> { }
		public new abstract class sourceRefNbr : PX.Data.BQL.BqlString.Field<sourceRefNbr> { }
		...
		public new abstract class curyAmt : PX.Data.BQL.BqlDecimal.Field<curyAmt> { }
		public new abstract class curyDiscAmt : PX.Data.BQL.BqlDecimal.Field<curyDiscAmt> { }
		public new abstract class curyWOAmt : PX.Data.BQL.BqlDecimal.Field<curyWOAmt> { }
	}
}
