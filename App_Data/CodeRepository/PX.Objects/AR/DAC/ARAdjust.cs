...
namespace PX.Objects.AR
{
	...
	/// <see cref="ARInvoice">invoice document</see> (such as when a payment
	...
	[PXDefault(typeof(ARPayment.adjCntr))]
		...
		#endregion
		#region CuryAdjgSignedAmt
		public abstract class curyAdjgSignedAmt : PX.Data.BQL.BqlDecimal.Field<curyAdjgSignedAmt>
		{
			public class DocTypesWithPositiveSign : IBqlConstants
			{
				public IEnumerable<object> GetValues(PXGraph graph)
					=> ARDocType.Values.Where(v => ARDocType.SignBalance(v) == 1m).ToArray();
			}
		...
		/// <summary>
		/// The signed foreign currency value of <see cref="CuryAdjgAmt"/> depending on <see cref="AdjdDocType"/>
		/// </summary>
		[PXDecimal]
		[PXDBCalced(typeof(Switch<
			Case<Where<adjdDocType, In3<curyAdjgSignedAmt.DocTypesWithPositiveSign>>, curyAdjgAmt,
			Case<Where<adjdDocType, In3<curyAdjgSignedAmt.DocTypesWithNegativeSign>>, Minus<curyAdjgAmt>>>,
			decimal0>), typeof(decimal))]
		public virtual Decimal? CuryAdjgSignedAmt
		{
			get;
			set;
		}
		...
		#endregion
		#region AdjSignedAmt
		public abstract class adjSignedAmt : PX.Data.BQL.BqlDecimal.Field<adjSignedAmt> { }
		/// <summary>
		/// The signed base currency value of <see cref="AdjAmt"/> depending on <see cref="AdjdDocType"/>
		/// </summary>
		[PXDecimal]
		[PXDBCalced(typeof(Switch<
			Case<Where<adjdDocType, In3<curyAdjgSignedAmt.DocTypesWithPositiveSign>>, adjAmt,
			Case<Where<adjdDocType, In3<curyAdjgSignedAmt.DocTypesWithNegativeSign>>, Minus<adjAmt>>>,
			decimal0>), typeof(decimal))]
		public virtual Decimal? AdjSignedAmt
		{
			get;
			set;
		}
		...
		/// <summary>
		/// The reference number of the credit memo, which is generated on the Generate VAT Credit Memos (AR504500) form.
		/// </summary>
		/// <value>
		...
		/// to close the document, you need to apply the cash discount by generating a credit memo on the Generate VAT Credit Memos (AR504500) form.
		/// </summary>
		[PXDBBool]
		[PXDefault(false)]
		...
		#endregion
		#region Recalculatable
		/// <inheritdoc cref="Recalculatable"/>
		public abstract class recalculatable : Data.BQL.BqlBool.Field<recalculatable> { }
		/// <summary>
		...
		[PXDBBool()]
		[PXDefault(false)]
		public virtual bool? Recalculatable
		{
			get;
			set;
		}
	...
	public partial class ARAdjust2 : PX.Objects.AR.ARAdjust, ICreatePaymentAdjust
	{
		...
		{
			public static ARAdjust2 Find(PXGraph graph, String adjgDocType, String adjgRefNbr, Int32? adjNbr, String adjdDocType, String adjdRefNbr, Int32? adjdLineNbr, PKFindOptions options = PKFindOptions.None)
		...
		#endregion
		#region AdjSignedAmt
		public new abstract class adjSignedAmt : PX.Data.BQL.BqlDecimal.Field<adjSignedAmt> { }
		#endregion
		#region AdjWOAmt
		...
		#endregion
		#region CuryAdjgSignedAmt
		public new abstract class curyAdjgSignedAmt : PX.Data.BQL.BqlDecimal.Field<curyAdjgSignedAmt> { }
		#endregion
		#region RGOLAmt
		...
		#endregion
		#region Recalculatable
		public new abstract class recalculatable : Data.BQL.BqlBool.Field<recalculatable> { }
		#endregion
	}
