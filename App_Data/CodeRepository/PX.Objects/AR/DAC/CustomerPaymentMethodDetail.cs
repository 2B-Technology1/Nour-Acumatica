...
namespace PX.Objects.AR
{
	...
	/// <summary>
	/// A payment method setting for a <see cref="CustomerPaymentMethod">
	...
	public partial class CustomerPaymentMethodDetail : PX.Data.IBqlTable,ICCPaymentProfileDetail
	{
		...
		{
			public static CustomerPaymentMethodDetail Find(PXGraph graph, Int32? pMInstanceID, String paymentMethodID, String detailID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, pMInstanceID, paymentMethodID, detailID, options);
		}
