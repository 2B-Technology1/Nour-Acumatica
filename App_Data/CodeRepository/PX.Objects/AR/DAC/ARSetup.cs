...
namespace PX.Objects.AR
{
	...
	public partial class ARSetup : PX.Data.IBqlTable
	{
		...
		#endregion
		#region PrepareDunningLetters
		public abstract class prepareDunningLetters : PX.Data.BQL.BqlShort.Field<prepareDunningLetters> {
			public class ListAttribute : prepareStatements.ListAttribute { }
		...
		[PXDBString(1, IsFixed = true)]
		[PXDefault(prepareDunningLetters.ConsolidatedForCompany)]
		[PXUIField(DisplayName = "Prepare Dunning Letters")]
		[prepareDunningLetters.List]
		...
		public virtual bool? AddOpenPaymentsAndCreditMemos
		{
			get
			{
				return this._AddOpenPaymentsAndCreditMemos;
			}
			set
			{
				this._AddOpenPaymentsAndCreditMemos = value;
			}
		}
		#endregion
		...
		/// <summary>
		/// A Boolean value that indicates (if it is <see langword="true"/>) that the credit memo generated on the Generate VAT Credit Memos (AR504500) form will be released automatically.
		/// </summary>
		[PXDBBool()]
		[PXDefault(false)]
		...
		/// <summary>
		/// The description of the credit memo generated on the Generate VAT Credit Memos (AR504500) form.
		/// </summary>
