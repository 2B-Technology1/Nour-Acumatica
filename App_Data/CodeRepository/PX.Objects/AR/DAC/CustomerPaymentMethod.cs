...
{
	/// <summary>
	/// The customer-specific settings of a <see cref="PaymentMethod">
	...
	public partial class CustomerPaymentMethod : PX.Data.IBqlTable, ICCPaymentProfile, INotable
	{
		#region Keys
		public class PK : PrimaryKeyOf<CustomerPaymentMethod>.By<pMInstanceID>
		{
			public static CustomerPaymentMethod Find(PXGraph graph, int? pMInstanceID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, pMInstanceID, options);
		}
