...
namespace PX.Objects.AR
{
	...
	public partial class ARRegister : PX.Data.IBqlTable, IRegister, IAssign, IBalance, IDocumentKey, INotable
	{
		#region Events
		...
		/// should be posted when the feature <see cref="FeaturesSet.VATRecognitionOnPrepayments"/> is activated.
		/// The Cash account and Year-to-Date Net Income account cannot be selected as the value of this field.
		/// </summary>
		/// <value>
		/// Corresponds to the <see cref="Account.AccountID"/> field.
		...
		#endregion
		#region CuryDocUnpaidBal
		public abstract class curyDocUnpaidBal : PX.Data.BQL.BqlDecimal.Field<curyDocUnpaidBal> { }

		/// <summary>
		/// The database unbound field which indicates an unpaid balance of the prepayment invoice document.
		/// This field mirrors the <see cref="ARRegister.CuryDocBal"></see> field.
		/// The field value is calculated in the <see cref="CuryID">currency of the document</see>.
		/// </summary>
		[PXFormula(typeof(ARRegister.curyDocBal))]
		[PXCurrency(typeof(ARRegister.curyInfoID), typeof(ARRegister.docBal), BaseCalc = false)]
		[PXUIField(DisplayName = "Unpaid Balance", Visibility = PXUIVisibility.SelectorVisible)]
		public virtual decimal? CuryDocUnpaidBal
		{
			get;
			set;
		}
