...
namespace PX.Objects.AR
{
	...
	public class ARTranApplications : IBqlTable
	{
		...
		{
			public static ARTranApplications Find(PXGraph graph, string tranType, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) =>
	...
	public class ARTranApplicationsTotal : IBqlTable
	{
		...
		{
			public static ARTranApplicationsTotal Find(PXGraph graph, string tranType, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) =>
				FindBy(graph, tranType, refNbr, lineNbr, options);
		}
		#endregion
