...
namespace PX.Objects.AR
{
	...
	public class CuryARHistoryYtdGrouped : IBqlTable
	{
		...
		{
			public static CuryARHistoryYtdGrouped Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? customerID, String curyID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, customerID, curyID, finPeriodID, options);
		}
		#endregion
	...
	public class CuryARHistoryYtd : CuryARHistory
	{
		...
		{
			public static CuryARHistoryYtd Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? customerID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, customerID, finPeriodID, options);
		}
		#endregion
