...
namespace PX.Objects.AR
{
	...
	public class ARHistoryFinGrouped : IBqlTable
	{
		...
		{
			public static ARHistoryFinGrouped Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? customerID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, customerID, finPeriodID, options);
		}
		#endregion
	...
	public class ARHistoryTranGrouped : IBqlTable
	{
		...
		{
			public static ARHistoryTranGrouped Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? customerID, String finPeriodID, PKFindOptions options = PKFindOptions.None) 
				=> FindBy(graph, branchID, accountID, subID, customerID, finPeriodID, options);
		}
		#endregion
