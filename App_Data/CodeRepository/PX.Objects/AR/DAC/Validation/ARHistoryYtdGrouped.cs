...
namespace PX.Objects.AR
{
	...
	public class ARHistoryYtdGrouped : IBqlTable
	{
		...
		{
			public static ARHistoryYtdGrouped Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? customerID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, customerID, finPeriodID, options);
		}
		#endregion
	...
	public class ARHistoryYtd : ARHistory
	{
		...
		{
			public static ARHistoryYtd Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? customerID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, customerID, finPeriodID, options);
		}
		#endregion
