...
namespace PX.Objects.AR
{
	...
	public class ARRegisterTranPostGL : IBqlTable
	{
		...
		{
			public static ARRegisterTranPostGL Find(PXGraph graph, string docType, string refNbr, PKFindOptions options = PKFindOptions.None) =>
		...
		#region CalcCuryRetainageUnpaidTotal
		public abstract class calcCuryRetainageUnpaidTotal : PX.Data.BQL.BqlDecimal.Field<calcCuryRetainageUnpaidTotal> { }

		[PXDecimal]
		[PXDBCalced(typeof(ARTranPostGL.curyRetainageReleasedAmt.Add<ARTranPostGL.curyRetainageUnreleasedAmt>.Subtract<ARTranPostGL.curyRetainagePaidTotal>), typeof(decimal))]
		public virtual decimal? CalcCuryRetainageUnpaidTotal { get; set; }
		#endregion

		#region CalcRetainageUnpaidTotal
		public abstract class calcRetainageUnpaidTotal : PX.Data.BQL.BqlDecimal.Field<calcRetainageUnpaidTotal> { }

		[PXDecimal]
		[PXDBCalced(typeof(ARTranPostGL.retainageReleasedAmt.Add<ARTranPostGL.retainageUnreleasedAmt>.Subtract<ARTranPostGL.retainagePaidTotal>), typeof(decimal))]
	...
	[PXProjection(typeof(Select4<
		...
		Aggregate<
			...
			Sum<ARRegisterTranPostGL.calcCuryRetainageUnpaidTotal,
			Sum<ARRegisterTranPostGL.calcRetainageUnpaidTotal
		>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>), Persistent = false)]
	[PXHidden]
	public class ARRegisterTranPostGLGrouped : IBqlTable
	{
		...
		{
			public static ARRegisterTranPostGLGrouped Find(PXGraph graph, string docType, string refNbr, PKFindOptions options = PKFindOptions.None) =>
				FindBy(graph, docType, refNbr, options);
		}
		#endregion
