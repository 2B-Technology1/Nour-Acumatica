...
namespace PX.Objects.AR
{
	...
	public class CuryARHistoryFinGrouped : IBqlTable
	{
		...
		{
			public static CuryARHistoryFinGrouped Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, string curyID, Int32? customerID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, curyID, customerID, finPeriodID, options);
		}
		#endregion
	...
	public class CuryARHistoryTranGrouped : IBqlTable
	{
		...
		{
			public static CuryARHistoryTranGrouped Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, string curyID, Int32? customerID, String finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, branchID, accountID, subID, curyID, customerID, finPeriodID, options);
		}
		#endregion
