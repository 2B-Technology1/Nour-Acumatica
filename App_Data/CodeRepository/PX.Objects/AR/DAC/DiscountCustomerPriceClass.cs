...
namespace PX.Objects.AR
{
	...
	public partial class DiscountCustomerPriceClass : PX.Data.IBqlTable
	{
		...
		{
			public static DiscountCustomerPriceClass Find(PXGraph graph, string discountID, string discountSequenceID, string customerPriceClassID, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, discountID, discountSequenceID, customerPriceClassID, options);
		}
