...
namespace PX.Objects.AR
{
    ...
    public partial class ARInvoiceDiscountDetail : PX.Data.IBqlTable, IDiscountDetail
    {
      ...
      {
         public static ARInvoiceDiscountDetail Find(PXGraph graph, string docType, string refNbr, Int32? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, recordID, options);
      }
