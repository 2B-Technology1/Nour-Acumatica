...
namespace PX.Objects.AR
{
	...
	public partial class ARInvoice : ARRegister, CM.IInvoice, ICreatePaymentDocument
	{
		...
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBCalced(typeof(Add<ARInvoice.curyGoodsExtPriceTotal, ARInvoice.curyMiscExtPriceTotal>), typeof(Decimal))]
		[PXFormula(typeof(Add<ARInvoice.curyGoodsExtPriceTotal, ARInvoice.curyMiscExtPriceTotal>))]
		...
		/// </summary>
		[PXDecimal(4)]
		[PXDBCalced(typeof(Add<ARInvoice.goodsExtPriceTotal, ARInvoice.miscExtPriceTotal>), typeof(Decimal))]
