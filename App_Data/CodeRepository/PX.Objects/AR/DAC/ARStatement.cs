...
namespace PX.Objects.AR
{
	...
	/// for all <see cref="ARStatementDetail">document details</see>/> that are displayed in the statement.
	/// </summary>
	[Serializable]
	...
	public partial class ARStatement : PX.Data.IBqlTable
	{
		...
		{
			public static ARStatement Find(PXGraph graph, Int32? branchID, Int32? customerID, String curyID, DateTime? statementDate, PKFindOptions options = PKFindOptions.None)
													=> FindBy(graph, branchID, customerID, curyID, statementDate, options);
		}
