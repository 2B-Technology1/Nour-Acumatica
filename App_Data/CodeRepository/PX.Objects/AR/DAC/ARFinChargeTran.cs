...
namespace PX.Objects.AR
{
	...
	public partial class ARFinChargeTran : PX.Data.IBqlTable
	{
		...
		{
			public static ARFinChargeTran Find(PXGraph graph, String tranType, String refNbr, Int32? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranType, refNbr, lineNbr, options);
		}
		#endregion
