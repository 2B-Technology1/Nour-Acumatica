...
namespace PX.Objects.AR
{
    ...
    public class ARTranPostGL : IBqlTable
    {
        ...
        {
            public static ARTranPostGL Find(PXGraph graph, string docType, string refNbr, int? lineNbr, int? id, PKFindOptions options = PKFindOptions.None) =>
                FindBy(graph, docType, refNbr, lineNbr, id, options);
        }
        ...
        [PXDBCalced(typeof(
            Switch<
                Case<Where<ARTranPost.type.IsIn<ARTranPost.type.origin, ARTranPost.type.adjustment, ARTranPost.type.@void, ARTranPost.type.installment, ARTranPost.type.prepaymentInvoice>>,
		...
		[PXCurrency(typeof(curyInfoID), typeof(retainagePaidTotal), BaseCalc = false)]
		[PXDBCalced(typeof(IIf<ARTranPost.type.IsEqual<ARTranPost.type.retainagePayment>,
			ARTranPost.glSign.Multiply<ARTranPost.balanceSign>.Multiply<ARTranPost.curyAmt.Add<ARTranPost.curyDiscAmt.Add<ARTranPost.curyWOAmt>>>,
			Zero>), typeof(decimal))]
		...
		[PXBaseCury]
		[PXDBCalced(typeof(IIf<ARTranPost.type.IsEqual<ARTranPost.type.retainagePayment>,
			ARTranPost.glSign.Multiply<ARTranPost.balanceSign>.Multiply<ARTranPost.amt.Add<ARTranPost.discAmt.Add<ARTranPost.wOAmt>>>,
			Zero>), typeof(decimal))]
