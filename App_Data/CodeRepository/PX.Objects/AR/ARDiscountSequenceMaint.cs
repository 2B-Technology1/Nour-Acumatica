	...
	public class ARDiscountSequenceMaint : PXGraph<ARDiscountSequenceMaint>
	{
		...
		public class DiscountValidation : PXGraphExtension<ARDiscountSequenceMaint>
		{
			...
			public PXSelectBase<DiscountSequence> ApplyCustomer(PXSelectBase<DiscountSequence> cmd)
			{
				...
				cmd.WhereAnd<Where<DiscountCustomer.customerID, In2<Search<DiscountCustomer.customerID, Where<DiscountCustomer.FK.DiscountSequence.SameAsCurrent>>>>>();
				return cmd;
			}
			...
			public PXSelectBase<DiscountSequence> ApplyInventory(PXSelectBase<DiscountSequence> cmd)
			{
				...
				cmd.WhereAnd<Where<DiscountItem.inventoryID, In2<Search<DiscountItem.inventoryID, Where<DiscountItem.FK.DiscountSequence.SameAsCurrent>>>>>();
				return cmd;
			}
			...
			public PXSelectBase<DiscountSequence> ApplyBranch(PXSelectBase<DiscountSequence> cmd)
			{
				...
				cmd.WhereAnd<Where<DiscountBranch.branchID, In2<Search<DiscountBranch.branchID, Where<DiscountBranch.FK.DiscountSequence.SameAsCurrent>>>>>();
				return cmd;
			}
			...
			public PXSelectBase<DiscountSequence> ApplyWarehouse(PXSelectBase<DiscountSequence> cmd)
			{
				...
				cmd.WhereAnd<Where<DiscountSite.siteID, In2<Search<DiscountSite.siteID, Where<DiscountSite.FK.DiscountSequence.SameAsCurrent>>>>>();
				return cmd;
			}
			...
			public PXSelectBase<DiscountSequence> ApplyCustomerPriceClass(PXSelectBase<DiscountSequence> cmd)
			{
				...
				cmd.WhereAnd<Where<DiscountCustomerPriceClass.customerPriceClassID, In2<Search<DiscountCustomerPriceClass.customerPriceClassID, Where<DiscountCustomerPriceClass.FK.DiscountSequence.SameAsCurrent>>>>>();
				return cmd;
			}
			...
			public PXSelectBase<DiscountSequence> ApplyInventoryPriceClass(PXSelectBase<DiscountSequence> cmd)
			{
				...
				cmd.WhereAnd<Where<DiscountInventoryPriceClass.inventoryPriceClassID, In2<Search<DiscountInventoryPriceClass.inventoryPriceClassID, Where<DiscountInventoryPriceClass.FK.DiscountSequence.SameAsCurrent>>>>>();
				return cmd;
			}
