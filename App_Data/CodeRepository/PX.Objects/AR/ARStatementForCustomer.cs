...
namespace PX.Objects.AR
{
    ...
    public class ARStatementForCustomer : PXGraph<ARStatementForCustomer>
    {
		...
		[PXFilterable]
		public PXSelectOrderBy<DetailsResult, OrderBy<Asc<DetailsResult.statementDate>>> Details;
        ...
        protected virtual IEnumerable details()
        {
			...
			if (customer != null)
            {
				...
				PXSelectBase<ARStatement> sel = new PXSelectJoin<ARStatement,
					...
					OrderBy<Asc<ARStatement.statementCycleId, Asc<ARStatement.statementDate, Asc<ARStatement.curyID, Asc<ARStatement.branchID, Asc<ARStatement.customerID>>>>>>>(this);
