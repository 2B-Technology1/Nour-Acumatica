		...
		private class V2HostedFormProcessor : V2ProcessorBase, IHostedFromProcessingWrapper, IHostedPaymentFormProcessingWrapper
		{
			...
			public void PrepareProfileForm()
			{
				...
				var formPrepareOptions = new V2.ProfileFormPrepareOptions
				{
					...
					MeansOfPayment = _provider.GetPaymentMethodDataReader().GetPaymentMethod()?.PaymentType == CA.PaymentMethodType.EFT ? V2.MeansOfPayment.EFT : V2.MeansOfPayment.CreditCard
				};
