...
namespace PX.Objects.RQ
{
	...
	public class RQRequisitionContent : IBqlTable
	{
		#region Keys
		public class PK : PrimaryKeyOf<RQRequisitionContent>.By<reqNbr, reqLineNbr, orderNbr, lineNbr>
		{
			public static RQRequisitionContent Find(PXGraph graph, string reqNbr, int? reqLineNbr, string orderNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, reqNbr, reqLineNbr, orderNbr, lineNbr, options);
		}
