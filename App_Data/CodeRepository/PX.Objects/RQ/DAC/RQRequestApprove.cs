...
namespace PX.Objects.RQ
{
	...
	public partial class RQRequestApprove : PX.Data.IBqlTable
	{
		...
		{
			public static RQRequestApprove Find(PXGraph graph, string orderNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderNbr, lineNbr, options);
		}
