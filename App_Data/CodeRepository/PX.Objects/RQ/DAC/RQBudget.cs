...
namespace PX.Objects.RQ
{
	...
	public partial class RQRequestLineBudget : RQRequestLine
	{
		...
		{
			public static RQRequestLineBudget Find(PXGraph graph, string orderNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderNbr, lineNbr, options);
		}
