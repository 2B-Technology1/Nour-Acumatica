...
namespace PX.Objects.RQ
{
	...
	public partial class RQRequisition : PX.Data.IBqlTable, PX.Data.EP.IAssign, INotable
	{
		#region Keys
		public class PK : PrimaryKeyOf<RQRequisition>.By<reqNbr>
		{
			public static RQRequisition Find(PXGraph graph, string reqNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, reqNbr, options);
		}
