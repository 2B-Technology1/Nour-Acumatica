...
namespace PX.Objects.RQ
{
	...
	public partial class RQRequestClassItem : PX.Data.IBqlTable
	{
		...
		{
			public static RQRequestClassItem Find(PXGraph graph, string reqClassID, int? lineID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, reqClassID, lineID, options);
		}
	...
	public partial class RQInventoryItem : IBqlTable
	{
		...
		{
			public static RQInventoryItem Find(PXGraph graph, int? inventoryID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, inventoryID, options);
		}
		#endregion
