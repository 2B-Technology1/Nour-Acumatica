...
namespace PX.Objects.RQ
{
	...
	public partial class RQRequest : PX.Data.IBqlTable, PX.Data.EP.IAssign, INotable
	{
		#region Keys
		public class PK : PrimaryKeyOf<RQRequest>.By<orderNbr>
		{
			public static RQRequest Find(PXGraph graph, string orderNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, orderNbr, options);
		}
