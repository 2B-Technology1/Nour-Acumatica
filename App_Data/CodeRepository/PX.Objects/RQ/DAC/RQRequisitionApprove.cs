...
namespace PX.Objects.RQ
{
	...
	public partial class RQRequisitionApprove : PX.Data.IBqlTable
	{
		...
		{
			public static RQRequisitionApprove Find(PXGraph graph, string reqNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, reqNbr, lineNbr, options);
		}
		#endregion
