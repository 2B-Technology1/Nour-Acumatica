...
namespace PX.Objects.CM
{
	...
	public partial class TranslationHistoryDetails : IBqlTable, GL.DAC.Abstract.IAccountable
	{
		...
		{
			public static TranslationHistoryDetails Find(PXGraph graph, String referenceNbr, int? branchID, int? accountID, int? subID, String lineType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, referenceNbr, branchID, accountID, subID, lineType, options);
		}
