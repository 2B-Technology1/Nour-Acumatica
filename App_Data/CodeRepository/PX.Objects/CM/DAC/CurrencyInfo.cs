...
namespace PX.Objects.CM
{
	...
	public partial class CurrencyInfo : PX.Data.IBqlTable
	{
		...
		{
			public static CurrencyInfo Find(PXGraph graph, Int64? curyInfoID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, curyInfoID, options);
		}
		...
		{
			return PXSetup<CMSetup>.Select(cache.Graph);
		}
        ...
        /// </value>
        [PXShort]
		  [CurrencyPrecision(curyPrecision.Default, typeof(CurrencyInfo.curyID), PersistingCheck = PXPersistingCheck.Nothing)]
        public virtual short? CuryPrecision
        {
	        get { return _CuryPrecision; }
	        set { _CuryPrecision = value; }
        }
		#endregion
        ...
        /// </value>
        [PXShort]
        [CurrencyPrecision((short)2, typeof(CurrencyInfo.baseCuryID), PersistingCheck = PXPersistingCheck.Nothing)]
        public virtual short? BasePrecision
        {
	        get { return _BasePrecision; }
	        set { _BasePrecision = value; }
        }
		#endregion
		#region tstamp
