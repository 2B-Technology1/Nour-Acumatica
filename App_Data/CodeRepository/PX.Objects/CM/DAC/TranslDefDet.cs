...
namespace PX.Objects.CM
{
	...
	public partial class TranslDefDet : PX.Data.IBqlTable
	{
		...
		{
			public static TranslDefDet Find(PXGraph graph, String translDefId, Int32? lineNbr, Int32? accountIdFrom, PKFindOptions options = PKFindOptions.None) => FindBy(graph, translDefId, lineNbr, accountIdFrom, options);
		}
