...
namespace PX.Objects.CM
{
	...
	public partial class CurrencyRateByDate2 : CurrencyRate
	{
		...
		{
			public static CurrencyRateByDate2 Find(PXGraph graph, Int64? curyRateID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, curyRateID, options);
		}
	...
	public partial class CurrencyRate2 : CurrencyRate
	{
		...
		{
			public static CurrencyRate2 Find(PXGraph graph, Int64? curyRateID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, curyRateID, options);
		}
		public new static class FK
		{
	...
	public partial class CurrencyRateByDateForVendor : CurrencyRate
	{
		...
		{
			public static CurrencyRateByDateForVendor Find(PXGraph graph, Int64? curyRateID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, curyRateID, options);
		}
		public new static class FK
		{
	...
	public partial class CurrencyRateByDate : CurrencyRate
	{
		...
		{
			public static CurrencyRateByDate Find(PXGraph graph, Int64? curyRateID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, curyRateID, options);
		}
		public new static class FK
		{
	...
	public partial class CurrencyRate : PX.Data.IBqlTable
	{
		...
		{
			public static CurrencyRate Find(PXGraph graph, Int64? curyRateID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, curyRateID, options);
		}
		...
		/// <summary>
		/// Indicates weather the record is currently selected.
		/// </summary>
		[PXBool]
