...
namespace PX.Objects.CA
{
	...
	public class CashFlowEnq : PXGraph<CashFlowEnq>
	{
		...
		public partial class CashFlowFilter : PX.Data.IBqlTable
		{
			...
			[CashAccount(typeof(Search<CashAccount.cashAccountID, Where<CashAccount.branchID, InsideBranchesOf<Current<orgBAccountID>>>, OrderBy<Asc<CashAccount.cashAccountCD>>>))]
			[PXDefault(typeof(Search<CashAccount.cashAccountID, Where<CashAccount.branchID, InsideBranchesOf<Current<orgBAccountID>>>, OrderBy<Asc<CashAccount.cashAccountCD>>>))]
		...
		protected virtual void CashFlowFilter_OrgBAccountID_FieldUpdated(PXCache sender, PXFieldUpdatedEventArgs e)
		{
			sender.SetDefaultExt<CashFlowFilter.cashAccountID>(e.Row);
		}
