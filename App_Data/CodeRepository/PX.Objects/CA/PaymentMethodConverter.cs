...
namespace PX.Objects.CA
{
	public class PaymentMethodConverter : PXGraph<PaymentMethodConverter>
	{
		...
		{
			foreach (PXResult<CustomerPaymentMethod, Customer,CustomerPaymentMethodDetail> items in CustomerPaymentMethodListView.Select())
			{
		...
		public PXSelectJoinGroupBy<CustomerPaymentMethod,
				...
				Aggregate<GroupBy<CustomerPaymentMethod.pMInstanceID>>> CustomerPaymentMethodListView;
