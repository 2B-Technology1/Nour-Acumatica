...
namespace PX.Objects.CA
{
	...
	public abstract class CashTranIDAttribute : PXEventSubscriberAttribute, IPXRowPersistingSubscriber, IPXRowPersistedSubscriber, IPXRowDeletedSubscriber
	{
		...
		public virtual void RowPersisting(PXCache sender, PXRowPersistingEventArgs e)
		{
			...
			{
				PXCache<CATran>.StoreOriginal(sender.Graph, info);
		...
		protected virtual void SetOriginalTransactionVoided(PXCache sender, long? tranID, CATran voidingTran)
		{
			...
			PXCache cache = sender.Graph.Caches[typeof(CATran)];
			CATran transaction = PXSelect<CATran, Where<CATran.tranID, Equal<Required<CATran.tranID>>>>.Select(sender.Graph, tranID);
			transaction.Voided = true;
			cache.Update(transaction);
			cache.PersistUpdated(transaction);
		}
