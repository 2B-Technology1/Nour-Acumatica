...
namespace PX.Objects.CA
{
	...
	public class CCBatchTransaction : IBqlTable
	{
		...
		{
			public static CCBatchTransaction Find(PXGraph graph, int? batchID, string pCTranNumber, PKFindOptions options = PKFindOptions.None) => FindBy(graph, batchID, pCTranNumber, options);
		}
