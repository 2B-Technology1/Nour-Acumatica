...
namespace PX.Objects.CA
{
	...
	public class CABankTaxTranMatch : TaxDetail, IBqlTable
	{
		...
		{
			public static CABankTaxTran Find(PXGraph graph, string module, DateTime? tranDate, int? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, module, tranDate, recordID, options);
		}
