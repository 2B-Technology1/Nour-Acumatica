...
namespace PX.Objects.CA
{
	...
	public partial class CASplit : IBqlTable, CM.IDocumentTran, ICATranDetail
	{
		...
		{
			public static CASplit Find(PXGraph graph, string adjTranType, string adjRefNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, adjTranType, adjRefNbr, lineNbr, options);
		}
		...
		public static class FK
		{
			...
			public class Task : PMTask.PK.ForeignKeyOf<CASplit>.By<projectID, taskID> { }
