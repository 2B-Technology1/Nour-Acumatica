...
namespace PX.Objects.CA
{
	...
	/// (which corresponds to the <see cref="CASetupMaint"/> graph).
    /// </summary>
    [Serializable]
    ...
    public partial class CASetup : IBqlTable
	{
		...
		[PXForeignReference(typeof(FK.CashInTransitAccount))]
		...
		[PXForeignReference(typeof(FK.CashInTransitSubaccount))]
