...
namespace PX.Objects.CA
{
	...
	public partial class CADepositDetail : IBqlTable
	{
		...
		{
			public static CADepositDetail Find(PXGraph graph, string tranType, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranType, refNbr, lineNbr, options);
		}
		...
		public static class FK
		{
			...
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CADepositDetail>.By<cashAccountID> { }
			...
			public class CashAccountTransaction : CA.CATran.PK.ForeignKeyOf<CADepositDetail>.By<cashAccountID, tranID> { }
