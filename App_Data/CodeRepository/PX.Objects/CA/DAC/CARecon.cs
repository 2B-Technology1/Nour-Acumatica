...
namespace PX.Objects.CA
{
	...
	public partial class CARecon : IBqlTable
	{
		...
		{
			public static CARecon Find(PXGraph graph, int? cashAccountID, string reconNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, cashAccountID, reconNbr, options);
		}
		...
		#endregion
		#region IsUserLoadDocumentsTill
		public abstract class isUserLoadDocumentsTill : PX.Data.BQL.BqlBool.Field<isUserLoadDocumentsTill> { }
		/// <summary>
		/// The field indicates if user set LoadDocumentsTill, or was it set by <see cref="CAOptimizeLoadDateAttribute"/>.
		/// </summary>
		[PXBool]
		[PXFormula(typeof(False))]
		public virtual bool? IsUserLoadDocumentsTill
		{
			get;
			set;
		}
