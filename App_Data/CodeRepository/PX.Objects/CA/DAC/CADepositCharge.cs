...
namespace PX.Objects.CA
{
	...
	/// (which corresponds to the <see cref="CADepositEntry"/> graph)
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CADepositCharge>.By<tranType, refNbr, lineNbr>
		{
			public static CADepositCharge Find(PXGraph graph, string tranType, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None)
        ...
        /// </value>
		[Descriptor.PXDBDepositCharge(10, IsUnicode = true)]
		[PXDefault]
		...
		[PXSelector(typeof(Search2<CAEntryType.entryTypeId, InnerJoin<CashAccountETDetail,
								...
								And<CashAccountETDetail.cashAccountID, Equal<Current<CADeposit.cashAccountID>>>>>,
        ...
        [PXSelectorAllowEmpty(typeof(SelectFrom<PaymentMethod>
	        .Where<PaymentMethod.isActive.IsEqual<True>>
	        .SearchFor<PaymentMethod.paymentMethodID>))]
