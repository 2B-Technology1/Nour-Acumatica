...
namespace PX.Objects.CA
{
	...
	public partial class CATaxTran : TaxTran
	{
		...
		{
			public static CATaxTran Find(PXGraph graph, DateTime? tranDate, Int32? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranDate, recordID, options);
		}
		...
		[PXDBDefault(typeof(CAAdj.tranDesc), PersistingCheck = PXPersistingCheck.Nothing)]
