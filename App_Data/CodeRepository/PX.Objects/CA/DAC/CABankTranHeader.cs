...
{
	/// <summary>
	/// A header of a bank statement by an account.
	/// </summary>
	[Serializable]
	...
	public partial class CABankTranHeader : IBqlTable
	{
		...
		{
			public static CABankTranHeader Find(PXGraph graph, int? cashAccountID, string refNbr, string tranType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, cashAccountID, refNbr, tranType, options);
		}
		...
		[CM.PXDBCury(typeof(CABankTranHeader.curyID))]
