...
namespace PX.Objects.CA
{
	...
	public partial class CABankTax : TaxDetail, IBqlTable 
	{
		...
		{
			public static CABankTax Find(PXGraph graph, int? tranID, int? lineNbr, string taxID, string tranType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranID, lineNbr, taxID, tranType, options);
		}
