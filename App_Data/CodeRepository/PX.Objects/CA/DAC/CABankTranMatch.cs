...
namespace PX.Objects.CA
{
	...
	public partial class CABankTranMatch : IBqlTable
	{
		...
		{
			public static CABankTranMatch Find(PXGraph graph, int? tranID, int? lineNbr, string matchType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranID, lineNbr, matchType, options);
		}
