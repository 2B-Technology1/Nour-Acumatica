...
namespace PX.Objects.CA
{
	...
	public partial class CATran : IBqlTable, GL.DAC.Abstract.IAccountable
	{
		...
		{
			public static CATran Find(PXGraph graph, int? cashAccountID, long? tranID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, cashAccountID, tranID, options);
		}
		public class UK : PrimaryKeyOf<CATran>.By<tranID>
		{
			public static CATran Find(PXGraph graph, long? tranID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranID, options);
		}
		...
		public abstract class origTranTypeUI : PX.Data.BQL.BqlString.Field<origTranTypeUI>
		{
		}
		[PXString]
		[PXDBCalced(typeof(
			Switch<Case<Where<CATran.origTranType, Equal<AP.APDocType.check>>,
					AR.ARDocType.payment,
				Case<Where<CATran.origTranType, Equal<AP.APDocType.voidCheck>>,
					AR.ARDocType.voidPayment>>,
				CATran.origTranType>), typeof(String))]
		[PXUIField(DisplayName = "Tran. Type")]
		[CAAPARTranType.ListByModuleUI(typeof(origModule))]
		public virtual string OrigTranTypeUI
		{
			get;
			set;
		}
		...
		public virtual string Status
		{
			...
			get
			{
				...
				else if (this.Voided == true && this.Posted != true)
				{
					return GL.BatchStatus.Voided;
				}
