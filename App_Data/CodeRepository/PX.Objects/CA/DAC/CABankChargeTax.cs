...
namespace PX.Objects.CA
{
	...
	public partial class CABankChargeTax : TaxDetail, IBqlTable
	{
		...
		{
			public static CABankChargeTax Find(PXGraph graph, int? tranID, int? lineNbr, string taxID, string tranType, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranID, lineNbr, taxID, tranType, options);
		}
