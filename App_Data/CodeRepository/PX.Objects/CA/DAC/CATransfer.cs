...
namespace PX.Objects.CA
{
	...
	/// (which corresponds to the <see cref="CashTransferEntry"/> graph).
    /// </summary>
	...
	public partial class CATransfer : PX.Data.IBqlTable, ICADocument
	{
		...
		{
			public static CATransfer Find(PXGraph graph, string transferNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, transferNbr, options);
		}
		...
		[Branch(typeof(Search<CashAccount.branchID, Where<CashAccount.cashAccountID, Equal<Current<inAccountID>>>>))]
		...
		[Branch(typeof(Search<CashAccount.branchID, Where<CashAccount.cashAccountID, Equal<Current<outAccountID>>>>))]
		...
		/// </summary>
		/// <value>
		/// This field is populated only by the <see cref="CashTransferEntry"/> graph, which corresponds to the Funds Transfers CA301000 form.
		/// </value>
		[PXInt]
