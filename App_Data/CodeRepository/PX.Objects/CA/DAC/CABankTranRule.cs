...
namespace PX.Objects.CA
{
    ...
    /// from <see cref="CABankTran">bank transactions</see> during
    ...
    public partial class CABankTranRule : IBqlTable
    {
        ...
        {
            public static CABankTranRule Find(PXGraph graph, int? ruleID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, ruleID, options);
        }
        ...
        #region CuryMinTranAmt
        public abstract class curyMinTranAmt : PX.Data.BQL.BqlDecimal.Field<curyMinTranAmt> { }
		...
		#region UsePayeeNameWildcards
		public abstract class usePayeeNameWildcards : PX.Data.BQL.BqlBool.Field<usePayeeNameWildcards>  { }

		/// <summary>
		/// When set to <c>true</c>, indicates that the system must treat '*' and '?' characters in the <see cref="PayeeName" />
		/// as wildcards ('*' matches 0 or more arbitrary symbols, '?' matches one arbitrary symbol).
		/// </summary>
		/// <value>
		/// Defaults to <c>false</c>.
		...
		[PXDefault(false)]
		[PXUIField(DisplayName = "Use Wildcards (*, ?)")]
		public virtual bool? UsePayeeNameWildcards
		{
			get;
			set;
		}
        ...
        [PXSelector(typeof(
			...
			And<CashAccountETDetail.cashAccountID, Equal<Current<CABankTranRule.bankTranCashAccountID>>>>>,
				Where<CAEntryType.module, Equal<Current<CABankTranRule.documentModule>>,
					...
					And<Where<CashAccountETDetail.cashAccountID, Equal<Current<CABankTranRule.bankTranCashAccountID>>, 
