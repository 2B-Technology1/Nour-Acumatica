...
namespace PX.Objects.CA
{
	...
	public partial class CADeposit : IBqlTable, ICADocument 
	{
		...
		{
			public static CADeposit Find(PXGraph graph, string tranType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, tranType, refNbr, options);
		}
		...
		public static class FK
		{
			...
			public class Owner : CR.Contact.PK.ForeignKeyOf<CADeposit>.By<ownerID> { }
		}
		...
		#endregion
		#region LineCntrCharge
		public abstract class lineCntrCharge : PX.Data.BQL.BqlInt.Field<lineCntrCharge> { }

		/// <summary>
		/// The counter of Charges detail lines.
		/// The field depends on <see cref="CADepositCharge.LineNbr"/>.
		/// </summary>
		[PXDBInt]
		[PXDefault(0)]
		public virtual int? LineCntrCharge
		{
			get;
			set;
		}
