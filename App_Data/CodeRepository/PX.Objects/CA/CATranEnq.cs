...
namespace PX.Objects.CA
{
	...
	public class CATranEnq : PXGraph<CATranEnq>
	{
		...
		public virtual IEnumerable cATranListRecords()
		{
			...
			decimal curBalance = filter?.BegBal ?? 0;
		...
		protected virtual void CAEnqFilter_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
		{
			...
			PXUIFieldAttribute.SetVisible<CATran.origTranTypeUI>(tranCache, null, ShowSummaryNotChecked);
		...
		[PXParent(typeof(SelectFrom<CAAdj>.Where<CAAdj.noteID.IsEqual<EPApproval.refNoteID.FromCurrent>>))]
		[PXMergeAttributes(Method = MergeMethod.Merge)]
		protected virtual void _(Events.CacheAttached<EPApproval.refNoteID> e) { }
	}
