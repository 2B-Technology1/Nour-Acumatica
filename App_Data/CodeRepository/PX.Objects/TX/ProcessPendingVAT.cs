...
namespace PX.Objects.TX
{
	...
	public class ProcessSVATBase : PXGraph<ProcessSVATBase>
	{
			...
			foreach (SVATConversionHistExt histSVAT in list)
			{
				...
				try
				{
					...
					using (PXTransactionScope ts = new PXTransactionScope())
					{
						...
						IEnumerable<PXResult<SVATTaxTran>> taxTranSelection = GetSVATTaxTrans(je, histSVAT, masterInvoiceNbr);
		...
		public static IEnumerable<PXResult<SVATTaxTran>> GetSVATTaxTrans(JournalEntry je, SVATConversionHistExt histSVAT, string masterInvoiceNbr)
		{
			return PXSelectJoin<SVATTaxTran,
	...
	public class SVATTaxReversalMethods
		...
		public class onPrepayment : PX.Data.BQL.BqlString.Constant<onPrepayment>
		{
			public onPrepayment() : base(OnPrepayment) { }
		}
	}
}
