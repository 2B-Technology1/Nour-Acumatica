...
namespace PX.Objects.TX
{
	...
	public static class Messages
	{
		...
		public const string NonImportAndImportCanNotExistTogether = "Direct-entry and non-direct-entry taxes cannot be included in the same tax category ({0}).";
		public const string SeveralImportTaxesCanNotBeInSameZoneAndCategory = "Multiple direct-entry taxes cannot be included in the same tax category ({0}) and tax zone ({1}).";
		public const string ImportTaxeAndNonImportTaxesCannotBeAppliedTogether = "The {0} direct-entry tax cannot be applied to the document line together with the {1} non-direct-entry tax.";
		public const string SeveralImportTaxesCanNotBeApplied = "The {0} tax category contains multiple direct-entry taxes that cannot be applied to the same document line.";
		...
		public const string GrossModeIsNotAvailableForReversedTax = "The Gross tax calculation mode cannot be used in a document where a reversed tax is specified.";
		...
		public const string ClearAddressMappingData = "Ship-to address mapping already exists for the current tax zone. Do you want to clear it and proceed?";
		public const string ToValueMustNotBeLess = "The value must not be less than {0}.";
		public const string CountryNotFound = "The '{0}' country cannot be found in the system.";
		public const string CountryIsAlreadyAssociated = "The {0} tax zone has already been associated with the {1} country.";
		public const string StateIsAlreadyAssociated = "The {0} tax zone has already been associated with the {1} state.";
		public const string PostalCodeIsAlreadyAssociated = "The {0} - {1} range of postal codes has already been associated with the {2} tax zone.";
		#endregion
		...
		public const string DirectTaxCanNotBeInsertedManually = "Direct-entry taxes cannot be inserted manually.";
		public const string DirectTaxCanNotBeDeletedManually = "Direct-entry taxes cannot be deleted manually. To delete a direct-entry tax, change the {0} tax category in the document line or delete the line.";
		#endregion
		...
		public const string TaxZoneAddressMapping = "Tax Zone Address Mapping";
		...
		public const string Taxable = "Taxable - Override Exemption";
		...
		#region Address Mapping Types
		public const string OneOrMoreCountires = "Countries";
		public const string OneOrMoreStates = "States";
		public const string OneOrMorePostalCodes = "Postal Codes";
		#endregion

		public const string APTaxCalcAsSales = "Sales Taxes";
		public const string APTaxCalcAsUse = "Use Taxes";
	}
}
