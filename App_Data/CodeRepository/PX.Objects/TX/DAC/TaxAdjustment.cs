...
namespace PX.Objects.TX
{
	...
	public partial class TaxAdjustment : PX.Data.IBqlTable
	{
		...
		{
			public static TaxAdjustment Find(PXGraph graph, string docType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, options);
		}
