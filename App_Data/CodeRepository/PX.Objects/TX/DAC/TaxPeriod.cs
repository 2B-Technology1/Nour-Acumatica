...
namespace PX.Objects.TX
{
	...
	public partial class TaxPeriod : PX.Data.IBqlTable
	{
		...
		{
			public static TaxPeriod Find(PXGraph graph, Int32? organizationID, Int32? vendorID, string finPeriodID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, organizationID, vendorID,finPeriodID, options);
		}
