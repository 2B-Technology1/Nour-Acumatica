...
namespace PX.Objects.TX
{
	...
	/// belong to the <see cref="TaxTran.TaxPeriodID">specified tax period</see>
	...
	public partial class TaxTran : TaxDetail, PX.Data.IBqlTable
	{
		...
		{
			public static TaxTran Find(PXGraph graph, String module, DateTime? tranDate, Int32? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, module, tranDate, recordID, options);
		}
		...
		#region CuryAdjustedTaxableAmt
		public abstract class curyAdjustedTaxableAmt : PX.Data.BQL.BqlDecimal.Field<curyAdjustedTaxableAmt> { }

		/// <summary>
		/// The Taxable Amount of the prepayment invoice document (PPI)reduced by a credit memo
		/// when the feature <see cref="FeaturesSet.VATRecognitionOnPrepayments"/> is activated.
		/// </summary>
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXDBCurrency(typeof(ARTaxTran.curyInfoID), typeof(ARTaxTran.adjustedTaxableAmt))]
		[PXUIField(DisplayName = "Adj. Taxable Amount", Visibility = PXUIVisibility.Visible)]
		public virtual decimal? CuryAdjustedTaxableAmt { get; set; }
		#endregion
		#region AdjustedTaxableAmt
		public abstract class adjustedTaxableAmt : PX.Data.BQL.BqlDecimal.Field<adjustedTaxableAmt> { }
		...
		#endregion
		#region CuryAdjustedTaxAmt
		public abstract class curyAdjustedTaxAmt : PX.Data.BQL.BqlDecimal.Field<curyAdjustedTaxAmt> { }

		/// <summary>
		/// The Tax Amount of the prepayment invoice document (PPI)reduced by a credit memo
		/// when the feature <see cref="FeaturesSet.VATRecognitionOnPrepayments"/> is activated.
		/// </summary>
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXDBCurrency(typeof(ARTaxTran.curyInfoID), typeof(ARTaxTran.adjustedTaxAmt))]
		[PXUIField(DisplayName = "Adj. Tax Amount", Visibility = PXUIVisibility.Visible)]
		public virtual decimal? CuryAdjustedTaxAmt { get; set; }
		#endregion
		#region AdjustedTaxAmt
		public abstract class adjustedTaxAmt : PX.Data.BQL.BqlDecimal.Field<adjustedTaxAmt> { }
