...
namespace PX.Objects.TX
{
	...
	public partial class TaxZone : PX.Data.IBqlTable
	{
		...
		{
			public static TaxZone Find(PXGraph graph, String taxZoneID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, taxZoneID, options);
		}
		...
		#endregion
		#region AddresMapingType
		public abstract class mappingType : PX.Data.BQL.BqlString.Field<mappingType> { }
		[PXDBString(1)]
		[PXDefault(MappingTypesAttribute.OneOrMoreCountires)]
		[MappingTypes]
		...
		#region ExternalTaxTypeAP
		public abstract class externalAPTaxType : PX.Data.BQL.BqlString.Field<externalAPTaxType> { }
		[PXDBString(1, IsFixed = true)]
		[PXDefault(ExternalAPTaxTypes.Use)]
		[ExternalAPTaxTypes]
		[PXUIField(DisplayName = "Calculate in AP", Visibility = PXUIVisibility.Visible)]
