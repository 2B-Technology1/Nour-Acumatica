...
namespace PX.Objects.TX
{
	...
	/// The line is mapped as many-to-many to <see cref="TaxBucket">reporting groups</see> and through them to taxes.
    /// </summary>
	...
	public partial class TaxReportLine : IBqlTable, ISortOrder
	{
		...
		{
			public static TaxReportLine Find(PXGraph graph, int? vendorID, int? taxReportRevisionID, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, vendorID, taxReportRevisionID, lineNbr, options);
		}
