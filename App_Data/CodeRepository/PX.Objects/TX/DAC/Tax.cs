...
namespace PX.Objects.TX
{
	...
	public partial class Tax : PX.Data.IBqlTable
	{
		...
		{
			public static Tax Find(PXGraph graph, string taxID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, taxID, options);
		}
		...
		[PXFormula(typeof(IsNull<TX.Tax.taxCalcType.FromCurrent.Concat<TX.Tax.taxCalcLevel.FromCurrent>, TX.Tax.taxCalcRule>))]
		...
		/// </summary>
		[Account(DisplayName = "Pending Tax Payable Account", DescriptionField = typeof(Account.description), ControlAccountForModule = ControlAccountModule.TX)]
		...
		/// </summary>
		[Account(DisplayName = "Pending Tax Claimable Account", DescriptionField = typeof(Account.description), ControlAccountForModule = ControlAccountModule.TX)]
