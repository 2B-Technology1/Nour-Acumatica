...
namespace PX.Objects.TX
{
	public class TaxHistorySumManager
	{
		...
		public static void UpdateTaxHistorySums(
			...
			int? organizationID,
			int? branchID,
			Func<PXResult<TaxReportLine, TaxBucketLine, CM.Extensions.Currency, TaxTranRevReport>, bool> ShowTaxReportLine = null)
		{
		...
		private class TaxBucketsCalculation
		{
			...
			public TaxBucketsCalculation(
				...
				Func<PXResult<TaxReportLine, TaxBucketLine, CM.Extensions.Currency, TaxTranRevReport>, bool> showTaxReportLine)
			{
				...
				aggregatesTable = TaxReportMaint.AnalyseBuckets(
					graph,
					curVendorBaccountID,
					roundingManager.CurrentTaxReportRevisionID,
					taxTypeForCalculation,
					CalcWithZones,
					showTaxReportLine);
