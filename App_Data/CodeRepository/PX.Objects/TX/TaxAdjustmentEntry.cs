...
namespace PX.Objects.TX
{
	public partial class TaxAdjustmentEntry : PXGraph<TaxAdjustmentEntry, TaxAdjustment>
	{
		...
		protected virtual void _(Events.CacheAttached<TaxTran.curyTaxAmt> e) { }
		...
		protected virtual void TaxAdjustment_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
		{
			...
			PXFieldState docDateState = cache.GetStateExt<TaxAdjustment.docDate>(doc) as PXFieldState;

			if (docDateState != null && docDateState.ErrorLevel != PXErrorLevel.Error)
			{
