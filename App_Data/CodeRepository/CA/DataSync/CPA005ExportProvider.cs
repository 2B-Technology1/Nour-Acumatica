...
namespace PX.Objects.Localizations.CA.DataSync
{
	public class CPA005ExportProvider : ACHProvider
    {
		...
		{
			return FormatFileCreationNumber(seqNbr, Messages.CPA005.FileCreationNumberInvalid);
		}

		protected virtual string FormatFileCreationNumber(string seqNbr, string errorMessage)
        {
			...
			else
			{
				...
				{
					throw new PXException(errorMessage, seqNbr);
				}
