...
{
	/// <summary>
	/// Stores the information about the export or printing of a payment batch. The information will be displayed on the Payment Batches (PR305000) form.
	/// </summary>
	[Serializable]
	...
	public class PRPaymentBatchExportDetails : IBqlTable
	{
		...
		{
			public static PRPaymentBatchExportDetails Find(PXGraph graph, string paymentBatchNbr, int exportHistoryLineNbr, int lineNbr, PKFindOptions options = PKFindOptions.None)
				=> FindBy(graph, paymentBatchNbr, exportHistoryLineNbr, lineNbr, options);
		}
