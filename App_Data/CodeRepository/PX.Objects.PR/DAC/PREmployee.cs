...
{
	/// <summary>
	/// Stores the payroll information related to the employee of the company. The information will be displayed on the Employee Payroll Settings (PR203000) form.
	/// </summary>
	...
	public class PREmployee : EPEmployee
	{
		...
		{
			public static PREmployee Find(PXGraph graph, string acctCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, acctCD, options);
		}
		...
		[PXDBBool]
		[PXDefault(true)]
		[PXUIField(DisplayName = "Use Class Default Work Locations")]
