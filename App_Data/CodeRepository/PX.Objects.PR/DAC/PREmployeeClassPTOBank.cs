...
{
	/// <summary>
	/// Stores the information related to the paid time off of a specific group of employees. The information will be displayed on the Employee Payroll Class (PR202000) form.
	/// </summary>
	[Serializable]
	...
	public class PREmployeeClassPTOBank : IBqlTable, IPTOBank
	{
		...
		{
			public static PREmployeeClassPTOBank Find(PXGraph graph, string employeeClassID, string bankID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, employeeClassID, bankID, options);
		}
