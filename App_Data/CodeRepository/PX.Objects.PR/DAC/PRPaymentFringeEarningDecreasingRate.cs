...
{
	/// <summary>
	/// Stores the information about the earning reducing the fringe rate for each project and labor item for a specific paycheck. The information will be displayed on the Paychecks and Adjustments (PR302000) form.
	/// </summary>
	...
	public class PRPaymentFringeEarningDecreasingRate : IBqlTable
	{
		...
		{
			public static PRPaymentFringeEarningDecreasingRate Find(PXGraph graph, int? recordID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, recordID, options);
		}
		...
		{
			public static PRPaymentFringeEarningDecreasingRate Find(PXGraph graph, string docType, string refNbr, string earningTypeCD, int? projectID, int? projectTaskID, int? laborItemID, PKFindOptions options = PKFindOptions.None) =>
				FindBy(graph, docType, refNbr, earningTypeCD, projectID, projectTaskID, laborItemID, options);
		}
		...
		public static class FK
		{
			...
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PRPaymentFringeEarningDecreasingRate>.By<projectID, projectTaskID> { }
