...
{
	/// <summary>
	/// A tax which increases the applicable wage for a certain deduction or benefit.
	/// </summary>
	...
	public class PRDeductCodeTaxIncreasingWage : IBqlTable
	{
		...
		{
			public static PRDeductCodeTaxIncreasingWage Find(PXGraph graph, int? deductCodeID, int? applicableTaxID, PKFindOptions options = PKFindOptions.None) =>
