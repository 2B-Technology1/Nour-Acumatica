...
{
	/// <summary>
	/// Stores the information about the first year the pay schedule was started. The information will be displayed on the Pay Groups (PR205000) form.
	/// </summary>
	[Serializable]
	...
	public partial class PRPayGroupYearSetup : IBqlTable, IYearSetup
	{
		...
		{
			public static PRPayGroupYearSetup Find(PXGraph graph, string payGroupID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, payGroupID, options);
		}
		...
		[PXDBInt()]
		[PXDefault(1)]
		[PXUIField(DisplayName = "Payment Released", Enabled = true)]
		[PXIntList(new int[] { -4, -3, -2, -1, 0, 1, 2, 3, 4 }, new string[] { "4 Weeks Before Period Start", "3 Weeks Before Period Start", "2 Weeks Before Period Start", "1 Week Before Period Start", "Same Week As Period Start", "1 Week After Period Start", "2 Weeks After Period Start", "3 Weeks After Period Start", "4 Weeks After Period Start" })]
