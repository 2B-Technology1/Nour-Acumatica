...
namespace PX.Objects.PR
{
	public class PREarningTypeMaint : EPEarningTypesSetup
	{
		...
		public SelectFrom<PRRegularTypeForOvertime>
			.InnerJoin<EPEarningType>
				.On<PRRegularTypeForOvertime.FK.RegularEarningType>
			.Where<PRRegularTypeForOvertime.overtimeTypeCD.IsEqual<EPEarningType.typeCD.FromCurrent>>.View PRRegularTypesForOvertime;
		...
		protected virtual void EPEarningType_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			bool requireRegularTypeCD = prRow.IsPTO == true;
		...
		protected virtual void _(Events.RowUpdated<EPEarningType> e)
		{
			if (e.OldRow?.IsOvertime == true && e.Row?.IsOvertime != true)
			{
				PRRegularTypesForOvertime.Select().FirstTableItems.ForEach(regularType => PRRegularTypesForOvertime.Delete(regularType));
			}
		}
		...
		{
			EPEarningType earningTypeWithCurrentRegularEarningType = SelectFrom<EPEarningType>
				.Where<EPEarningType.isActive.IsEqual<True>
					.And<PREarningType.regularTypeCD.IsEqual<P.AsString>>>
				.View.SelectSingleBound(this, null, typeCD);

			if (earningTypeWithCurrentRegularEarningType == null)
			{
				earningTypeWithCurrentRegularEarningType = SelectFrom<EPEarningType>
					.InnerJoin<PRRegularTypeForOvertime>
						.On<PRRegularTypeForOvertime.FK.OvertimeEarningType>
					.Where<EPEarningType.isActive.IsEqual<True>
						.And<PRRegularTypeForOvertime.regularTypeCD.IsEqual<P.AsString>>>
					.View.SelectSingleBound(this, null, typeCD);
			}
