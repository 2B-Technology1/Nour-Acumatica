...
namespace PX.Objects.PR
{
	public class PRPayPeriodMaint : PXGraph<PRPayPeriodMaint, PRPayGroupYear>
	{
		...
		public SelectFrom<PRTransactionDateException>
			.Where<PRTransactionDateException.date.IsEqual<P.AsDateTime.UTC>>.View ExceptionDates;
		#endregion
	...
	public class PRPayPeriodCreationDialog : IBqlTable
	{
		...
		[PXUIField(DisplayName = "Automatically Change Transaction Date Based on Exception Calendar")]
