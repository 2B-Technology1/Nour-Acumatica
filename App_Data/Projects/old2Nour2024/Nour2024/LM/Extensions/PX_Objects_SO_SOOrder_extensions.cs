...
namespace PX.Objects.SO
{
    public class SOOrderExt : PXCacheExtension<PX.Objects.SO.SOOrder>
    {
        ...
        //[PXInt]
        //[PXUIField(DisplayName = "Available Loyalty Points", Enabled = false, IsReadOnly = true)]
        //public virtual int? LoyaltyPoints { get; set; }
        //public abstract class loyaltyPoints : PX.Data.BQL.BqlInt.Field<loyaltyPoints> { }
        //#endregion


        //#region EarnedLoyaltyPoints
        //[PXInt]
        //[PXUIField(DisplayName = "Earned Loyalty Points", Enabled = false, IsReadOnly = true)]
        //public virtual int? EarnedLoyaltyPoints { get; set; }
        //public abstract class earnedLoyaltyPoints : PX.Data.BQL.BqlInt.Field<earnedLoyaltyPoints> { }
        //#endregion
