...
{
    public class LMOAutoNumberingAttribute : PXEventSubscriberAttribute,
                                            ...
                                            IPXRowPersistedSubscriber
    {
        ...
        public LMOAutoNumberingAttribute(Type autoNumbering)
        {
        ...
        public LMOAutoNumberingAttribute(Type autoNumbering, Type lastNumberField)
            : this(autoNumbering)
        {
...
PXCache sender, PXFieldDefaultingEventArgs e)
        ...
        where Field : IBqlField
        {
            ...
            {
                if (attribute is LMOAutoNumberingAttribute)
                {
                    LMOAutoNumberingAttribute attr = (LMOAutoNumberingAttribute)attribute;
        ...
        where Field : IBqlField
        {
            ...
            sender.GetAttributes<Field>(row))
            {
                if (attribute is LMOAutoNumberingAttribute)
                {
                    ((LMOAutoNumberingAttribute)attribute).Prefix = prefix;
                }
            }
        } 
    }
