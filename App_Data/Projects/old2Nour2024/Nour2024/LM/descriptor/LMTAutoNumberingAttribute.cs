...
{
    public class LMTAutoNumberingAttribute : PXEventSubscriberAttribute,
                                            ...
                                            IPXRowPersistedSubscriber
    {
        ...
        public LMTAutoNumberingAttribute(Type autoNumbering)
        {
        ...
        public LMTAutoNumberingAttribute(Type autoNumbering, Type lastNumberField)
            : this(autoNumbering)
        {
...
PXCache sender, PXFieldDefaultingEventArgs e)
        ...
        where Field : IBqlField
        {
            ...
            {
                if (attribute is LMTAutoNumberingAttribute)
                {
                    LMTAutoNumberingAttribute attr = (LMTAutoNumberingAttribute)attribute;
        ...
        where Field : IBqlField
        {
            ...
            sender.GetAttributes<Field>(row))
            {
                if (attribute is LMTAutoNumberingAttribute)
                {
                    ((LMTAutoNumberingAttribute)attribute).Prefix = prefix;
                }
            }
        } 
    }
