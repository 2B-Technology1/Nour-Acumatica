...
{
    public class JOAutoNumberingAttribute : PXEventSubscriberAttribute,
                                            ...
                                            IPXRowPersistedSubscriber
    {
        ...
        public JOAutoNumberingAttribute(Type autoNumbering)
        {
        ...
        public JOAutoNumberingAttribute(Type autoNumbering, Type lastNumberField)
            : this(autoNumbering)
        {
...
PXCache sender, PXFieldDefaultingEventArgs e)
        ...
        where Field : IBqlField
        {
            ...
            {
                if (attribute is JOAutoNumberingAttribute)
                {
                    JOAutoNumberingAttribute attr = (JOAutoNumberingAttribute)attribute;
        ...
        where Field : IBqlField
        {
            ...
            sender.GetAttributes<Field>(row))
            {
                if (attribute is JOAutoNumberingAttribute)
                {
                    ((JOAutoNumberingAttribute)attribute).Prefix = prefix;
                }
            }
        } 
    }
