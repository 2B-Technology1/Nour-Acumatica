﻿namespace MyMaintaince
 {
     ...
     public class Items : PX.Data.IBqlTable
     {
         #region Code
         ...
         new Type[] { typeof(Items.code), typeof(Items.name) })]
         ...
         [PXDefault(typeof(Search<Model.modelID, Where<Model.brandID, Equal<Current<Items.brandID>>>>))]
         [PXSelector(typeof(Search<Model.modelID, Where<Model.brandID, Equal<Current<Items.brandID>>>>)
        ...
        **/
         ...
         [PXDBIdentity()]
         [PXUIField(DisplayName = "Items Nbr")]
         [PXSelector(typeof(Search<Items.itemsID>), new Type[] { typeof(Items.itemsID), typeof(Items.code) }, DescriptionField = typeof(Items.name))]
         ...
         [PXDBString(50, IsUnicode = true)]
         [PXUIField(DisplayName = "Lincense Plate")]
         ...
         [PXDBString(50, IsUnicode = true)]
         [PXUIField(DisplayName = "Cylinder rows")]
