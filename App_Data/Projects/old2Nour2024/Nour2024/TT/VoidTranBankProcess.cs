...
{
    public class VoidTranBankProcess : PXGraph<VoidTranBankProcess>
    {
        [Serializable]
        ...
        public PXFilteredProcessingJoin<CAAdj, ProcessFilter,
                                InnerJoin<BankCUC, On<BankCUC.cashAccountID, Equal<CAAdjExt.usrBankAccount>>,
                                ...
                                LeftJoin<CATransfer, On<CATransfer.transferNbr, Equal<CAAdjExt.usrTransferRefNbr>>>>>,
                                    Where<CAAdjExt.usrCUC, Equal<True>,
                                            And<CAAdjExt.usrBankDeposited, Equal<True>,
                                            And<CAAdjExt.usrCUCAccount, Equal<BankCUC.cucaccountid>>>>> Records;

        public VoidTranBankProcess()
        {
        ...
        public static void ReleaseDocs(List<CAAdj> payments, DateTime? transactionDate)
        {
            ...
            foreach (CAAdj payment in payments)
            {
                ...
                Transfer.Transfer.Current.OutAccountID = caAdj.GetExtension<CAAdjExt>().UsrBankAccount;
                Transfer.Transfer.Current.CuryTranOut = payment.CuryTranAmt;
                Transfer.Transfer.Current.InAccountID = payment.GetExtension<CAAdjExt>().UsrCUCAccount;
                Transfer.Transfer.Current.OutExtRefNbr = "Void Transaction Bank";
                ...
                entry.CurrentDocument.Cache.SetValueExt<CAAdjExt.usrBankAccount>(entry.CurrentDocument.Current, null);
                entry.CurrentDocument.Cache.SetValueExt<CAAdjExt.usrBankDeposited>(entry.CurrentDocument.Current, false);
