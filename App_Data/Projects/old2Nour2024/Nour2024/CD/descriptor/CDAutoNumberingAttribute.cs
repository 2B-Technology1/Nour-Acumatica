...
{
    public class CDAutoNumberingAttribute : PXEventSubscriberAttribute,
                                            ...
                                            IPXRowPersistedSubscriber
    {
        ...
        public CDAutoNumberingAttribute(Type autoNumbering)
        {
        ...
        public CDAutoNumberingAttribute(Type autoNumbering, Type lastNumberField)
            : this(autoNumbering)
        {
...
PXCache sender, PXFieldDefaultingEventArgs e)
        ...
        where Field : IBqlField
        {
            ...
            {
                if (attribute is CDAutoNumberingAttribute)
                {
                    CDAutoNumberingAttribute attr = (CDAutoNumberingAttribute)attribute;
        ...
        where Field : IBqlField
        {
            ...
            sender.GetAttributes<Field>(row))
            {
                if (attribute is CDAutoNumberingAttribute)
                {
                    ((CDAutoNumberingAttribute)attribute).Prefix = prefix;
                }
            }
        } 
    }
