...
namespace MyMaintaince
{
	...
	public class JobOrderStockItems : PX.Data.IBqlTable
    {
        #region JobOrdrID
        ...
        Equal<Current<JobOrderStockItems.jobOrdrID>>>>))]
		...
		#endregion
        #region StkPrice
        public abstract class stkPrice : PX.Data.IBqlField
        {
        }
        protected decimal? _StkPrice;
        //[PXDBDecimal(4)]
        [PXDBDecimal(2)]
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXUIField(DisplayName = "Price")]
        public virtual decimal? StkPrice
        {
            get
            {
                return this._StkPrice;
            }
            set
            {
                this._StkPrice = value;
            }
        }
        #endregion
        #region LinePrice
        ...
        #endregion
        #region StkQty
        public abstract class stkQty : PX.Data.IBqlField
        {
        }
        [PXDecimal(2)]
        [PXUIField(DisplayName = "Qty OnHand", IsReadOnly = true)]
        public virtual decimal? StkQty { get; set; }
        #endregion
        #endregion
