...
namespace MyMaintaince
{
    ...
    public class JobOrderAutoNumberAttribute : PXEventSubscriberAttribute,
     ...
     IPXRowPersistedSubscriber
    {
        ...
        public JobOrderAutoNumberAttribute(Type autoNumbering)
        {
        ...
        public JobOrderAutoNumberAttribute(Type autoNumbering, Type lastNumberField)
            : this(autoNumbering)
        {
        ...
        public static void SetLastNumberField<Field>(PXCache sender, object row, Type lastNumberField) where Field : IBqlField
        {
            ...
            {
                if (attribute is JobOrderAutoNumberAttribute)
                {
                    JobOrderAutoNumberAttribute attr = (JobOrderAutoNumberAttribute)attribute;
        ...
        public static void SetPrefix<Field>(PXCache sender, object row, string prefix) where Field : IBqlField
        {
            ...
            sender.GetAttributes<Field>(row))
            {
                if (attribute is JobOrderAutoNumberAttribute)
                {
                    ((JobOrderAutoNumberAttribute)attribute).Prefix = prefix;
                }
            }
        }
