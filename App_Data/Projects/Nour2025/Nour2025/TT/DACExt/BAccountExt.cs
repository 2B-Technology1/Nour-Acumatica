...
namespace Maintenance
{
    ...
    public class BAccountExt : PXCacheExtension<PX.Objects.CR.BAccount>
    {
        ...
        #region UsrLoyaltyTier
        [PXDBInt]
        [PXUIField(DisplayName = "Loyalty Tier")]
        [PXSelector(typeof(LoyaltyTiers.loyaltyTierID),
                typeof(LoyaltyTiers.loyaltyTierID),
                typeof(LoyaltyTiers.loyaltyTierCD),
                SubstituteKey = typeof(LoyaltyTiers.loyaltyTierCD),
                DescriptionField = typeof(LoyaltyTiers.description)
                )]
        public virtual int? UsrLoyaltyTier { get; set; }
        public abstract class usrLoyaltyTier : PX.Data.BQL.BqlInt.Field<usrLoyaltyTier> { }
        #endregion
    }
