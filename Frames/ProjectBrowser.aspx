				...
				<td class="leftFrame" runat="server" style="width: 19%">
					...
					<px:PXSmartPanel ID="panelProj" runat="server" SkinID="Frame" RenderVisible="true">
						<px:PXTreeView runat="server" ID="treeProj" SkinID="Menu" Target="main" ShowRootNode="False" 
							...
							<DataBindings>
								<px:PXTreeItemBinding DataMember="SiteMapTree" TextField="Title" ValueField="NodeID" ImageUrlField="" NavigateUrlField="Url" ToolTipField="ToolTip" EnabledField="IsEnabled" />
							</DataBindings>
						</px:PXTreeView>
					</px:PXSmartPanel>
				</td>                
