            ...
            <Template>
                ...
                <div class="traceLnk">
                    <asp:HyperLink ID="lnkTrace" runat="server" Font-Size="Medium" Font-Underline="True"
                        ForeColor="Blue" NavigateUrl="~/Scripts/Trace/index.html" Target="_blank" Text="Show Trace"></asp:HyperLink>
                </div>
                <div class="nxtSt">
                ...
                <div class="navTo">
                    ...
                    <asp:HyperLink ID="hlNavTo" runat="server" NavigateUrl="~/Scripts/Trace/index.html" Text="Show Trace"
