...
<asp:Content ID="c1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <px:PXDashboardFormView id="form" runat="server" DataSourceID="ds" DataMember="Filter" Style="z-index: 100;" CSSClass="dashboard-params" Width="100%" CaptionVisible="false">
