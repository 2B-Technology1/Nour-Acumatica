...
<px:PXSmartPanel ID="ComboBoxValuesDictDialog" runat="server" Style="z-index: 108;left: 351px; position: absolute; top: 99px" 
    ...
    AutoRepaint="True"
        ...
        <px:PXGrid ID="gridCombos" runat="server" DataSourceID="DsControlProps" Style="padding: 5px; z-index: 100" SkinID="Details" AutoAdjustColumns="True" 
                    Width="100%" Heigth="100%">
            <AutoSize Enabled="True" MinHeight="200"></AutoSize>
            <ActionBar>
                <Actions>
                    <Refresh ToolBarVisible="False"></Refresh>
                    <ExportExcel ToolBarVisible="Bottom" Order="0" GroupIndex="0" ></ExportExcel>
...
<%--		<px:PXButton ID="PXButton2" runat="server" Text="Manage..." NavigateUrl="~/pages/sm/sm204505.aspx"
	...
	<px:PXSmartPanel ID="PanelElemInfo" runat="server"
		...
		Key="ViewElemInfo" Overflow="hidden" CssClass="Panel-Elem-Info">
		...
		<px:PXFormView ID="FormElemInfo" runat="server" DataMember="ViewElemInfo" AllowCollapse="False"
			...
			<ClientEvents AfterRepaint="arPanelElemInfo" />	
			<Template>
